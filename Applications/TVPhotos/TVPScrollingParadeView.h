...
- (void).cxx_destruct;	// IMP=0x000000010001ed10
@property(nonatomic, getter=isPaused) _Bool paused; // @synthesize paused=_paused;
@property(copy, nonatomic) NSArray *imageProxies; // @synthesize imageProxies=_imageProxies;
- (void)_stopAnimations;	// IMP=0x000000010001eb44
- (void)_startAnimations;	// IMP=0x000000010001e200
- (void)_addImageToAnimationContainer:(id)arg1;	// IMP=0x000000010001df40
- (void)animationDidStop:(id)arg1 finished:(_Bool)arg2;	// IMP=0x000000010001df30
- (void)layoutSubviews;	// IMP=0x000000010001d7d8
- (void)didMoveToWindow;	// IMP=0x000000010001d71c
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000010001d670
