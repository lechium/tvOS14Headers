...
- (void).cxx_destruct;	// IMP=0x000000010005b56c
...
- (void)_updateImageViewWithPlaceholderImageIfNeeded;	// IMP=0x000000010005b408
- (void)_setImage:(id)arg1;	// IMP=0x000000010005b294
- (id)_imageView;	// IMP=0x000000010005b100
- (void)_loadImage;	// IMP=0x000000010005aa40
- (void)setSelected:(_Bool)arg1 animated:(_Bool)arg2;	// IMP=0x000000010005a8cc
@property(nonatomic) double cornerRadius;
- (void)setImageProxy:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000010005a4dc
@property(retain, nonatomic) UIImage *image;
- (void)willMoveToWindow:(id)arg1;	// IMP=0x000000010005a3cc
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x000000010005a324
- (void)setFrame:(struct CGRect)arg1;	// IMP=0x000000010005a2b0
- (void)setContentMode:(long long)arg1;	// IMP=0x000000010005a28c
- (void)layoutSubviews;	// IMP=0x000000010005a220
- (long long)contentMode;	// IMP=0x000000010005a208
- (struct CGSize)intrinsicContentSize;	// IMP=0x000000010005a1f0
- (void)dealloc;	// IMP=0x000000010005a184
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000010005a0a0
