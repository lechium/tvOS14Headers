...
- (void).cxx_destruct;	// IMP=0x0000000100065aa0
...
- (void)_setSystemInputView:(id)arg1;	// IMP=0x00000001000658dc
- (void)_gridAlignFrame:(struct CGRect *)arg1;	// IMP=0x000000010006589c
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x00000001000657bc
- (void)layoutSubviews;	// IMP=0x00000001000652e8
- (void)updateConstraints;	// IMP=0x0000000100064f60
- (void)setSystemInputView:(id)arg1 touchInputEnabled:(_Bool)arg2;	// IMP=0x0000000100064e38
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000100064a7c
