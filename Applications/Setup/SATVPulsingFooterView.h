...
- (void)animationDidStop:(id)arg1 finished:(_Bool)arg2;	// IMP=0x000000010003c838
- (void)pulseAtBeginTime:(double)arg1;	// IMP=0x000000010003c630
- (void)layoutSubviews;	// IMP=0x000000010003c528
- (id)initWithMode:(unsigned long long)arg1;	// IMP=0x000000010003c4c8
