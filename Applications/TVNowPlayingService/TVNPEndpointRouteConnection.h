...
+ (id)keyPathsForValuesAffectingPaired;	// IMP=0x0000000100023634
...
- (id)_preloadArtwork;	// IMP=0x0000000100025c18
- (id)_placeholderArtwork;	// IMP=0x0000000100025b44
- (void)_updateState;	// IMP=0x00000001000259b0
- (void)_updateAutomaticResponseLoading;	// IMP=0x00000001000258f0
- (void)_connectPairingIfNeeded:(_Bool)arg1;	// IMP=0x000000010002549c
- (void)_connectionDidInvalidate:(id)arg1;	// IMP=0x0000000100025394
- (void)_updateMetadata;	// IMP=0x0000000100024238
- (void)_createRequestController;	// IMP=0x0000000100023dc8
- (void)_reloadPlayerPathWithRoute:(id)arg1;	// IMP=0x0000000100023b8c
- (void)controller:(id)arg1 defersResponseReplacement:(CDUnknownBlockType)arg2;	// IMP=0x0000000100023a7c
- (void)sendCommand:(unsigned int)arg1 options:(id)arg2;	// IMP=0x00000001000237cc
- (void)playPause;	// IMP=0x00000001000237b8
- (void)deregisterMetadataUpdateHandler:(id)arg1;	// IMP=0x000000010002375c
- (id)registerMetadataUpdateHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000001000236c0
@property(retain, nonatomic) MPAVEndpointRoute *route;
- (id)response;	// IMP=0x00000001000235e0
- (id)playerPath;	// IMP=0x0000000100023534
@property(readonly, copy, nonatomic) NSString *bundleID;
@property(readonly, nonatomic, getter=isPaired) _Bool paired;
- (void)connectAndPair;	// IMP=0x00000001000233f4
@property(readonly, copy) NSString *description;
- (id)initWithRoute:(id)arg1;	// IMP=0x0000000100023188
