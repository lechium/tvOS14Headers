...
- (void).cxx_destruct;	// IMP=0x000000010000f1cc
...
- (void)refreshPropertiesWithRoute:(id)arg1;	// IMP=0x000000010000f0b0
- (void)connectAndPair;	// IMP=0x000000010000f0ac
- (void)togglePlayPause;	// IMP=0x000000010000f0a8
- (id)initWithEndpointRoute:(id)arg1;	// IMP=0x000000010000f074
- (id)init;	// IMP=0x000000010000f05c
