...
+ (id)gatekeeperForAceObject:(id)arg1 currentTurnContext:(id)arg2;	// IMP=0x00000001000338f0
+ (id)gatekeeperForRequestOptions:(id)arg1 currentTurnContext:(id)arg2;	// IMP=0x000000010003385c
- (void).cxx_destruct;	// IMP=0x0000000100034914
...
- (_Bool)viewContainsFocusItem:(id)arg1;	// IMP=0x00000001000347e8
- (id)updatedFocusItemForCurrentFocusItem:(id)arg1;	// IMP=0x0000000100034730
- (id)preferredFocusEnvironments;	// IMP=0x00000001000346b8
- (void)layoutSubviews;	// IMP=0x0000000100034480
- (unsigned long long)_gatekeeperTypeForBundleIdentifier:(id)arg1;	// IMP=0x00000001000343dc
- (void)_logGatekeeperDismissedManually;	// IMP=0x0000000100034294
- (void)logGatekeeperAppeared;	// IMP=0x000000010003414c
- (void)_dismissalButtonTapped:(id)arg1;	// IMP=0x0000000100033ed8
- (void)dealloc;	// IMP=0x0000000100033dc4
- (id)initWithAceObject:(id)arg1 currentTurnContext:(id)arg2;	// IMP=0x0000000100033d64
- (id)initWithRequestOptions:(id)arg1 currentTurnContext:(id)arg2;	// IMP=0x0000000100033cac
- (id)_init;	// IMP=0x0000000100033b00
- (void)updateGatekeeperWithCurrentTurnContext:(id)arg1;	// IMP=0x0000000100033af4
