...
- (void).cxx_destruct;	// IMP=0x00000001000287a4
...
- (void)_setKeylineHidden:(id)arg1 hidden:(_Bool)arg2;	// IMP=0x0000000100028678
- (void)layoutSubviews;	// IMP=0x0000000100028328
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000100028318
- (id)initWithFrame:(struct CGRect)arg1 collectionView:(id)arg2;	// IMP=0x00000001000280f0
