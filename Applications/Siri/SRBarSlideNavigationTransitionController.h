...
- (void).cxx_destruct;	// IMP=0x000000010002409c
...
- (void)_performNavigationBarAnimations;	// IMP=0x0000000100023ff4
- (void)coordinateAdditionalTransitionsWithTransitionCoordinator:(id)arg1;	// IMP=0x0000000100023df0
- (void)configureWithNavigationController:(id)arg1;	// IMP=0x0000000100023d6c
