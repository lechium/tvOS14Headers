...
- (void).cxx_destruct;	// IMP=0x0000000100081f48
...
- (void)speechSynthesizer:(id)arg1 didFinishSynthesisRequest:(id)arg2 withInstrumentMetrics:(id)arg3 error:(id)arg4;	// IMP=0x0000000100081c24
- (_Bool)handlePreSynthesisCommandWithError:(id *)arg1;	// IMP=0x0000000100081198
- (id)init;	// IMP=0x00000001000807b8
