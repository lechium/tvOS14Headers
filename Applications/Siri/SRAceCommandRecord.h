...
- (void).cxx_destruct;	// IMP=0x0000000100093054
...
- (void)incrementNumberOfUnsuccessfullyCompletedActions;	// IMP=0x0000000100092f98
- (void)incrementNumberOfSuccessfullyCompletedActions;	// IMP=0x0000000100092adc
- (void)incrementNumberOfStoppedActions;	// IMP=0x0000000100092aa4
- (void)incrementNumberOfStartedActions;	// IMP=0x0000000100092a6c
- (id)initWithAceCommand:(id)arg1 andCompletion:(CDUnknownBlockType)arg2;	// IMP=0x0000000100092944
