...
- (void).cxx_destruct;	// IMP=0x0000000100089e74
...
- (_Bool)_canBeInterrupted;	// IMP=0x0000000100089d88
- (void)_begin;	// IMP=0x0000000100089a44
- (id)initWithViewController:(id)arg1 parentViewController:(id)arg2 animated:(_Bool)arg3 transitionBlock:(CDUnknownBlockType)arg4;	// IMP=0x0000000100089884
