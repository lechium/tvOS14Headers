...
- (void).cxx_destruct;	// IMP=0x000000010018ce18
...
- (void)_willInterruptWithReason:(id)arg1;	// IMP=0x000000010018cb78
- (void)_begin;	// IMP=0x000000010018baa8
- (_Bool)_canBeInterrupted;	// IMP=0x000000010018ba88
