...
+ (id)infoWithChangedProperties:(unsigned long long)arg1 snapshot:(id)arg2;	// IMP=0x000000010000cc08
...
- (id)initWithChangedProperties:(unsigned long long)arg1 snapshot:(id)arg2;	// IMP=0x000000010000cc68
