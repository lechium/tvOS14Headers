...
- (void).cxx_destruct;	// IMP=0x000000010007ab80
...
- (id)description;	// IMP=0x000000010007aa10
- (id)init;	// IMP=0x000000010007a9f8
- (id)initWithChangeKind:(unsigned long long)arg1 sourceIndexes:(id)arg2 destinationIndexes:(id)arg3;	// IMP=0x000000010007a930
