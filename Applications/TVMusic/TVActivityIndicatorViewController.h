...
- (void).cxx_destruct;	// IMP=0x00000001000571ec
...
- (void)viewDidLayoutSubviews;	// IMP=0x0000000100056d9c
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x0000000100056bc0
- (void)loadView;	// IMP=0x000000010005695c
- (void)dealloc;	// IMP=0x00000001000568fc
- (id)initWithNibName:(id)arg1 bundle:(id)arg2;	// IMP=0x0000000100056878
