...
- (void)pressesEnded:(id)arg1 withEvent:(id)arg2;	// IMP=0x000000010005b5c0
- (void)pressesBegan:(id)arg1 withEvent:(id)arg2;	// IMP=0x000000010005b4a8
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x000000010005b2a8
- (void)prepareForReuse;	// IMP=0x000000010005b22c
@property(nonatomic, readonly) struct CGRect jet_focusedFrame;
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x000000010005affc
@property(nonatomic, readonly) _Bool canBecomeFocused;
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000100059dbc
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000100059d9c
