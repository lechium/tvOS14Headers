...
- (void)refreshPropertiesWithRoute:(id)arg1;	// IMP=0x000000000001bc6c
- (void)connectAndPair;	// IMP=0x000000000001bc68
- (void)togglePlayPause;	// IMP=0x000000000001bc64
- (id)initWithEndpointRoute:(id)arg1;	// IMP=0x000000000001bc30
- (id)init;	// IMP=0x000000000001bc18
