...
+ (id)keyPathsForValuesAffectingPaired;	// IMP=0x0000000000018094
- (void).cxx_destruct;	// IMP=0x000000000001a910
...
- (id)_preloadArtwork;	// IMP=0x000000000001a700
- (id)_placeholderArtwork;	// IMP=0x000000000001a62c
- (void)_updateState;	// IMP=0x000000000001a498
- (void)_updateAutomaticResponseLoading;	// IMP=0x000000000001a3d8
- (void)_connectPairingIfNeeded:(_Bool)arg1;	// IMP=0x0000000000019f2c
- (void)_connectionDidInvalidate:(id)arg1;	// IMP=0x0000000000019e24
- (void)_updateMetadata;	// IMP=0x0000000000018cc8
- (void)_createRequestController;	// IMP=0x0000000000018858
- (void)_reloadPlayerPathWithRoute:(id)arg1;	// IMP=0x000000000001861c
- (void)controller:(id)arg1 defersResponseReplacement:(CDUnknownBlockType)arg2;	// IMP=0x00000000000184dc
- (void)sendCommand:(unsigned int)arg1 options:(id)arg2;	// IMP=0x000000000001822c
- (void)playPause;	// IMP=0x0000000000018218
- (void)deregisterMetadataUpdateHandler:(id)arg1;	// IMP=0x00000000000181bc
- (id)registerMetadataUpdateHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000000018120
@property(retain, nonatomic) MPAVEndpointRoute *route;
- (id)response;	// IMP=0x0000000000018040
- (id)playerPath;	// IMP=0x0000000000017f94
@property(readonly, copy, nonatomic) NSString *bundleID;
@property(readonly, nonatomic, getter=isPaired) _Bool paired;
- (void)connectAndPair;	// IMP=0x0000000000017e54
@property(readonly, copy) NSString *description;
- (id)initWithRoute:(id)arg1;	// IMP=0x0000000000017be8
