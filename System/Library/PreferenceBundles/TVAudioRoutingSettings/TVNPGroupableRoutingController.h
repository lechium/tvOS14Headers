...
+ (_Bool)automaticallyNotifiesObserversForKey:(id)arg1;	// IMP=0x0000000000005f70
- (void).cxx_destruct;	// IMP=0x0000000000009730
...
- (void)_updateWithAvailableEndpoints:(id)arg1 outputDevices:(id)arg2;	// IMP=0x0000000000007d98
- (id)_endpointRoutesWithForcedLocalRoute:(id)arg1;	// IMP=0x0000000000007b2c
- (void)_updateAvailableRoutes;	// IMP=0x00000000000074cc
- (void)_setNeedsDisplayedRoutesUpdate;	// IMP=0x0000000000007378
- (void)routingController:(id)arg1 pickedRouteDidChange:(id)arg2;	// IMP=0x000000000000736c
- (void)routingControllerAvailableRoutesDidChange:(id)arg1;	// IMP=0x0000000000007360
- (void)targetDestination:(id)arg1;	// IMP=0x0000000000007248
- (void)unpickRoute:(id)arg1 forDestination:(id)arg2;	// IMP=0x0000000000006eb4
- (void)pickRoute:(id)arg1 forDestination:(id)arg2;	// IMP=0x0000000000006738
- (void)_updateAllowsDestinationSelection;	// IMP=0x00000000000066a4
- (void)dealloc;	// IMP=0x00000000000063c4
- (id)initWithOutputContextUID:(id)arg1 allowsRetargeting:(_Bool)arg2 initalFetchCompletion:(CDUnknownBlockType)arg3;	// IMP=0x0000000000006014
- (id)initWithOutputContextUID:(id)arg1 allowsRetargeting:(_Bool)arg2;	// IMP=0x0000000000006004
- (id)init;	// IMP=0x0000000000005ff0
