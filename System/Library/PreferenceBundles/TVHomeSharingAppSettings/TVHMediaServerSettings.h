...
- (void).cxx_destruct;	// IMP=0x000000000000646c
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000000063dc
- (id)description;	// IMP=0x0000000000006194
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000000005f4c
- (unsigned long long)hash;	// IMP=0x0000000000005eac
- (id)dictionaryRepresentation;	// IMP=0x0000000000005d70
- (id)initWithDictionaryRepresentation:(id)arg1;	// IMP=0x0000000000005ba8
- (id)initWithMediaServerIdentifier:(id)arg1;	// IMP=0x0000000000005ae8
- (id)init;	// IMP=0x0000000000005a60
