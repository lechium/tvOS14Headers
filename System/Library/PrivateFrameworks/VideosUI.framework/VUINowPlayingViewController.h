...
@class TVMediaPlaybackManager, VUIMediaController, IKAppContext, NSArray, UIViewController, VUINowPlayingHudView, VUINowPlayingViewModel, VUIButton, VUIPostPlayDocumentServiceViewController, VUINowPlayingSkipButtonLayout, VUIVideoAdvisoryView, VUIProductPlacementView, UITapGestureRecognizer, NSString;
