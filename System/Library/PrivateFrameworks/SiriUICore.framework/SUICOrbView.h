...
@interface SUICOrbView : UIView {
	...
	SCD_Struct_SU4 _mpsChipBlurOffset;
	...
	SCD_Struct_SU5 _projectionMatrix;
	SCD_Struct_SU6 _sphereUniforms;
	SCD_Struct_SU7 _bubbleSpring;
	SCD_Struct_SU7 _energySpring;
	SCD_Struct_SU7 _volumeSpring;
	SCD_Struct_SU7 _chipsSpring;
	SCD_Struct_SU7 _specularSpring;
	SCD_Struct_SU7 _thinkingSpring;
	SCD_Struct_SU7 _speakingSpring;
	SCD_Struct_SU7 _glowSpring;
	SCD_Struct_SU7 _onSpring;
	SCD_Struct_SU7 _chipSpring[6];
	 _setupRasterSize;
...
-(void)_setupSpring:(SCD_Struct_SU7*)arg1 withType:(unsigned long long)arg2 initialValue:(float)arg3 ;
