...
-(BOOL)getBitmap:(id*)arg1 layerOffsetX:(double*)arg2 layerOffsetY:(double*)arg3 requestInfo:(SCD_Struct_OZ0*)arg4 fromParm:(unsigned)arg5 atTime:(double)arg6;
-(BOOL)getTexture:(id*)arg1 layerOffsetX:(double*)arg2 layerOffsetY:(double*)arg3 requestInfo:(SCD_Struct_OZ0*)arg4 fromParm:(unsigned)arg5 atTime:(double)arg6;
