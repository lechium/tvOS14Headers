...
-(BOOL)getOutputWidth:(unsigned long long*)arg1 height:(unsigned long long*)arg2 withInput:(SCD_Struct_PA29)arg3 withInfo:(SCD_Struct_OZ18*)arg4 ;
...
-(BOOL)getInputBitmap:(id*)arg1 withInfo:(SCD_Struct_OZ18*)arg2 atTime:(/*function pointer*/void**)arg3 withROI:(HGRect*)arg4 ;
-(BOOL)getInputBitmap:(id*)arg1 withInfo:(SCD_Struct_OZ18*)arg2 atTime:(/*function pointer*/void**)arg3 appendHGGraph:(HGRef<HGNode>*)arg4 ;
...
-(BOOL)renderOutput:(id)arg1 withInput:(id)arg2 withInfo:(SCD_Struct_OZ18*)arg3 ;
@end
