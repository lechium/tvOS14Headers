...
-(id)newLibraryWithCIFilters:(id)arg1 imageFilterFunctionInfo:(const SCD_Struct_MT1*)arg2 error:(id*)arg3;
...
-(id)newComputePipelineStateWithImageFilterFunctionsSPI:(id)arg1 imageFilterFunctionInfo:(const SCD_Struct_MT1*)arg2 error:(id*)arg3;
-(id)newLibraryWithDAG:(id)arg1 functions:(id)arg2 error:(id*)arg3;
-(id)newLibraryWithImageFilterFunctionsSPI:(id)arg1 imageFilterFunctionInfo:(const SCD_Struct_MT1*)arg2 error:(id*)arg3;
...
-(id)newLibraryWithCIFiltersForComputePipeline:(id)arg1 imageFilterFunctionInfo:(const SCD_Struct_MT1*)arg2 error:(id*)arg3;
