...
@interface MTLDebugLibrary : MTLToolsLibrary {
	...
	SCD_Struct_MT7* _imageFilterFunctionInfo;
...
@property (nonatomic,readonly) SCD_Struct_MT7* imageFilterFunctionInfo;              //@synthesize imageFilterFunctionInfo=_imageFilterFunctionInfo - In the implementation block
-(void)dealloc;
-(id)code;
...
-(void)setImageFilterFunctions:(id)arg1 imageFilterFunctionInfo:(const SCD_Struct_MT7*)arg2 ;
...
-(SCD_Struct_MT7*)imageFilterFunctionInfo;
@end
