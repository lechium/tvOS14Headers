...
-(void)setViewports:(const SCD_Struct_MT14*)arg1 count:(unsigned long long)arg2 ;
-(void)setScissorRects:(const SCD_Struct_MT15*)arg1 count:(unsigned long long)arg2 ;
