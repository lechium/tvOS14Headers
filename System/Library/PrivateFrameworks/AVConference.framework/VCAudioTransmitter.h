...
@interface VCAudioTransmitter : NSObject <VCAudioIOSink, VCConnectionChangedHandler> {
	...
	SCD_Struct_VC185 _currentChannelMetrics;
	SCD_Struct_VC187 _idsChannelDataFormat;
...
@property (assign,nonatomic) SCD_Struct_VC185 currentChannelMetrics;                          //@synthesize currentChannelMetrics=_currentChannelMetrics - In the implementation block
...
-(SCD_Struct_VC185)currentChannelMetrics;
...
-(void)setCurrentChannelMetrics:(SCD_Struct_VC185)arg1 ;
-(BOOL)useWiFiTiers;
@end
