...
typedef struct {
	...
	SCD_Struct_VC114 report;
	SCD_Struct_VC117 dropAck;
	SCD_Struct_VC116) codecRateChange;
} SCD_Struct_VC118;
...
typedef struct VCMediaStreamTransportSetupInfo {
	...
	/*function pointer*/void* ;
	SCD_Struct_VC147 socketInfo;
	SCD_Struct_VC149 ipInfo;
	SCD_Struct_VC148 transportStreamInfo;
	id nwConnection;
...
typedef struct tagWRMMetricsInfo {
	...
	SCD_Struct_VC173 wrmMetricsReportingContext;
