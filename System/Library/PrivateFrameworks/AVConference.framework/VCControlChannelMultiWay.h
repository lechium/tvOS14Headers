...
-(int)updateEncryption:(SCD_Struct_VC156*)arg1 derivedSSRC:(unsigned)arg2 ;
-(int)getKeyDerivationCryptoSet:(SCD_Struct_VC156*)arg1 withKeyMaterial:(id)arg2 derivedSSRC:(unsigned*)arg3 ;
-(void)setCurrentSendMKIWithKeyMaterial:(id)arg1 ;
-(void)initializeSRTPInfo:(tagSRTPINFO*)arg1 ;
-(void)initializeEncryption;
-(void)finalizeEncryption;
-(void)updateEncryptionWithEncryptionMaterial:(SCD_Struct_VC158*)arg1 ;
...
-(void)setEncryptionWithEncryptionMaterial:(SCD_Struct_VC158*)arg1 ;
...
-(void)messageReceived:(id)arg1 participantInfo:(SCD_Struct_VC159*)arg2 ;
