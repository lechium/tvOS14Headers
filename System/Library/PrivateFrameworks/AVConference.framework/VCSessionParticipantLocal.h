...
-(void)updateVideoStreamAndProcessFrame:(id)arg1 sampleBuffer:(opaqueCMSampleBufferRef)arg2 lastSentAudioHostTime:(double)arg3 lastSentAudioSampleTime:(unsigned)arg4 frameTime:(SCD_Struct_AV88)arg5 attribute:(SCD_Struct_Vi127)arg6 ;
