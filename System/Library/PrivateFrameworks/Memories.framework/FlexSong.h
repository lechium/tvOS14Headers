...
@interface FlexSong : FlexSongBackend {
	...
	SCD_Struct_Fr12 _cachedNaturalDuration;
...
-(id)_clipPlaylistForDuration:(SCD_Struct_Fr12)arg1 withOptions:(id)arg2 testingContext:(id)arg3 ;
-(id)_fullSongLoopedClipPlaylistForDuration:(SCD_Struct_Fr12)arg1 withOptions:(id)arg2 testingContext:(id)arg3 ;
-(BOOL)_buildSegmentAssemblyList:(id)arg1 forDuration:(long long)arg2 withOptions:(id)arg3 testingContext:(id)arg4 ;
-(long long)_samplesForDuration:(SCD_Struct_Fr12)arg1 ;
