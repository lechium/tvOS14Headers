...
@interface CompositionTrackGroup : NSObject {
	...
	SCD_Struct_Fr12 m_cursor;
	SCD_Struct_Fr12 m_cursorForMovieAudio;
	BOOL m_videoTrackInUse;
	BOOL m_shouldAddVolumePointsAsWorkaround;
	SCD_Struct_Fr12 m_cursorAtLastVideoInsertion;
	SCD_Struct_Fr12 m_timeOfLastVolumeChange;
	float m_volumeAtLastVolumeChange;
	float m_volumeChangePending;
	SCD_Struct_Fr12 m_timeOfLastRequest;
	BOOL _isExporting;
	BOOL _seenSpeedClip;
	...
	SCD_Struct_Fr12 m_fadeOutStart;
	SCD_Struct_Fr12 m_fadeOutDuration;
	SCD_Struct_Fr12 _lastRampToZeroEnd;
...
@property (assign,nonatomic) SCD_Struct_Fr12 lastRampToZeroEnd;                                //@synthesize lastRampToZeroEnd=_lastRampToZeroEnd - In the implementation block
...
@property (nonatomic,readonly) SCD_Struct_Fr12 cursor; 
@property (nonatomic,readonly) SCD_Struct_Fr12 cursorAtLastVideoInsertion; 
@property (assign,nonatomic) SCD_Struct_Fr12 timeOfLastVolumeChange; 
@property (assign,nonatomic) SCD_Struct_Fr12 timeOfLastRequest; 
@property (assign,nonatomic) float volumeAtLastVolumeChange; 
@property (assign,nonatomic) float volumeChangePending; 
@property (assign,nonatomic) SCD_Struct_Fr12 fadeOutStart; 
@property (assign,nonatomic) SCD_Struct_Fr12 fadeOutDuration; 
...
-(id)description;
-(void)dealloc;
-(SCD_Struct_Fr12)cursor;
-(NSString *)label;
-(void)setLabel:(NSString *)arg1 ;
-(BOOL)validate;
-(id)initWithLabel:(id)arg1 ;
-(void)apply:(id)arg1 ;
-(SCD_Struct_Fr12)fadeOutDuration;
-(void)setFadeOutDuration:(SCD_Struct_Fr12)arg1 ;
...
-(void)applyCompositionItem:(id)arg1 atTime:(SCD_Struct_Fr12)arg2 ;
-(void)applyPaddingToTime:(SCD_Struct_Fr12)arg1 ;
-(SCD_Struct_Fr12)lastRampToZeroEnd;
-(void)applyCompositionItem:(id)arg1 atTime:(SCD_Struct_Fr12)arg2 videoOnly:(BOOL)arg3 ;
-(void)setFmTrackInfoDict:(NSDictionary *)arg1 ;
-(NSDictionary *)fmTrackInfoDict;
-(void)applyCompositionItemAsLoopedAudio:(id)arg1 forTimeRange:(SCD_Struct_Co16)arg2 ;
...
-(BOOL)requestVolumeRampFromStartVolume:(float)arg1 toEndVolume:(float)arg2 timeRange:(SCD_Struct_Co16)arg3 ;
-(BOOL)requestVolume:(float)arg1 atTime:(SCD_Struct_Fr12)arg2 ;
-(void)applyAudioMixParameters:(id)arg1 ;
-(void)applyFlexAudioMix:(id)arg1 ;
-(void)setTimeOfLastVolumeChange:(SCD_Struct_Fr12)arg1 ;
-(void)setVolumeAtLastVolumeChange:(float)arg1 ;
-(void)setVolumeChangePending:(float)arg1 ;
-(void)setTimeOfLastRequest:(SCD_Struct_Fr12)arg1 ;
-(void)setLastRampToZeroEnd:(SCD_Struct_Fr12)arg1 ;
-(float)volumeChangePending;
-(SCD_Struct_Fr12)timeOfLastRequest;
-(float)volumeAtLastVolumeChange;
-(SCD_Struct_Fr12)timeOfLastVolumeChange;
-(BOOL)commitPendingVolumeToTime:(SCD_Struct_Fr12)arg1 ;
-(SCD_Struct_Fr12)fadeOutStart;
-(float)linearFadeOutValueForTime:(SCD_Struct_Fr12)arg1 ;
-(float)setFadedVolumeRampFromStartVolume:(float)arg1 toEndVolume:(float)arg2 timeRange:(SCD_Struct_Co16)arg3 ;
-(void)commitVolumeRampFromStartVolume:(float)arg1 toEndVolume:(float)arg2 timeRange:(SCD_Struct_Co16)arg3 ;
-(BOOL)shouldCommitVolume:(float)arg1 ;
-(BOOL)requestVolumeRampFromStartVolume:(float)arg1 toEndVolume:(float)arg2 timeRange:(SCD_Struct_Co16)arg3 fillEmptySegment:(BOOL)arg4 ;
...
-(SCD_Struct_Fr12)cursorAtLastVideoInsertion;
-(void)setFadeOutStart:(SCD_Struct_Fr12)arg1 ;
