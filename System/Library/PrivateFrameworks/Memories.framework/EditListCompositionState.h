...
@interface EditListCompositionState : NSObject <NSCopying> {
	...
	SCD_Struct_Co16 m_videoCompTimeRange;
	SCD_Struct_Co16 m_audioCompTimeRange;
...
@property (assign,nonatomic) SCD_Struct_Co16 videoCompTimeRange; 
@property (assign,nonatomic) SCD_Struct_Co16 audioCompTimeRange; 
...
-(SCD_Struct_Co16)videoCompTimeRange;
-(void)setVideoCompTimeRange:(SCD_Struct_Co16)arg1 ;
-(SCD_Struct_Co16)audioCompTimeRange;
-(void)setAudioCompTimeRange:(SCD_Struct_Co16)arg1 ;
