...
@property (assign,nonatomic) SCD_Struct_Fr12 cachedNaturalDuration;              //@synthesize cachedNaturalDuration=_cachedNaturalDuration - In the implementation block
...
-(SCD_Struct_Fr12)cachedNaturalDuration;
-(void)setCachedNaturalDuration:(SCD_Struct_Fr12)arg1 ;
@end
