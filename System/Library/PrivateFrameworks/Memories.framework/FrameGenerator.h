...
@interface FrameGenerator : NSObject {
	...
	NSLock* m_fetchLock;
	SCD_Struct_Fr12 m_timeToleranceBefore;
	SCD_Struct_Fr12 m_timeToleranceAfter;
...
+(void)nukeCaches;
+(id)cachedFrameForMovie:(id)arg1 atTime:(SCD_Struct_Fr12)arg2 nearby:(BOOL)arg3 actualTime:(SCD_Struct_Fr12*)arg4 size:(CGSize)arg5 withRotation:(double)arg6 ;
...
+(void)queueNextItem;
+(void)setCachedFrame:(id)arg1 forMovie:(id)arg2 atTime:(SCD_Struct_Fr12)arg3 canPoster:(BOOL)arg4 size:(CGSize)arg5 withRotation:(double)arg6 maximumCacheSize:(long long)arg7 ;
...
-(id)imageAtTime:(SCD_Struct_Fr12)arg1 ;
...
-(void)requestedTimeTolerance:(SCD_Struct_Fr12)arg1 after:(SCD_Struct_Fr12)arg2 ;
-(void)fetchTime:(SCD_Struct_Fr12)arg1 highPriority:(BOOL)arg2 resultBlock:(/*^block*/id)arg3 ;
-(void)cancelAllFetching;
-(void)cancelFetchingOutsideActiveSegment:(SCD_Struct_Fr12)arg1 until:(SCD_Struct_Fr12)arg2 maxRequestInFlight:(long long)arg3 ;
-(BOOL)isFetching:(SCD_Struct_Fr12)arg1 ;
-(BOOL)isQueueEmpty;
-(void)logQueuedTimes;
-(BOOL)fetchTimeInQueue:(SCD_Struct_Fr12)arg1 ;
