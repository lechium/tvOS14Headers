...
@interface IrisSampleInfo : NSObject {
	...
	SCD_Struct_Fr12 _dominantSampleDuration;
...
@property (assign,nonatomic) SCD_Struct_Fr12 dominantSampleDuration;                  //@synthesize dominantSampleDuration=_dominantSampleDuration - In the implementation block
+(void)initialize;
+(void)clearCache;
...
-(void)setDominantSampleDuration:(SCD_Struct_Fr12)arg1 ;
...
-(SCD_Struct_Fr12)dominantSampleDuration;
@end
