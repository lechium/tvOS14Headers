...
@property (nonatomic,readonly) SCD_Struct_Fr12 duration; 
...
-(void)setProject:(id)arg1 frameDuration:(SCD_Struct_Fr12)arg2 viewSize:(CGSize)arg3 forFullScreen:(BOOL)arg4 ;
...
-(SCD_Struct_Fr12)extensionForTransitionsSupportingEatLeftRight:(id)arg1 leftSideOfTransition:(BOOL)arg2 splitClip:(BOOL*)arg3 ;
-(SCD_Struct_Fr12)transitionExtensionForClip:(id)arg1 left:(BOOL)arg2 splitClip:(BOOL*)arg3 ;
...
-(id)instructionToShowClip:(id)arg1 withTrackID:(int)arg2 withTransform:(CGAffineTransform)arg3 timeRange:(SCD_Struct_Co16)arg4 requiresCARendering:(BOOL)arg5 isFreezeFrame:(BOOL)arg6 applyTitleEffect:(BOOL)arg7 ;
-(id)instructionToHideTrackID:(int)arg1 whileHidingTrackID:(int)arg2 timeRange:(SCD_Struct_Co16)arg3 requiresCARendering:(BOOL)arg4 ;
-(void)addVideoInstructionsForTransition:(id)arg1 forRange:(SCD_Struct_Co16)arg2 toInstructions:(id)arg3 previousTrackID:(int)arg4 previousClip:(id)arg5 previousClipRequiresCA:(BOOL)arg6 nextTrackID:(int)arg7 nextClip:(id)arg8 nextClipRequiresCA:(BOOL)arg9 cutawaysIntersection:(id)arg10 ;
-(BOOL)cutIsContiguous:(id)arg1 transition:(id)arg2 next:(id)arg3 ;
-(void)addTransitionSoundsForState:(id)arg1 ;
-(id)instructionToShowImageWithClip:(id)arg1 withTransform:(CGAffineTransform)arg2 timeRange:(SCD_Struct_Co16)arg3 requiresCARendering:(BOOL)arg4 applyTitleEffect:(BOOL)arg5 ;
...
-(void)setRenderScale;
-(SCD_Struct_Fr12)fadeToBlackStartCMTime;
-(SCD_Struct_Fr12)fadeToBlackDurationCMTime;
...
-(SCD_Struct_Co16)sourceTimeRangeForClip:(id)arg1 endOfComposition:(SCD_Struct_Fr12)arg2 projectStartTime:(SCD_Struct_Fr12*)arg3 ;
-(BOOL)addVolumeRampToTrackGroup:(id)arg1 forClip:(id)arg2 shouldUseDucking:(BOOL)arg3 ;
-(SCD_Struct_Co16)sourceTimeRangeForAudioClip:(id)arg1 endOfComposition:(SCD_Struct_Fr12)arg2 ;
...
-(BOOL)writeVolumeRampToCompositionFromTrackGroup:(id)arg1 endOfComposition:(SCD_Struct_Fr12)arg2 ;
-(float)percentBetweenRange:(SCD_Struct_Co16)arg1 forTime:(SCD_Struct_Fr12)arg2 firstRange:(SCD_Struct_Co16*)arg3 secondRange:(SCD_Struct_Co16*)arg4 ;
-(id)splitCompositionInstruction:(id)arg1 atTime:(SCD_Struct_Fr12)arg2 options:(int)arg3 ;
...
-(SCD_Struct_Co16)compositionItemsForState:(id)arg1 compositionItem:(id*)arg2 backfillCompositionItem:(id*)arg3 ;
-(id)splitCompositionState:(id)arg1 forCutaways:(id)arg2 searchIndex:(int*)arg3 projectDuration:(SCD_Struct_Fr12)arg4 ;
-(void)updateVideoAndAudioInstructionForState:(id)arg1 cutSwaped:(BOOL)arg2 originalState:(id)arg3 ;
-(void)updateCutawayCompositionTracks:(SCD_Struct_Fr12)arg1 ;
-(void)updateInstructionsWithTitles:(id)arg1 ;
-(void)updateBackgroundAudioCompositionTracks:(SCD_Struct_Fr12)arg1 ;
-(void)updateForegroundAudioCompositionTracks:(SCD_Struct_Fr12)arg1 ;
-(BOOL)insertASilentAudioTrackAsWorkaround;
-(id)splitCompositionState:(id)arg1 atTime:(SCD_Struct_Fr12)arg2 ;
-(void)addIntersectingCutaways:(id)arg1 toInstruction:(id)arg2 ;
-(id)instructionToTransitionTracksForRange:(SCD_Struct_Co16)arg1 requiresCARendering:(BOOL)arg2 incomingClipIsNarrower:(BOOL)arg3 incomingClipRequiresBG:(BOOL)arg4 outgoingClipRequiresBG:(BOOL)arg5 incomingClipIsZoomed:(BOOL)arg6 outgoingClipIsZoomed:(BOOL)arg7 transitionClip:(id)arg8 applyTitleEffect:(BOOL)arg9 ;
...
-(SCD_Struct_Co16)timeRangeForClipIncludingTransitions:(id)arg1 ;
-(void)refreshCompositionInstructionsWithinRange:(SCD_Struct_Co16)arg1 ;
-(int)outputFrameRate;
...
-(void)splitCompositionInstructionListAtTime:(SCD_Struct_Fr12)arg1 options:(int)arg2 ;
-(void)setDynamicPlayBack:(BOOL)arg1 ;
-(void)lowerDynamicResolution;
-(void)raiseDynamicResolution;
-(void)checkIt:(id)arg1 timeRange:(SCD_Struct_Co16)arg2 ;
