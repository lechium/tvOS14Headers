...
-(void)generatePreviewImageForEffectID:(id)arg1 currentTime:(SCD_Struct_Fr12)arg2 effectRange:(SCD_Struct_Co16)arg3 rawImage:(id)arg4 previewSize:(CGSize)arg5 completion:(/*^block*/id)arg6 ;
...
-(void)generateAllFilterPreviewsAtTime:(SCD_Struct_Fr12)arg1 effectRange:(SCD_Struct_Co16)arg2 rawImage:(id)arg3 previewSize:(CGSize)arg4 ;
