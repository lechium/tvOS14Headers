...
-(void)nextKenBurnsStart:(SCD_Struct_Pr8*)arg1 end:(SCD_Struct_Pr8*)arg2 ;
-(CGRect)rectFromKenBurnsPosition:(SCD_Struct_Pr8)arg1 outputAspectRatio:(float)arg2 image:(id)arg3 ;
...
-(id)timedStabilizationConfigInArray:(id)arg1 useNewMethod:(BOOL)arg2 forTime:(SCD_Struct_Pr3)arg3 frameData:(CVBufferRef)arg4 irisMovieClip:(id)arg5 frameIndex:(out long long*)arg6 ;
-(BOOL)compareTimingMethodsForStabilizationConfigLookup:(id)arg1 forTime:(SCD_Struct_Pr3)arg2 frameData:(CVBufferRef)arg3 irisMovieClip:(id)arg4 ;
