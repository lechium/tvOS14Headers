...
+(id)valueWithDecomposedTransform:(SCD_Struct_UI149)arg1 rotationEpsilon:(double)arg2 scaleEpsilon:(double)arg3 translationEpsilon:(double)arg4 ;
+(id)valueWithDecomposedTransform:(SCD_Struct_UI149)arg1 ;
