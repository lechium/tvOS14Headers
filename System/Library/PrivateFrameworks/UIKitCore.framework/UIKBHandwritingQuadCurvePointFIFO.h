...
@property (assign,nonatomic) SCD_Struct_UI92 lastPoint;                //@synthesize lastPoint=_lastPoint - In the implementation block
...
-(void)setLastPoint:(SCD_Struct_UI92)arg1 ;
-(SCD_Struct_UI92)lastPoint;
-(id)emissionHandler;
