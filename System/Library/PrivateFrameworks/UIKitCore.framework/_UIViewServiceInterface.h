...
@property (nonatomic,readonly) SCD_Struct_UI57 serviceAuditToken; 
...
-(id)_initWithConnectionInfo:(SCD_Struct_UI30)arg1 serviceBundleIdentifier:(id)arg2 deputyInterfaces:(id)arg3 ;
-(id)_initWithConnectionInfo:(SCD_Struct_UI30)arg1 service:(id)arg2 deputyInterfaces:(id)arg3 ;
-(id)_terminateWithError:(id)arg1 ;
-(id)_initWithConnectionInfo:(SCD_Struct_UI30)arg1 serviceBundleIdentifier:(id)arg2 service:(id)arg3 deputyInterfaces:(id)arg4 ;
-(id)connectToDeputyWithInterface:(id)arg1 fromExportedHostingObject:(id)arg2 connectionHandler:(/*^block*/id)arg3 ;
-(int)servicePID;
-(SCD_Struct_UI57)serviceAuditToken;
@end
