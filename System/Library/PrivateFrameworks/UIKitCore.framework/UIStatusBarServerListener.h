...
@interface UIStatusBarServerListener : NSObject {
	...
	SCD_Struct_UI113 _statusBarData;
	SCD_Struct_UI113 _composedStatusBarData;
	SCD_Struct_UI114 _overrides;
...
-(SCD_Struct_UI116*)_statusBarOverrideData;
-(void)_postStatusBarData:(SCD_Struct_UI113*)arg1 actions:(int)arg2 animated:(BOOL)arg3 ;
...
-(void)_postStatusBarOverrideData:(SCD_Struct_UI116*)arg1 ;
