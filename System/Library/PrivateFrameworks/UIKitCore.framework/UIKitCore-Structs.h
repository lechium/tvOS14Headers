...
typedef struct {
	...
	double field2;
	double field3;
	SCD_Struct_UI60 field4;
	SCD_Struct_UI60 field5;
	SCD_Struct_UI60 field6;
	SCD_Struct_UI60 field7;
	BOOL field8;
} SCD_Struct_UI61;
...
typedef struct {
	SCD_Struct_UI78 field1;
	SCD_Struct_UI78 field2;
	SCD_Struct_UI78 field3;
} SCD_Struct_UI79;
...
typedef union GLKVector3 {
	SCD_Struct_UI98 field1;
	SCD_Struct_UI98 field2;
	SCD_Struct_UI98 field3;
	float v[3];
} GLKVector3;
...
typedef struct {
	SCD_Struct_UI50 dampingRatioParameters;
	SCD_Struct_UI50 responseParameters;
	SCD_Struct_UI50 targetParameters;
