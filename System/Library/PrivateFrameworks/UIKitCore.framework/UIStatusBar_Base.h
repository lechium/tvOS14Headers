...
@interface UIStatusBar_Base : _UIScrollsToTopInitiatorView <UIStatusBarServerClient, UIStatusBarStateObserver> {
	...
	SCD_Struct_UI116* _localDataOverrides;
...
@property (nonatomic,readonly) SCD_Struct_UI116* localDataOverrides;                                                //@synthesize localDataOverrides=_localDataOverrides - In the implementation block
...
-(id)activeTintColor;
-(BOOL)_isTransparent;
-(void)setLocalDataOverrides:(SCD_Struct_UI116*)arg1 ;
...
-(void)statusBarServer:(id)arg1 didReceiveStatusBarData:(const SCD_Struct_UI113*)arg2 withActions:(int)arg3 ;
...
-(void)forceUpdateToData:(const SCD_Struct_UI113*)arg1 animated:(BOOL)arg2 ;
...
-(SCD_Struct_UI116*)localDataOverrides;
...
-(void)statusBarStateProvider:(id)arg1 didPostStatusBarData:(const SCD_Struct_UI113*)arg2 withActions:(int)arg3 ;
