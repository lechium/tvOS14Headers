...
@interface UIKBHandwritingView : UIKBKeyView <UIGestureRecognizerDelegate> {
	...
	SCD_Struct_UI93 _previousPoint;
...
@property (assign,nonatomic) SCD_Struct_UI92 previousPoint;                                      //@synthesize previousPoint=_previousPoint - In the implementation block
...
-(void)setPreviousPoint:(SCD_Struct_UI92)arg1 ;
-(BOOL)initialPointPosted;
-(SCD_Struct_UI92)previousPoint;
