...
+(SCD_Struct_UI116*)getStatusBarOverrideData;
...
+(void)postStatusBarData:(const SCD_Struct_UI113*)arg1 withActions:(int)arg2 ;
+(void)postStatusBarOverrideData:(SCD_Struct_UI116*)arg1 ;
+(void)permanentizeStatusBarOverrideData;
+(id)_cachedTimeStringFromData:(SCD_Struct_UI113*)arg1 ;
+(const SCD_Struct_UI113*)getStatusBarData;
...
-(void)_receivedStatusBarData:(SCD_Struct_UI113*)arg1 actions:(int)arg2 animated:(BOOL)arg3 ;
