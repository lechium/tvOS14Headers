...
@class NSMapTable, UIImageConfiguration, UIImageAsset, _UIImageContent, CIImage, NSArray, UIGraphicsImageRendererFormat, UITraitCollection, UIImageSymbolConfiguration;
...
-(SCD_Struct_UI77)_calculateStatisticsOfEdge:(BOOL)arg1 ;
...
-(SCD_Struct_UI77)_calculateStatistics;
-(SCD_Struct_UI77)_calculateEdgeStatistics;
...
-(void)draw9PartImageWithSliceRects:(SCD_Struct_UI79)arg1 inRect:(CGRect)arg2 fraction:(double)arg3 ;
-(void)draw9PartImageWithSliceRects:(SCD_Struct_UI79)arg1 inRect:(CGRect)arg2 operation:(int)arg3 fraction:(double)arg4 ;
-(void)compositeToPoint:(CGPoint)arg1 fromRect:(CGRect)arg2 operation:(int)arg3 fraction:(double)arg4 ;
-(void)draw3PartImageWithSliceRects:(SCD_Struct_UI78)arg1 inRect:(CGRect)arg2 fraction:(double)arg3 ;
-(void)draw3PartImageWithSliceRects:(SCD_Struct_UI78)arg1 inRect:(CGRect)arg2 operation:(int)arg3 fraction:(double)arg4 ;
...
-(void)draw9PartImageWithSliceRects:(SCD_Struct_UI79)arg1 inRect:(CGRect)arg2 ;
-(void)draw3PartImageWithSliceRects:(SCD_Struct_UI78)arg1 inRect:(CGRect)arg2 ;
