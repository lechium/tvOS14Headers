...
@interface UIStatusBar : UIStatusBar_Base <UIStatusBarServerClient> {
	...
	SCD_Struct_UI113 _currentRawData;
...
+(void)getData:(SCD_Struct_UI113*)arg1 forRequestedData:(const SCD_Struct_UI113*)arg2 withOverrides:(const SCD_Struct_UI116*)arg3 ;
