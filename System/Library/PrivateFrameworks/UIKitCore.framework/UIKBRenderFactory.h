...
+(id)factoryForVisualStyle:(SCD_Struct_UI88)arg1 renderingContext:(id)arg2 ;
...
+(Class)factoryClassForVisualStyle:(SCD_Struct_UI88)arg1 ;
+(id)factoryForVisualStyle:(SCD_Struct_UI88)arg1 renderingContext:(id)arg2 skipLayoutSegments:(BOOL)arg3 ;
+(id)_characterSetForGlyphSelectors;
+(id)lightweightFactoryForVisualStyle:(SCD_Struct_UI88)arg1 renderingContext:(id)arg2 ;
