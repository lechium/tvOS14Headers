...
@interface UINavigationController : UIViewController <UIGestureRecognizerDelegatePrivate, _UINavigationBarDelegatePrivate, _UIToolbarDelegateInternal, _UIScrollViewScrollObserver, UILayoutContainerViewDelegate> {
	...
	SCD_Struct_UI50 _interactiveScrollNavBarIntrinsicHeightRange;
...
-(double)_navigationBar:(id)arg1 preferredHeightForTransitionToHeightRange:(SCD_Struct_UI50)arg2 ;
...
-(SCD_Struct_UI51)_calculateTopLayoutInfoForViewController:(id)arg1 ;
...
-(SCD_Struct_UI50)_intrinsicNavigationBarHeightRangeForNavItem:(id)arg1 ;
...
-(SCD_Struct_UI50)_heightRangeOfTopViews;
