...
@interface _UISwipeHandler : NSObject <UIGestureRecognizerDelegate, _UISwipeDismissalGestureRecognizerDelegate> {
	...
	SCD_Struct_UI120 _currentSwipeConfig;
...
@property (nonatomic,readonly) SCD_Struct_UI120 currentSwipeConfig; 
...
-(SCD_Struct_UI120)currentSwipeConfig;
-(void)resetSwipe;
...
-(SCD_Struct_UI119)_currentSwipeInfoWithTargetOffset:(double)arg1 animated:(BOOL)arg2 usingSpringWithStiffness:(double)arg3 ;
