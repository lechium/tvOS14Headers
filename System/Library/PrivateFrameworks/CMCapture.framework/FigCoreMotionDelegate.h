...
@interface FigCoreMotionDelegate : NSObject {
	...
	SCD_Struct_Fi98 fusedRingAccel[256];
	SCD_Struct_BW60 fusedRingQuaternion[256];
	SCD_Struct_Fi98 fusedRingPosition[256];
	...
	SCD_Struct_BW60 previousQuaternion;
	SCD_Struct_BW60 currentQuaternion;
	BOOL computingPosition;
	SCD_Struct_Fi114 position;
	SCD_Struct_Fi114 velocity;
...
-(void)didUpdatePositionWithAcceleration:(SCD_Struct_Fi98*)arg1 forTimeStamp:(double)arg2 ;
-(void)didUpdateVelocityWithAcceleration:(SCD_Struct_Fi98*)arg1 forTimeStamp:(double)arg2 ;
-(void)didUpdatePositionWithTimeStamp:(double)arg1 ;
-(void)getCurrentDeltaQuaternion:(SCD_Struct_BW60*)arg1 ;
-(void)updateDeviceCallback:(BOOL)arg1 fusedMotionUpdateInterval:(float)arg2 ;
-(void)updateGyroInterval:(float)arg1 ;
-(void)didUpdateAcceleration:(SCD_Struct_Fi98)arg1 time:(double)arg2 ;
-(void)didUpdateGravity:(SCD_Struct_Fi98)arg1 time:(double)arg2 ;
...
-(void)didUpdateFusedMotionWithDeviceMotion:(SCD_Struct_Fi115)arg1 time:(double)arg2 ifsync:(BOOL)arg3 ;
...
-(void)getCurrentQuaternion:(SCD_Struct_BW60*)arg1 ;
