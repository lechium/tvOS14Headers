...
@interface FigCaptureStillImageSinkPipelineSessionStorage : NSObject {
	...
	SCD_Struct_BW36 _currentUserInitiatedRequestPTS;
...
@property (assign,nonatomic) SCD_Struct_BW36 currentUserInitiatedRequestPTS;                                                  //@synthesize currentUserInitiatedRequestPTS=_currentUserInitiatedRequestPTS - In the implementation block
...
-(void)setCurrentUserInitiatedRequestPTS:(SCD_Struct_BW36)arg1 ;
-(BOOL)videoStabilizationOverscanCropEnabled;
-(unsigned long long)currentUserInitiatedRequestHostTime;
-(SCD_Struct_BW36)currentUserInitiatedRequestPTS;
