...
@interface FigCaptureCalibrationContext : NSObject {
	...
	SCD_Struct_Fi52 _lastSuccessfulCalibrationMagneticField;
...
@property (assign,nonatomic) SCD_Struct_Fi52 lastSuccessfulCalibrationMagneticField;              //@synthesize lastSuccessfulCalibrationMagneticField=_lastSuccessfulCalibrationMagneticField - In the implementation block
...
-(void)updateWithNewCalibrationData:(id)arg1 orExternalErrors:(unsigned)arg2 magneticFieldAttempts:(int)arg3 magneticField:(SCD_Struct_Fi52)arg4 isCalibrationValid:(BOOL*)arg5 calibrationStatus:(unsigned*)arg6 ;
...
-(unsigned)_updateAndStashCalibrationData:(id)arg1 externalErrors:(unsigned)arg2 hasFirmwareErrors:(BOOL)arg3 magneticFieldAttempts:(int)arg4 magneticField:(SCD_Struct_Fi52)arg5 ;
-(void)_writeCalibrationDataToInternalLogFile:(id)arg1 magneticField:(SCD_Struct_Fi52)arg2 ;
-(double)lastSuccessfulCalibrationTimeStamp;
-(void)setLastSuccessfulCalibrationMagneticField:(SCD_Struct_Fi52)arg1 ;
-(id)_createDictionaryForFailureOutsideFirmwareWithReasons:(unsigned)arg1 ;
-(SCD_Struct_Fi52)lastSuccessfulCalibrationMagneticField;
@end
