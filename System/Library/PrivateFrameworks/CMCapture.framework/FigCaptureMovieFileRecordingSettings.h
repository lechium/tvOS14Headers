...
@interface FigCaptureMovieFileRecordingSettings : FigCaptureRecordingSettings {
	...
	SCD_Struct_BW36 _movieFragmentInterval;
...
@property (assign,nonatomic) SCD_Struct_BW36 movieFragmentInterval;                            //@synthesize movieFragmentInterval=_movieFragmentInterval - In the implementation block
...
-(SCD_Struct_BW36)movieFragmentInterval;
-(void)setMovieFragmentInterval:(SCD_Struct_BW36)arg1 ;
