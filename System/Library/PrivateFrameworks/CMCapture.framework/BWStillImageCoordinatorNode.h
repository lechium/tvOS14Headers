...
@interface BWStillImageCoordinatorNode : BWNode <BWFigVideoCaptureStreamStillImageCaptureDelegate, BWStillImageProcessingStatusDelegate> {
	...
	SCD_Struct_BW36 _streamingDisruptionEndPTS;
...
-(void)_didResolveStillImagePTS:(SCD_Struct_BW36)arg1 isPreBracketedEV0:(BOOL)arg2 ;
-(void)_didResolveReferenceFrameBracketedCaptureSequenceNumber:(id)arg1 ;
-(void)_didCaptureStillImage;
-(void)_didSelectNewReferenceFrameWithPTS:(SCD_Struct_BW36)arg1 transform:(id)arg2 ;
...
-(void)node:(id)arg1 didSelectNewReferenceFrameWithPTS:(SCD_Struct_BW36)arg2 transform:(id)arg3 ;
