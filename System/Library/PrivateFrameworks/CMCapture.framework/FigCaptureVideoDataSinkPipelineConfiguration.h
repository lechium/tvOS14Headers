...
@interface FigCaptureVideoDataSinkPipelineConfiguration : NSObject {
	...
	SCD_Struct_BW41 _visOutputDimensions;
...
@property (assign,nonatomic) SCD_Struct_BW41 visOutputDimensions;                                                    //@synthesize visOutputDimensions=_visOutputDimensions - In the implementation block
...
@property (assign,nonatomic) SCD_Struct_Fi43 clientAuditToken;                                                       //@synthesize clientAuditToken=_clientAuditToken - In the implementation block
...
-(SCD_Struct_BW41)visOutputDimensions;
-(void)setVisOutputDimensions:(SCD_Struct_BW41)arg1 ;
...
-(void)setClientAuditToken:(SCD_Struct_Fi43)arg1 ;
