...
@interface BWZoomCommandHandler : NSObject {
	...
	SCD_Struct_BW36 _lastFramePTSes[2];
	long long _timeForLastRequestedZoomFactor;
	SCD_Struct_BW36 _rampStartTime;
...
-(id)init;
-(void)dealloc;
-(BOOL)haveUpdatedZoomModelForPTS:(SCD_Struct_BW36)arg1 ;
-(float)updateZoomModelForNextFrameWithPTS:(SCD_Struct_BW36)arg1 ;
...
-(float)_zoomFactorForRampAtPTS:(SCD_Struct_BW36)arg1 updateCurrentZoomRampState:(BOOL)arg2 ;
-(void)_activateRampMode:(BOOL)arg1 ;
-(float)_zoomFactorForDurationBasedRampAtPTS:(SCD_Struct_BW36)arg1 updateCurrentZoomRampState:(BOOL)arg2 ;
-(float)_zoomFactorForRateBasedRampAtPTS:(SCD_Struct_BW36)arg1 updateCurrentZoomRampState:(BOOL)arg2 ;
-(float)_zoomFactorForSpringBasedRampAtPTS:(SCD_Struct_BW36)arg1 updateCurrentZoomRampState:(BOOL)arg2 ;
