...
@property (readonly) SCD_Struct_BW36 pts; 
@property (readonly) NSArray * backPressureSemaphoresToIgnore; 
+(id)newDroppedSampleWithReason:(id)arg1 pts:(SCD_Struct_BW36)arg2 ;
...
-(SCD_Struct_BW36)pts;
-(id)_initDroppedSampleWithReason:(id)arg1 pts:(SCD_Struct_BW36)arg2 backPressureSemaphoresToIgnore:(id)arg3 ;
@end
