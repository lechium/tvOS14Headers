...
@interface BWIrisMovieInfo : NSObject <NSCopying> {
	...
	SCD_Struct_BW36 _stillImageCaptureTime;
	SCD_Struct_BW36 _stillImageCaptureHostTime;
	...
	SCD_Struct_BW36 _movieStartTime;
	SCD_Struct_BW36 _movieEndTime;
	SCD_Struct_BW36 _movieTrimStartTime;
	SCD_Struct_BW36 _movieTrimEndTime;
	SCD_Struct_BW36 _beginTrimMasterPTS;
	SCD_Struct_BW36 _audioOffset;
	SCD_Struct_BW36 _stillTimeOffsetToVideoPrerollStartInMilliseconds;
	SCD_Struct_BW36 _stillTimeOffsetToVideoPrerollStopInMilliseconds;
	SCD_Struct_BW36 _stillTimeOffsetToAudioPrerollStartInMilliseconds;
	SCD_Struct_BW36 _stillTimeOffsetToAudioPrerollStopInMilliseconds;
	SCD_Struct_BW36 _masterMovieStartTime;
	...
	SCD_Struct_BW36 _stillTimeOffsetToVideoPrerollStartTime;
	SCD_Struct_BW36 _stillTimeOffsetToVideoPrerollStopTime;
	SCD_Struct_BW36 _stillTimeOffsetToAudioPrerollStartTime;
	SCD_Struct_BW36 _stillTimeOffsetToAudioPrerollStopTime;
...
@property (assign,nonatomic) SCD_Struct_BW36 stillImageCaptureTime;                                              //@synthesize stillImageCaptureTime=_stillImageCaptureTime - In the implementation block
@property (nonatomic,readonly) SCD_Struct_BW36 stillImageCaptureHostTime;                                        //@synthesize stillImageCaptureHostTime=_stillImageCaptureHostTime - In the implementation block
...
@property (assign,nonatomic) SCD_Struct_BW36 movieStartTime;                                                     //@synthesize movieStartTime=_movieStartTime - In the implementation block
@property (assign,nonatomic) SCD_Struct_BW36 movieEndTime;                                                       //@synthesize movieEndTime=_movieEndTime - In the implementation block
@property (assign,nonatomic) SCD_Struct_BW36 movieTrimStartTime;                                                 //@synthesize movieTrimStartTime=_movieTrimStartTime - In the implementation block
@property (assign,nonatomic) SCD_Struct_BW36 movieTrimEndTime;                                                   //@synthesize movieTrimEndTime=_movieTrimEndTime - In the implementation block
@property (assign,nonatomic) SCD_Struct_BW36 beginTrimMasterPTS;                                                 //@synthesize beginTrimMasterPTS=_beginTrimMasterPTS - In the implementation block
@property (nonatomic,readonly) BOOL containsTrims; 
@property (assign,nonatomic) SCD_Struct_BW36 masterMovieStartTime;                                               //@synthesize masterMovieStartTime=_masterMovieStartTime - In the implementation block
...
@property (assign,nonatomic) SCD_Struct_BW36 audioOffset;                                                        //@synthesize audioOffset=_audioOffset - In the implementation block
@property (assign,nonatomic) SCD_Struct_BW36 stillTimeOffsetToVideoPrerollStartTime;                             //@synthesize stillTimeOffsetToVideoPrerollStartTime=_stillTimeOffsetToVideoPrerollStartTime - In the implementation block
@property (assign,nonatomic) SCD_Struct_BW36 stillTimeOffsetToVideoPrerollStopTime;                              //@synthesize stillTimeOffsetToVideoPrerollStopTime=_stillTimeOffsetToVideoPrerollStopTime - In the implementation block
@property (assign,nonatomic) SCD_Struct_BW36 stillTimeOffsetToAudioPrerollStartTime;                             //@synthesize stillTimeOffsetToAudioPrerollStartTime=_stillTimeOffsetToAudioPrerollStartTime - In the implementation block
@property (assign,nonatomic) SCD_Struct_BW36 stillTimeOffsetToAudioPrerollStopTime;                              //@synthesize stillTimeOffsetToAudioPrerollStopTime=_stillTimeOffsetToAudioPrerollStopTime - In the implementation block
...
+(id)irisMovieInfoWithFigCaptureMovieFileRecordingSettings:(id)arg1 stillImageCaptureTime:(SCD_Struct_BW36)arg2 stillImageCaptureHostTime:(SCD_Struct_BW36)arg3 stillImageCaptureAbsoluteStartTime:(double)arg4 stillImageCaptureType:(int)arg5 originalPhotoRecording:(BOOL)arg6 ;
-(id)copyWithZone:(NSZone*)arg1 ;
-(id)description;
-(void)dealloc;
-(FigCaptureMovieFileRecordingSettings *)settings;
-(SCD_Struct_BW36)movieTrimEndTime;
-(int)numberOfRequestedVariants;
-(SCD_Struct_BW36)movieTrimStartTime;
-(SCD_Struct_BW36)masterMovieStartTime;
-(SCD_Struct_BW36)movieEndTime;
-(SCD_Struct_BW36)audioOffset;
-(BOOL)isVitalityScoreValid;
-(float)vitalityScore;
-(unsigned)vitalityScoringVersion;
-(SCD_Struct_BW36)stillImageCaptureHostTime;
-(SCD_Struct_BW36)movieStartTime;
-(void)setMovieStartTime:(SCD_Struct_BW36)arg1 ;
-(void)setMovieTrimStartTime:(SCD_Struct_BW36)arg1 ;
-(void)setMasterMovieStartTime:(SCD_Struct_BW36)arg1 ;
-(NSURL *)temporaryMovieURL;
-(NSURL *)outputMovieURL;
-(NSURL *)masterMovieURL;
-(unsigned)requestedSDOFVariants;
-(SCD_Struct_BW36)stillImageCaptureTime;
-(NSString *)livePhotoMetadataStillImageKeyFrameSettingsID;
-(BOOL)containsTrims;
-(void)setMovieTrimEndTime:(SCD_Struct_BW36)arg1 ;
-(void)setMovieEndTime:(SCD_Struct_BW36)arg1 ;
...
-(void)setMomentCaptureRecordingStillImageCaptureHostTimeOverride:(SCD_Struct_BW36)arg1 stillImageCaptureTimeOverride:(SCD_Struct_BW36)arg2 ;
-(SCD_Struct_BW36)beginTrimMasterPTS;
...
-(void)setStillTimeOffsetToVideoPrerollStartTime:(SCD_Struct_BW36)arg1 ;
-(void)setStillTimeOffsetToVideoPrerollStopTime:(SCD_Struct_BW36)arg1 ;
-(void)setStillTimeOffsetToAudioPrerollStartTime:(SCD_Struct_BW36)arg1 ;
-(void)setStillTimeOffsetToAudioPrerollStopTime:(SCD_Struct_BW36)arg1 ;
...
-(void)setAudioOffset:(SCD_Struct_BW36)arg1 ;
...
-(id)_initWithFigCaptureMovieFileRecordingSettings:(id)arg1 stillImageCaptureTime:(SCD_Struct_BW36)arg2 stillImageCaptureHostTime:(SCD_Struct_BW36)arg3 stillImageCaptureAbsoluteStartTime:(double)arg4 stillImageCaptureType:(int)arg5 originalPhotoRecording:(BOOL)arg6 ;
...
-(void)setBeginTrimMasterPTS:(SCD_Struct_BW36)arg1 ;
-(SCD_Struct_BW36)stillTimeOffsetToVideoPrerollStartTime;
-(SCD_Struct_BW36)stillTimeOffsetToVideoPrerollStopTime;
-(SCD_Struct_BW36)stillTimeOffsetToAudioPrerollStartTime;
-(SCD_Struct_BW36)stillTimeOffsetToAudioPrerollStopTime;
...
-(void)setStillImageCaptureTime:(SCD_Struct_BW36)arg1 ;
