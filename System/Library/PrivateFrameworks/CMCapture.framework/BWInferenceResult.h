...
@property (nonatomic,readonly) SCD_Struct_BW36 timestamp;                     //@synthesize timestamp=_timestamp - In the implementation block
...
-(id)initWithInferenceType:(int)arg1 inferences:(id)arg2 preventionReason:(id)arg3 atTimestamp:(SCD_Struct_BW36)arg4 ;
-(id)initWithInferenceType:(int)arg1 inferences:(id)arg2 atTimestamp:(SCD_Struct_BW36)arg3 ;
-(id)initWithInferenceType:(int)arg1 preventionReason:(id)arg2 atTimestamp:(SCD_Struct_BW36)arg3 ;
@end
