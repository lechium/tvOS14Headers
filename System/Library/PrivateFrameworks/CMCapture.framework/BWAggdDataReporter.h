...
-(void)reportShutterLag:(SCD_Struct_BW36)arg1 primaryCaptureType:(int)arg2 secondaryCaptureType:(int)arg3 captureFlags:(unsigned long long)arg4 sceneFlags:(unsigned long long)arg5 stillDuringVideo:(BOOL)arg6 frontCamera:(BOOL)arg7 ;
-(int)lastShutterLag;
