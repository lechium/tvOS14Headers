...
-(id)_newVISNodeWithUpstreamOutput:(id)arg1 graph:(id)arg2 parentPipeline:(id)arg3 videoCaptureConnectionConfiguration:(id)arg4 videoStabilizationType:(int)arg5 motionAttachmentsSource:(int)arg6 fillExtendedRowsOfOutputBuffer:(BOOL)arg7 overCaptureEnabled:(BOOL)arg8 videoStabilizationOverscanOverride:(float)arg9 motionMetadataPreloadingEnabled:(BOOL)arg10 visExecutionMode:(int)arg11 pipelineTraceID:(int)arg12 pipelineStage:(id)arg13 captureDevice:(id)arg14 outputDimensions:(SCD_Struct_BW41)arg15 irisVISCleanOutputRectOut:(CGRect*)arg16 ;
