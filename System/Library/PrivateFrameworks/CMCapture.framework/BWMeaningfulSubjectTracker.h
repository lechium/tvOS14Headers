...
@interface BWMeaningfulSubjectTracker : NSObject {
	...
	SCD_Struct_BW26 _mostRecentDetectionResult;
	SCD_Struct_BW29 _mostRecentDetectionResultAsTrackingResult;
	SCD_Struct_BW29 _mostRecentTrackingResult;
	SCD_Struct_BW30 _associationParams;
	SCD_Struct_BW32 _mostRecentAssociationResult;
...
-(int)_initializeTrackingOfObject:(SCD_Struct_BW33*)arg1 inPixelBuffer:(CVBufferRef)arg2 usingContext:(id)arg3 examplePixelBuffer:(CVBufferRef)arg4 trackingPixelBuffer:(CVBufferRef)arg5 intermediatePixelBuffer:(CVBufferRef)arg6 estimatedMeanColor:(CVBufferRef)arg7 ;
-(int)_continueTrackingObject:(SCD_Struct_BW33*)arg1 inPixelBuffer:(CVBufferRef)arg2 usingContext:(id)arg3 examplePixelBuffer:(CVBufferRef)arg4 trackingPixelBuffer:(CVBufferRef)arg5 intermediatePixelBuffer:(CVBufferRef)arg6 estimatedMeanColor:(CVBufferRef)arg7 bgraInputPixelBuffer:(SCD_Struct_BW34*)arg8 ;
