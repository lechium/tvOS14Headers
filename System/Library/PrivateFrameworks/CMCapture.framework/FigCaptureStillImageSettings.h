...
@interface FigCaptureStillImageSettings : NSObject <NSSecureCoding, NSCopying> {
	...
	SCD_Struct_BW36* _exposureDurations;
	float* _ISOs;
	float* _exposureTargetBiases;
	unsigned long long _stillImageUserInitiatedRequestTime;
	SCD_Struct_BW36 _stillImageUserInitiatedRequestPTS;
...
@property (nonatomic,readonly) SCD_Struct_BW36* exposureDurations;                                                     //@synthesize exposureDurations=_exposureDurations - In the implementation block
...
@property (assign,nonatomic) SCD_Struct_BW36 stillImageUserInitiatedRequestPTS;                                        //@synthesize stillImageUserInitiatedRequestPTS=_stillImageUserInitiatedRequestPTS - In the implementation block
...
-(SCD_Struct_BW36*)exposureDurations;
-(float*)ISOs;
...
-(void)setStillImageUserInitiatedRequestPTS:(SCD_Struct_BW36)arg1 ;
...
-(SCD_Struct_BW36)stillImageUserInitiatedRequestPTS;
