...
@property (readonly) const SCD_Struct_CM0* limits; 
...
-(id)newLibraryWithCIFilters:(id)arg1 imageFilterFunctionInfo:(const SCD_Struct_CM1*)arg2 error:(id*)arg3;
...
-(id)newComputePipelineStateWithImageFilterFunctionsSPI:(id)arg1 imageFilterFunctionInfo:(const SCD_Struct_CM1*)arg2 error:(id*)arg3;
-(id)newLibraryWithDAG:(id)arg1 functions:(id)arg2 error:(id*)arg3;
-(id)newLibraryWithImageFilterFunctionsSPI:(id)arg1 imageFilterFunctionInfo:(const SCD_Struct_CM1*)arg2 error:(id*)arg3;
...
-(BOOL)mapShaderSampleBufferWithBuffer:(SCD_Struct_CM3*)arg1 capacity:(unsigned long long)arg2 size:(unsigned long long)arg3;
-(void)unmapShaderSampleBuffer;
-(id)newIndirectArgumentEncoderWithArguments:(id)arg1;
-(id)newLibraryWithCIFiltersForComputePipeline:(id)arg1 imageFilterFunctionInfo:(const SCD_Struct_CM1*)arg2 error:(id*)arg3;
...
-(SCD_Struct_CM5*)libraryCacheStats;
-(SCD_Struct_CM5*)pipelineCacheStats;
