...
-(int)_scaleInputPixelBuffer:(CVBufferRef)arg1 toDimensions:(SCD_Struct_BW41)arg2 colorSpaceProperties:(int)arg3 cropRect:(CGRect)arg4 pixelConverter:(id)arg5 poolCapacity:(int)arg6 thumbnailPixelBuffer:(_CVBuffer*)arg7 ;
...
-(int)_encodePhotoForEncodingScheme:(int)arg1 pixelBuffer:(CVBufferRef)arg2 imageDimensions:(SCD_Struct_BW41)arg3 metadata:(id)arg4 thumbnailOptions:(id)arg5 requestedStillImageCaptureSettings:(id)arg6 resolvedStillImageCaptureSettings:(id)arg7 cropRect:(CGRect)arg8 usePixelsOutsideCrop:(BOOL)arg9 outputSurfaceImageSize:(CGSize*)arg10 ;
...
-(void)_addQualityOptionsToDictionary:(id)arg1 codecType:(unsigned)arg2 pixelBuffer:(CVBufferRef)arg3 imageDimensions:(SCD_Struct_BW41)arg4 metadata:(id)arg5 requestedStillImageCaptureSettings:(id)arg6 resolvedStillImageCaptureSettings:(id)arg7 enableHEIFTiling:(BOOL)arg8 enableHEIFOrientation:(BOOL)arg9 ;
...
-(id)_arrayInColumnMajorOrderFrom3x3MatrixData:(SCD_Struct_BW46)arg1 ;
-(id)_arrayInColumnMajorOrderFrom3x4MatrixData:(SCD_Struct_BW47)arg1 ;
