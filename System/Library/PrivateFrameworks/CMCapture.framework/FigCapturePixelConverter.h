...
-(int)updateOutputPixelFormat:(unsigned)arg1 dimensions:(SCD_Struct_BW41)arg2 poolCapacity:(int)arg3 colorSpaceProperties:(int)arg4 alwaysUseHardwareForConversion:(BOOL)arg5 ;
