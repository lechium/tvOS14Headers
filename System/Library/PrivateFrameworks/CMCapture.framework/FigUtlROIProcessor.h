...
@interface FigUtlROIProcessor : NSObject {
	...
	SCD_Struct_BW46 _originalToRoiMatrix;
	SCD_Struct_BW46 _roiToOriginalMatrix;

}

@property (nonatomic,readonly) SCD_Struct_BW46 originalToRoiMatrix;              //@synthesize originalToRoiMatrix=_originalToRoiMatrix - In the implementation block
@property (nonatomic,readonly) SCD_Struct_BW46 roiToOriginalMatrix;              //@synthesize roiToOriginalMatrix=_roiToOriginalMatrix - In the implementation block
...
-(SCD_Struct_BW46)matrix:(int)arg1 rectangle:(CGRect)arg2 scaleX:(double)arg3 scaleY:(double)arg4 inverse:(SCD_Struct_BW46*)arg5 ;
...
-(SCD_Struct_BW46)originalToRoiMatrix;
-(SCD_Struct_BW46)roiToOriginalMatrix;
-(CGRect)roiRectangle;
@end
