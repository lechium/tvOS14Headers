...
-(void)getBiasWithMagneticField:(SCD_Struct_CM15)arg1 acceleration:(SCD_Struct_CM15)arg2 ;
-(void)setBias:(SCD_Struct_CM15)arg1 withMagneticField:(SCD_Struct_CM15)arg2 level:(int)arg3 magnitude:(float)arg4 inclination:(float)arg5 ;
-(void)beginService;
-(void)endService;
...
-(BOOL)syncgetLookupBiasWithMagneticField:(SCD_Struct_CM15)arg1 acceleration:(SCD_Struct_CM15)arg2 bias:(SCD_Struct_CM15*)arg3 level:(int*)arg4 noResults:(BOOL*)arg5 ;
