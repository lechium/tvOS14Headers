...
-(unsigned char)getLocationForBundleID:(const CFStringRef)arg1 orBundlePath:(const CFStringRef)arg2 dynamicAccuracyReductionEnabled:(unsigned char)arg3 allowsAlteredAccessoryLocations:(unsigned char)arg4 location:(SCD_Struct_CL34*)arg5 ;
-(unsigned char)getGroundAltitudeForBundleID:(const CFStringRef)arg1 orBundlePath:(const CFStringRef)arg2 location:(id)arg3 groundAltitude:(SCD_Struct_CL35*)arg4 ;
-(void)setMapMatchingRouteHint:(SCD_Struct_CL36*)arg1 count:(int)arg2 routingType:(int)arg3 stepType:(int)arg4 ;
...
-(unsigned char)getGyroCalibrationDatabaseBiasFit:(SCD_Struct_CM26*)arg1 atTemperature:(float)arg2 ;
-(unsigned char)insertGyroCalibrationDatabaseBiasEstimateIfValid:(SCD_Struct_CM15)arg1 temperature:(float)arg2 variance:(SCD_Struct_CM15)arg3 timestamp:(double)arg4 ;
-(unsigned char)gyroCalibrationDatabaseWipe;
-(unsigned char)getGyroCalibrationDatabaseNumTemperatures:(int*)arg1 ;
-(unsigned char)compassCalibrationDatabaseGetBias:(SCD_Struct_CL37*)arg1 magneticField:(SCD_Struct_CM15)arg2 acceleration:(SCD_Struct_CM15)arg3 ;
-(unsigned char)compassCalibrationDatabaseSetBias:(SCD_Struct_CM15)arg1 magneticField:(SCD_Struct_CM15)arg2 level:(int)arg3 magnitude:(float)arg4 inclination:(float)arg5 ;
-(unsigned char)configure:(SCD_Struct_CL38)arg1 ;
