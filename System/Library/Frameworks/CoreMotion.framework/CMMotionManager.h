...
+(SCD_Struct_CM26)gyroCalibrationDatabaseGetBiasFit;
...
+(SCD_Struct_CM26)gyroCalibrationDatabaseGetBiasFitAndEstimate:(SCD_Struct_CM1*)arg1 atTemperature:(float)arg2 ;
+(BOOL)hasRunMiniCal;
-(id)init;
-(void)dealloc;
-(void)connect;
...
-(void)startDeviceMotionLiteUpdatesForDeviceID:(id)arg1 usingConfiguration:(SCD_Struct_CM27)arg2 toQueue:(id)arg3 withFusedHandler:(/*^block*/id)arg4 ;
