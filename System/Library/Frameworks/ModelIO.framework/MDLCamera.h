...
@property (nonatomic,readonly) SCD_Struct_MD3 projectionMatrix; 
...
-(RTCamera*)rtCamera;
-(SCD_Struct_MD3)getViewMatrixAtTime:(double)arg1 ;
-(SCD_Struct_MD3)projectionMatrix;
-(SCD_Struct_MD3)getProjectionMatrixAtTime:(double)arg1 ;
-(3)rayTo:forViewPort:;
-(float)focusDistance;
