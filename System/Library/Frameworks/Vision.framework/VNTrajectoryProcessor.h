...
@interface VNTrajectoryProcessor : NSObject {
	...
	SCD_Struct_VN50 _lastAnalyzedFramePTS;
	SCD_Struct_VN50 _nextFrameToBeAnalyzedPTS;
...
-(void)dealloc;
-(id)initWithFrameAnalysisSpacing:(SCD_Struct_VN50)arg1 trajectoryLength:(long long)arg2 ;
