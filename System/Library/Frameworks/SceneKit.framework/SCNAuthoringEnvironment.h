...
@interface SCNAuthoringEnvironment : NSObject {
	...
	SCD_Struct_SC147* _logsInfo;
	SCD_Struct_SC147* _boldLogsInfo;
	SCD_Struct_SC147* _dynamicLinesInfo;
	SCD_Struct_SC147* _dynamicLinesNoDepthTestInfo;
	SCD_Struct_SC147* _dynamicTrianglesInfo;
	SCD_Struct_SC147* _overlayDynamicLinesInfo;
	SCD_Struct_SC147* _overlayDynamicTriangleInfo;
	SCD_Struct_SC147* _textInfo;
	SCD_Struct_SC147* _lightProbesInfo;
	SCD_Struct_SC149* _normalTextInfo;
	SCD_Struct_SC149* _boldTextInfo;
	...
	SCD_Struct_SC151* _statisticsInfo;
	float _drawScale;
	id _delegate;
