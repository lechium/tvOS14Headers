...
- (void).cxx_destruct;	// IMP=0x0000000100078fa0
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000100078e64
- (unsigned long long)hash;	// IMP=0x0000000100078d70
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100078c40
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000100078b40
- (void)copyTo:(id)arg1;	// IMP=0x0000000100078a84
- (void)writeTo:(id)arg1;	// IMP=0x00000001000789d0
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000001000789c8
- (id)dictionaryRepresentation;	// IMP=0x000000010007885c
- (id)description;	// IMP=0x00000001000787a8
