...
+ (id)createFromProvider:(id)arg1;	// IMP=0x00000001001069bc
+ (id)noPeersState:(id)arg1;	// IMP=0x0000000100106888
- (void).cxx_destruct;	// IMP=0x0000000100106828
...
- (_Bool)unwrapKey:(id)arg1 fromShares:(id)arg2 error:(id *)arg3;	// IMP=0x0000000100105afc
- (id)findPeersMissingTLKSharesFor:(id)arg1 error:(id *)arg2;	// IMP=0x0000000100104560
- (id)description;	// IMP=0x0000000100104420
- (id)initWithPeerProviderID:(id)arg1 essential:(_Bool)arg2 selfPeers:(id)arg3 selfPeersError:(id)arg4 trustedPeers:(id)arg5 trustedPeersError:(id)arg6;	// IMP=0x00000001001041a8
