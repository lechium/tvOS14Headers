...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000100174b20
- (void).cxx_destruct;	// IMP=0x0000000100174ae4
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000001001748e8
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000100174558
- (id)description;	// IMP=0x00000001001744e4
- (id)initWithEgoPeerID:(id)arg1 status:(unsigned long long)arg2 viablePeerCountsByModelID:(id)arg3 peerCountsByMachineID:(id)arg4 isExcluded:(_Bool)arg5 isLocked:(_Bool)arg6;	// IMP=0x00000001001742e4
