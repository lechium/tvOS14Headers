...
- (void).cxx_destruct;	// IMP=0x00000001001bf76c
...
- (id)initWithDefaults:(id)arg1 dateDescription:(id)arg2 earliest:(double)arg3 latest:(double)arg4;	// IMP=0x00000001001bf634
- (void)schedule;	// IMP=0x00000001001bf5e8
- (void)followup;	// IMP=0x00000001001bf5a0
- (_Bool)checkDate;	// IMP=0x00000001001bf53c
- (id)getDate;	// IMP=0x00000001001bf528
