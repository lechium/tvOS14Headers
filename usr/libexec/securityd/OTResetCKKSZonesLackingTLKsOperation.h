...
- (void).cxx_destruct;	// IMP=0x00000001000afff4
...
- (void)resetViews:(id)arg1;	// IMP=0x00000001000afb7c
- (void)proceedWithKeys:(id)arg1 incompleteKeySets:(id)arg2 pendingTLKShares:(id)arg3;	// IMP=0x00000001000af6d0
- (void)groupStart;	// IMP=0x00000001000af40c
- (id)initWithDependencies:(id)arg1 intendedState:(id)arg2 errorState:(id)arg3;	// IMP=0x00000001000af324
