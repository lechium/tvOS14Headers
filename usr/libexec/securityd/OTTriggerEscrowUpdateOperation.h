...
- (void).cxx_destruct;	// IMP=0x000000010005ae90
...
- (void)groupStart;	// IMP=0x000000010005aa24
- (id)initWithDependencies:(id)arg1 intendedState:(id)arg2 errorState:(id)arg3;	// IMP=0x000000010005a93c
