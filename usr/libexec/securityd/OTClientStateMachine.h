...
- (void).cxx_destruct;	// IMP=0x00000001001764ac
...
- (void)rpcVoucher:(id)arg1 peerID:(id)arg2 permanentInfo:(id)arg3 permanentInfoSig:(id)arg4 stableInfo:(id)arg5 stableInfoSig:(id)arg6 reply:(CDUnknownBlockType)arg7;	// IMP=0x0000000100176050
- (void)rpcEpoch:(id)arg1 reply:(CDUnknownBlockType)arg2;	// IMP=0x0000000100175d18
- (void)notifyContainerChange;	// IMP=0x0000000100175b70
- (id)_onqueueNextClientStateMachineTransition:(id)arg1;	// IMP=0x00000001001756f8
- (_Bool)isAcceptorWaitingForFirstMessage;	// IMP=0x0000000100175644
- (void)handleExternalClientStateMachineRequest:(id)arg1 client:(id)arg2;	// IMP=0x0000000100175564
- (void)_onqueueStartNextClientStateMachineOperation:(id)arg1;	// IMP=0x000000010017530c
- (void)_onqueuePokeClientStateMachine:(id)arg1;	// IMP=0x0000000100175278
- (id)createOperationToFinishAttemptForClient:(id)arg1 clientName:(id)arg2;	// IMP=0x00000001001750e4
- (void)startOctagonStateMachine;	// IMP=0x0000000100175068
@property(retain) NSString<OctagonStateString> *currentState;
- (void)dealloc;	// IMP=0x0000000100174f0c
- (id)initWithContainerName:(id)arg1 contextID:(id)arg2 clientName:(id)arg3 cuttlefish:(id)arg4;	// IMP=0x0000000100174bcc
