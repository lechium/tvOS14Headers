...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000001001b469c
- (void).cxx_destruct;	// IMP=0x00000001001b466c
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000001001b45d8
- (id)initWithCoder:(id)arg1;	// IMP=0x00000001001b44f4
