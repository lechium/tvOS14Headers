...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000001001742dc
- (void).cxx_destruct;	// IMP=0x0000000100174294
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000100174114
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000100173f14
- (id)description;	// IMP=0x0000000100173e10
- (id)initWithPeerID:(id)arg1 signingSPKI:(id)arg2 encryptionSPKI:(id)arg3 viewList:(id)arg4;	// IMP=0x0000000100173d14
