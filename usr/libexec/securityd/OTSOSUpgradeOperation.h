...
- (void).cxx_destruct;	// IMP=0x00000001000f6180
...
- (void)proceedWithKeys:(id)arg1 pendingTLKShares:(id)arg2;	// IMP=0x00000001000f5db4
- (void)afterSuccessfulAllowList;	// IMP=0x00000001000f5bc0
- (void)requestSilentEscrowUpdate;	// IMP=0x00000001000f5984
- (void)afterUpdate;	// IMP=0x00000001000f57e0
- (void)handlePrepareErrors:(id)arg1 nextExpectedState:(id)arg2;	// IMP=0x00000001000f5668
- (void)afterPreflight;	// IMP=0x00000001000f543c
- (void)afterPrepare;	// IMP=0x00000001000f5268
- (void)groupStart;	// IMP=0x00000001000f40a0
- (id)persistentKeyRef:(struct __SecKey *)arg1 error:(id *)arg2;	// IMP=0x00000001000f3fe8
- (id)initWithDependencies:(id)arg1 intendedState:(id)arg2 ckksConflictState:(id)arg3 errorState:(id)arg4 deviceInfo:(id)arg5 policyOverride:(id)arg6;	// IMP=0x00000001000f3e74
