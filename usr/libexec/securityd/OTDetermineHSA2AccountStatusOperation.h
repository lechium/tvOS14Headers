...
- (void).cxx_destruct;	// IMP=0x000000010013a4c0
...
- (void)groupStart;	// IMP=0x0000000100139f2c
- (id)initWithDependencies:(id)arg1 stateIfHSA2:(id)arg2 stateIfNotHSA2:(id)arg3 stateIfNoAccount:(id)arg4 errorState:(id)arg5;	// IMP=0x0000000100139de4
