...
+ (_Bool)isNetworkFailureError:(id)arg1;	// IMP=0x00000001000e5cf0
+ (_Bool)isNetworkError:(id)arg1;	// IMP=0x00000001000e5bb4
- (void).cxx_destruct;	// IMP=0x00000001000e582c
...
- (_Bool)isNetworkError:(id)arg1;	// IMP=0x00000001000e57a0
- (void)setNetworkReachability:(_Bool)arg1;	// IMP=0x00000001000e5714
- (void)_onqueueSetNetworkReachability:(_Bool)arg1;	// IMP=0x00000001000e5648
- (void)_onQueueResetReachabilityDependency;	// IMP=0x00000001000e5310
- (void)_onQueueRunReachabilityDependency;	// IMP=0x00000001000e51c8
@property(readonly) _Bool currentReachability;
- (id)description;	// IMP=0x00000001000e5090
- (id)init;	// IMP=0x00000001000e4e70
