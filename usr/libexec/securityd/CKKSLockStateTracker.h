...
+ (id)globalTracker;	// IMP=0x000000010013d984
+ (_Bool)queryAKSLocked;	// IMP=0x000000010013d880
- (void).cxx_destruct;	// IMP=0x000000010013d520
...
- (void)addLockStateObserver:(id)arg1;	// IMP=0x000000010013d3e4
- (_Bool)isLockedError:(id)arg1;	// IMP=0x000000010013d28c
- (void)recheck;	// IMP=0x000000010013d210
- (void)_onqueueRecheck;	// IMP=0x000000010013cf18
- (void)resetUnlockDependency;	// IMP=0x000000010013ce28
- (id)description;	// IMP=0x000000010013cd64
@property(readonly) NSDate *lastUnlockTime;
@property(readonly) _Bool isLocked;
- (void)dealloc;	// IMP=0x000000010013cb8c
- (id)init;	// IMP=0x000000010013c998
