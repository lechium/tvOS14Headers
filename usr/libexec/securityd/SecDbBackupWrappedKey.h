...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000001000b29bc
- (void).cxx_destruct;	// IMP=0x00000001000b298c
...
- (id)initWithCoder:(id)arg1;	// IMP=0x00000001000b2880
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000001000b27c8
