...
- (void).cxx_destruct;	// IMP=0x00000001001a55c0
...
- (void)requestSyncWithPeers:(id)arg1;	// IMP=0x00000001001a5434
- (void)requestSyncWith:(id)arg1;	// IMP=0x00000001001a536c
- (void)finish;	// IMP=0x00000001001a3b28
- (void)restart;	// IMP=0x00000001001a3af4
- (void)start;	// IMP=0x00000001001a36cc
- (id)initWithAccount:(id)arg1 quiet:(_Bool)arg2;	// IMP=0x00000001001a3638
@property(readonly) NSString *description;
- (void)updateSOSCircleCachedStatus;	// IMP=0x00000001001a3368
- (unsigned long long)currentTrustBitmask;	// IMP=0x00000001001a3260
