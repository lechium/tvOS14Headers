...
- (void).cxx_destruct;	// IMP=0x000000010017aa7c
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000010017a98c
- (unsigned long long)hash;	// IMP=0x000000010017a8fc
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010017a7ec
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010017a710
- (void)copyTo:(id)arg1;	// IMP=0x000000010017a678
- (void)writeTo:(id)arg1;	// IMP=0x000000010017a5ec
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000010017a5e4
- (id)dictionaryRepresentation;	// IMP=0x000000010017a4f4
- (id)description;	// IMP=0x000000010017a440
