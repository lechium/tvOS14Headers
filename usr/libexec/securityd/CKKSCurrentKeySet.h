...
+ (id)loadForZone:(id)arg1;	// IMP=0x000000010008ee38
- (void).cxx_destruct;	// IMP=0x000000010008eda8
...
- (id)asKeychainBackedSet:(id *)arg1;	// IMP=0x000000010008ea4c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010008e7b0
- (id)description;	// IMP=0x000000010008e524
- (id)initForZoneName:(id)arg1;	// IMP=0x000000010008e4ac
