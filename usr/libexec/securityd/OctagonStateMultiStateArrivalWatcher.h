...
- (void).cxx_destruct;	// IMP=0x00000001000af1ac
...
- (void)onqueueStartFinishOperation;	// IMP=0x00000001000af05c
- (id)timeout:(unsigned long long)arg1;	// IMP=0x00000001000aef6c
- (void)_onqueuePerformTimeoutWithUnderlyingError;	// IMP=0x00000001000aede8
- (void)onqueueEnterState:(id)arg1;	// IMP=0x00000001000aed54
- (void)onqueueHandleTransition:(id)arg1;	// IMP=0x00000001000aecbc
- (id)initNamed:(id)arg1 serialQueue:(id)arg2 states:(id)arg3;	// IMP=0x00000001000aeb58
