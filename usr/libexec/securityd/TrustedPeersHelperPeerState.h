...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000100173d0c
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000100173b04
- (id)initWithCoder:(id)arg1;	// IMP=0x000000010017399c
- (id)description;	// IMP=0x0000000100173854
- (id)initWithPeerID:(id)arg1 isPreapproved:(_Bool)arg2 status:(unsigned long long)arg3 memberChanges:(_Bool)arg4 unknownMachineIDs:(_Bool)arg5 osVersion:(id)arg6;	// IMP=0x0000000100173780
