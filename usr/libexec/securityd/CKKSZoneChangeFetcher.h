...
- (void).cxx_destruct;	// IMP=0x000000010017c9d4
...
- (void)cancel;	// IMP=0x000000010017c850
- (void)holdFetchesUntil:(id)arg1;	// IMP=0x000000010017c844
- (id)createSuccesfulFetchDependency;	// IMP=0x000000010017c7d8
- (void)_onqueueCreateNewFetch;	// IMP=0x000000010017c054
- (void)maybeCreateNewFetch;	// IMP=0x000000010017bfd8
- (void)maybeCreateNewFetchOnQueue;	// IMP=0x000000010017be48
- (id)inflightFetch;	// IMP=0x000000010017bd54
- (id)requestSuccessfulFetchForManyReasons:(id)arg1;	// IMP=0x000000010017bc2c
- (id)requestFetchDueToAPNS:(id)arg1;	// IMP=0x000000010017b94c
- (void)notifyZoneChange:(id)arg1;	// IMP=0x000000010017b854
- (id)requestSuccessfulFetch:(id)arg1;	// IMP=0x000000010017b7ec
- (id)clients;	// IMP=0x000000010017b620
- (void)registerClient:(id)arg1;	// IMP=0x000000010017b544
@property(readonly, copy) NSString *description;
- (id)initWithContainer:(id)arg1 fetchClass:(Class)arg2 reachabilityTracker:(id)arg3;	// IMP=0x000000010017b0b4
