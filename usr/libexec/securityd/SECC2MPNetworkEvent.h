...
- (void).cxx_destruct;	// IMP=0x000000010016a954
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000100169f90
- (unsigned long long)hash;	// IMP=0x0000000100169a68
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001001692d8
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000100168c14
- (void)copyTo:(id)arg1;	// IMP=0x00000001001685d4
- (void)writeTo:(id)arg1;	// IMP=0x0000000100168038
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000100168030
- (id)dictionaryRepresentation;	// IMP=0x00000001001674a0
- (id)description;	// IMP=0x00000001001673ec
