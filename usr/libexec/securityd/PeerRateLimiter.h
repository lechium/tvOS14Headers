...
- (void).cxx_destruct;	// IMP=0x00000001001db28c
...
- (int)stateForAccessGroup:(id)arg1;	// IMP=0x00000001001db110
- (id)initWithPeer:(struct __OpaqueSOSPeer *)arg1;	// IMP=0x00000001001db004
- (id)setUpConfigForPeer;	// IMP=0x00000001001daf80
