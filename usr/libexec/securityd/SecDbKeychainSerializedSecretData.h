...
- (void).cxx_destruct;	// IMP=0x000000010013e798
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000010013e65c
- (unsigned long long)hash;	// IMP=0x000000010013e5d0
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010013e4a4
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010013e3a4
- (void)copyTo:(id)arg1;	// IMP=0x000000010013e308
- (void)writeTo:(id)arg1;	// IMP=0x000000010013e27c
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000010013e058
- (id)dictionaryRepresentation;	// IMP=0x000000010013df7c
- (id)description;	// IMP=0x000000010013dec8
