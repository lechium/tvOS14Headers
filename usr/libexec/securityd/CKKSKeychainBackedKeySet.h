...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000100172e1c
- (void).cxx_destruct;	// IMP=0x0000000100172de0
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000100172b38
- (id)description;	// IMP=0x0000000100172a54
- (id)initWithTLK:(id)arg1 classA:(id)arg2 classC:(id)arg3 newUpload:(_Bool)arg4;	// IMP=0x000000010017297c
