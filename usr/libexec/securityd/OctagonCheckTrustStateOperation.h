...
- (void).cxx_destruct;	// IMP=0x000000010013ba94
...
- (void)afterTPHTrustState:(id)arg1 trustedPeers:(id)arg2;	// IMP=0x000000010013a8f0
- (void)groupStart;	// IMP=0x000000010013a6e0
- (id)initWithDependencies:(id)arg1 intendedState:(id)arg2 errorState:(id)arg3;	// IMP=0x000000010013a5f8
