...
+ (_Bool)askUserIfTTR:(id)arg1;	// IMP=0x000000010001f614
+ (void)triggerTapToRadar:(id)arg1;	// IMP=0x000000010001f500
+ (void)disableTTRsEntirely;	// IMP=0x000000010001f4fc
+ (_Bool)isRateLimited:(id)arg1;	// IMP=0x000000010001f4f4
+ (id)keyname:(id)arg1;	// IMP=0x000000010001f474
- (void).cxx_destruct;	// IMP=0x000000010001f2b0
...
- (void)trigger;	// IMP=0x000000010001f1a8
- (void)clearRetryTimestamp;	// IMP=0x000000010001f124
- (void)updateRetryTimestamp;	// IMP=0x000000010001f044
- (_Bool)isRateLimited;	// IMP=0x000000010001ef1c
- (id)initTapToRadar:(id)arg1 description:(id)arg2 radar:(id)arg3;	// IMP=0x000000010001edb0
