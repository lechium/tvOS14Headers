...
+ (id)stringFromAccountStatus:(long long)arg1;	// IMP=0x0000000100038c3c
+ (id)getCircleStatus;	// IMP=0x0000000100038b14
+ (void)fetchCirclePeerID:(CDUnknownBlockType)arg1;	// IMP=0x0000000100038a70
- (void).cxx_destruct;	// IMP=0x0000000100036d68
...
- (void)setHSA2iCloudAccountStatus:(long long)arg1;	// IMP=0x0000000100036b1c
- (void)triggerOctagonStatusFetch;	// IMP=0x0000000100036940
- (id)checkForAllDeliveries;	// IMP=0x0000000100036820
- (void)notifyCircleStatusChangeAndWaitForSignal;	// IMP=0x00000001000367e0
- (void)notifyCKAccountStatusChangeAndWaitForSignal;	// IMP=0x00000001000367d0
- (_Bool)notifyCKAccountStatusChangeAndWait:(unsigned long long)arg1;	// IMP=0x000000010003676c
- (void)_onqueueDeliverCurrentCloudKitState:(id)arg1 listenerQueue:(id)arg2 oldStatus:(id)arg3 group:(id)arg4;	// IMP=0x0000000100036628
- (void)_onqueueDeliverCloudKitStateChanges:(id)arg1 dispatchGroup:(id)arg2;	// IMP=0x000000010003648c
- (void)_onqueueUpdateAccountState:(id)arg1 dispatchGroup:(id)arg2;	// IMP=0x0000000100036190
- (void)_onqueueUpdateAccountState:(id)arg1 deliveredSemaphore:(id)arg2;	// IMP=0x0000000100036004
- (void)_onqueueUpdateCirclePeerID:(id)arg1;	// IMP=0x0000000100035df8
- (id)notifyCircleChange:(id)arg1;	// IMP=0x0000000100035cf0
- (void)_onqueueUpdateCKDeviceID:(id)arg1;	// IMP=0x0000000100035b54
- (id)notifyCKAccountStatusChange:(id)arg1;	// IMP=0x0000000100035a2c
- (id)registerForNotificationsOfCloudKitAccountStatusChange:(id)arg1;	// IMP=0x0000000100035938
@property(readonly, copy) NSString *debugDescription;
@property(readonly, copy) NSString *description;
- (id)descriptionInternal:(id)arg1;	// IMP=0x0000000100035784
- (void)dealloc;	// IMP=0x0000000100035708
- (void)performInitialDispatches;	// IMP=0x0000000100035678
- (id)init:(id)arg1 nsnotificationCenterClass:(Class)arg2;	// IMP=0x000000010003529c
