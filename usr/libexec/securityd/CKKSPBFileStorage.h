...
- (void).cxx_destruct;	// IMP=0x000000010015ab5c
...
- (void)setStorage:(id)arg1;	// IMP=0x000000010015a9f8
- (id)storage;	// IMP=0x000000010015a98c
- (id)initWithStoragePath:(id)arg1 storageClass:(Class)arg2;	// IMP=0x000000010015a7f0
