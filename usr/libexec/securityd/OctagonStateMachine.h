...
- (void).cxx_destruct;	// IMP=0x00000001000eec38
...
- (id)doWatchedStateMachineRPC:(id)arg1 sourceStates:(id)arg2 path:(id)arg3 reply:(CDUnknownBlockType)arg4;	// IMP=0x00000001000ee5fc
- (void)setWatcherTimeout:(unsigned long long)arg1;	// IMP=0x00000001000ee5f0
- (void)doSimpleStateMachineRPC:(id)arg1 op:(id)arg2 sourceStates:(id)arg3 reply:(CDUnknownBlockType)arg4;	// IMP=0x00000001000ee27c
- (void)registerMultiStateArrivalWatcher:(id)arg1;	// IMP=0x00000001000ee1cc
- (void)registerStateTransitionWatcher:(id)arg1;	// IMP=0x00000001000ee11c
- (void)handleExternalRequest:(id)arg1;	// IMP=0x00000001000ee06c
- (void)haltOperation;	// IMP=0x00000001000edfc0
- (void)startOperation;	// IMP=0x00000001000edf44
- (_Bool)isPaused;	// IMP=0x00000001000ede74
- (void)_onqueueSendAnyPendingFlags;	// IMP=0x00000001000ed6d4
- (void)_onqueueRecheckConditions;	// IMP=0x00000001000ed26c
- (id)possiblePendingFlags;	// IMP=0x00000001000ed218
- (id)dumpPendingFlags;	// IMP=0x00000001000ed0fc
- (void)disablePendingFlags;	// IMP=0x00000001000ed080
- (void)_onqueueHandlePendingFlag:(id)arg1;	// IMP=0x00000001000ecdfc
- (void)handlePendingFlag:(id)arg1;	// IMP=0x00000001000ecd4c
- (void)_onqueueHandleFlag:(id)arg1;	// IMP=0x00000001000ecca8
- (void)handleFlag:(id)arg1;	// IMP=0x00000001000ecbf8
- (void)_onqueuePokeStateMachine;	// IMP=0x00000001000ecba8
- (void)pokeStateMachine;	// IMP=0x00000001000ecb2c
- (id)createOperationToFinishAttempt:(id)arg1;	// IMP=0x00000001000ec9b4
- (void)_onqueueStartNextStateMachineOperation:(_Bool)arg1;	// IMP=0x00000001000ec5d8
- (id)_onqueueNextStateMachineTransition;	// IMP=0x00000001000ec1d0
- (id)waitForState:(id)arg1 wait:(unsigned long long)arg2;	// IMP=0x00000001000ec118
@property(retain) NSString<OctagonStateString> *currentState;
@property(readonly) id <OctagonFlagContainer> flags;
- (id)description;	// IMP=0x00000001000ebdec
- (id)pendingFlagsString;	// IMP=0x00000001000ebd68
- (id)initWithName:(id)arg1 states:(id)arg2 flags:(id)arg3 initialState:(id)arg4 queue:(id)arg5 stateEngine:(id)arg6 lockStateTracker:(id)arg7;	// IMP=0x00000001000eb824
