...
+ (Class)internalTestConfigType;	// IMP=0x000000010017a3b0
- (void).cxx_destruct;	// IMP=0x0000000100179ed4
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000100179b18
- (unsigned long long)hash;	// IMP=0x00000001001799e0
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100179798
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001001794b4
- (void)copyTo:(id)arg1;	// IMP=0x00000001001792b4
- (void)writeTo:(id)arg1;	// IMP=0x0000000100179080
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000100179078
- (id)dictionaryRepresentation;	// IMP=0x0000000100178d0c
- (id)description;	// IMP=0x0000000100178c58
- (id)internalTestConfigAtIndex:(unsigned long long)arg1;	// IMP=0x0000000100178c40
- (unsigned long long)internalTestConfigsCount;	// IMP=0x0000000100178c28
- (void)addInternalTestConfig:(id)arg1;	// IMP=0x0000000100178bb4
- (void)clearInternalTestConfigs;	// IMP=0x0000000100178b9c
