...
- (void).cxx_destruct;	// IMP=0x00000001000e18b0
...
- (id)initWithData:(id)arg1;	// IMP=0x00000001000e1754
- (id)initRefKeyWrappedKeyWithData:(id)arg1 refKeyBlob:(id)arg2;	// IMP=0x00000001000e167c
- (id)initRegularWrappedKeyWithData:(id)arg1;	// IMP=0x00000001000e15d8
