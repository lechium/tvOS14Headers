...
- (void).cxx_destruct;	// IMP=0x00000001000ab2c4
...
- (void)cancel;	// IMP=0x00000001000ab014
- (void)sendChangesToClient:(id)arg1 moreComing:(_Bool)arg2;	// IMP=0x00000001000aaaac
- (void)performFetch;	// IMP=0x00000001000aa3c8
- (void)groupStart;	// IMP=0x00000001000aa1a0
- (void)queryClientsForChangeTokens;	// IMP=0x00000001000a9cd8
- (id)initWithContainer:(id)arg1 fetchClass:(Class)arg2 clients:(id)arg3 fetchReasons:(id)arg4 apnsPushes:(id)arg5 forceResync:(_Bool)arg6 ckoperationGroup:(id)arg7;	// IMP=0x00000001000a9918
- (id)init;	// IMP=0x00000001000a9900
