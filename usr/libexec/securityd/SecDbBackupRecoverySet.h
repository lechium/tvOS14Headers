...
- (void).cxx_destruct;	// IMP=0x000000010008cac0
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000010008c930
- (unsigned long long)hash;	// IMP=0x000000010008c874
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010008c710
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010008c5e4
- (void)copyTo:(id)arg1;	// IMP=0x000000010008c50c
- (void)writeTo:(id)arg1;	// IMP=0x000000010008c448
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000010008c12c
- (id)dictionaryRepresentation;	// IMP=0x000000010008bfd0
- (id)description;	// IMP=0x000000010008bf1c
