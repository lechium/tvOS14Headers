...
- (void).cxx_destruct;	// IMP=0x0000000100090f84
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000100090cb0
- (unsigned long long)hash;	// IMP=0x0000000100090b70
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100090960
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000100090794
- (void)copyTo:(id)arg1;	// IMP=0x000000010009061c
- (void)writeTo:(id)arg1;	// IMP=0x00000001000904c8
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000010008fe9c
- (id)dictionaryRepresentation;	// IMP=0x000000010008fb48
- (id)description;	// IMP=0x000000010008fa94
...
- (int)StringAsMetricType:(id)arg1;	// IMP=0x000000010008f868
- (id)metricTypeAsString:(int)arg1;	// IMP=0x000000010008f7f0
