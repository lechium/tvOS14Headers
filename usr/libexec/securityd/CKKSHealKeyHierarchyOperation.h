...
- (void).cxx_destruct;	// IMP=0x0000000100082c24
...
- (void)cancel;	// IMP=0x0000000100082b18
- (_Bool)ensureKeyPresent:(id)arg1;	// IMP=0x0000000100082634
- (void)groupStart;	// IMP=0x00000001000823b0
- (id)initWithDependencies:(id)arg1 ckks:(id)arg2 intending:(id)arg3 errorState:(id)arg4;	// IMP=0x000000010008229c
- (id)init;	// IMP=0x0000000100082284
