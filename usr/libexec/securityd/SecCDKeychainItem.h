...
- (void).cxx_destruct;	// IMP=0x0000000100041b10
...
- (id)secretsFromEncryptedData:(id)arg1 withKeybag:(int)arg2 error:(id *)arg3;	// IMP=0x00000001000415cc
- (id)encryptedSecretDataWithAttributeData:(id)arg1 keybag:(int)arg2 error:(id *)arg3;	// IMP=0x0000000100040f38
- (id)primaryKeyStringRepresentationWithError:(id *)arg1;	// IMP=0x0000000100040b60
- (id)primaryKeys;	// IMP=0x0000000100040b50
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010004088c
- (id)initWithManagedItem:(id)arg1 keychain:(id)arg2 error:(id *)arg3;	// IMP=0x0000000100040584
- (id)initItemType:(id)arg1 withPersistentID:(id)arg2 attributes:(id)arg3 lookupAttributes:(id)arg4 secrets:(id)arg5 owner:(id)arg6 keyclass:(int)arg7;	// IMP=0x000000010004041c
