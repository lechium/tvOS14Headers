...
- (void).cxx_destruct;	// IMP=0x00000001000e1e70
...
- (id)initWithData:(id)arg1;	// IMP=0x00000001000e1ab0
- (id)initWithCiphertext:(id)arg1 wrappedKey:(id)arg2 tamperCheck:(id)arg3 error:(id *)arg4;	// IMP=0x00000001000e18bc
