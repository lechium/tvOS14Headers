...
- (void).cxx_destruct;	// IMP=0x00000001000947e4
...
- (void)cancel;	// IMP=0x0000000100094634
- (void)_onqueueTrigger:(unsigned long long)arg1 maximumDelay:(unsigned long long)arg2;	// IMP=0x00000001000940dc
- (void)trigger;	// IMP=0x0000000100094010
- (void)_onqueueTimerTick;	// IMP=0x0000000100093ce0
- (void)triggerAt:(unsigned long long)arg1;	// IMP=0x0000000100093c04
- (void)waitUntil:(unsigned long long)arg1;	// IMP=0x0000000100093b7c
@property(readonly) NSDate *nextFireTime;
- (id)description;	// IMP=0x0000000100093998
- (id)makeOperationDependency;	// IMP=0x00000001000938bc
- (void)changeDelays:(unsigned long long)arg1 continuingDelay:(unsigned long long)arg2;	// IMP=0x000000010009382c
- (id)initWithName:(id)arg1 initialDelay:(unsigned long long)arg2 expontialBackoff:(double)arg3 maximumDelay:(unsigned long long)arg4 keepProcessAlive:(_Bool)arg5 dependencyDescriptionCode:(long long)arg6 block:(CDUnknownBlockType)arg7;	// IMP=0x0000000100093648
- (id)initWithName:(id)arg1 initialDelay:(unsigned long long)arg2 continuingDelay:(unsigned long long)arg3 keepProcessAlive:(_Bool)arg4 dependencyDescriptionCode:(long long)arg5 block:(CDUnknownBlockType)arg6;	// IMP=0x00000001000935a0
- (id)initWithName:(id)arg1 delay:(unsigned long long)arg2 keepProcessAlive:(_Bool)arg3 dependencyDescriptionCode:(long long)arg4 block:(CDUnknownBlockType)arg5;	// IMP=0x0000000100093520
