...
+ (id)trust;	// IMP=0x00000001001c5ee4
- (void).cxx_destruct;	// IMP=0x00000001001c5ea8
...
- (void)dealloc;	// IMP=0x00000001001c5c6c
- (id)initWithRetirees:(id)arg1 fpi:(struct __OpaqueSOSFullPeerInfo *)arg2 circle:(struct __OpaqueSOSCircle *)arg3 departureCode:(int)arg4 peerExpansion:(id)arg5;	// IMP=0x00000001001c5b74
- (id)init;	// IMP=0x00000001001c5a78
