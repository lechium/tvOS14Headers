...
- (void).cxx_destruct;	// IMP=0x00000001000e23d4
...
- (id)initWithData:(id)arg1;	// IMP=0x00000001000e20e4
- (id)initWithCiphertext:(id)arg1 wrappedKey:(id)arg2 tamperCheck:(id)arg3 backupWrappedKey:(id)arg4 error:(id *)arg5;	// IMP=0x00000001000e1e7c
