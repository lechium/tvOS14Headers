...
- (void).cxx_destruct;	// IMP=0x0000000100096e50
...
- (void)proceedWithKeys:(id)arg1 salt:(id)arg2;	// IMP=0x0000000100096b44
- (void)groupStart;	// IMP=0x0000000100096660
- (id)initWithDependencies:(id)arg1 recoveryKey:(id)arg2;	// IMP=0x00000001000965ac
