...
- (_Bool)_onqueueIsErrorBadEtagOnKeyPointersOnly:(id)arg1;	// IMP=0x0000000100069e90
- (_Bool)_onqueueIsErrorMissingSyncKey:(id)arg1;	// IMP=0x0000000100069bb4
- (void)_onqueueModifyAllRecords:(id)arg1 as:(id)arg2;	// IMP=0x00000001000695b0
- (void)_onqueueModifyRecordAsError:(id)arg1 recordError:(id)arg2;	// IMP=0x0000000100069100
- (void)groupStart;	// IMP=0x0000000100068e0c
- (id)initWithDependencies:(id)arg1 ckks:(id)arg2 intending:(id)arg3 errorState:(id)arg4 ckoperationGroup:(id)arg5;	// IMP=0x0000000100068c1c
