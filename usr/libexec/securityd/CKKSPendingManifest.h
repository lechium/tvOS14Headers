...
+ (id)sqlTable;	// IMP=0x00000001001016d0
- (void).cxx_destruct;	// IMP=0x00000001001016bc
...
- (id)commitToDatabaseWithError:(id *)arg1;	// IMP=0x0000000100101314
- (_Bool)isReadyToCommit;	// IMP=0x0000000100101118
