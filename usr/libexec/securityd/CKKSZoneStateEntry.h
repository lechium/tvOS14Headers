...
+ (id)fromDatabaseRow:(id)arg1;	// IMP=0x00000001000768e4
+ (id)sqlColumns;	// IMP=0x00000001000768d8
+ (id)sqlTable;	// IMP=0x00000001000768cc
+ (id)tryFromDatabase:(id)arg1 error:(id *)arg2;	// IMP=0x00000001000767a4
+ (id)fromDatabase:(id)arg1 error:(id *)arg2;	// IMP=0x000000010007667c
+ (id)state:(id)arg1;	// IMP=0x0000000100076518
- (void).cxx_destruct;	// IMP=0x00000001000764b0
...
- (id)sqlValues;	// IMP=0x0000000100075fac
- (id)whereClauseToFindSelf;	// IMP=0x0000000100075f00
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010007574c
- (id)initWithCKZone:(id)arg1 zoneCreated:(_Bool)arg2 zoneSubscribed:(_Bool)arg3 changeToken:(id)arg4 moreRecordsInCloudKit:(_Bool)arg5 lastFetch:(id)arg6 lastFixup:(unsigned long long)arg7 encodedRateLimiter:(id)arg8;	// IMP=0x00000001000755f0
