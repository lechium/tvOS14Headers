...
- (void)proceedWithKeys:(id)arg1 tlkShares:(id)arg2 salt:(id)arg3;	// IMP=0x00000001000c80ac
- (void)proceedWithRecoveryKeyID:(id)arg1;	// IMP=0x00000001000c7ee0
- (void)groupStart;	// IMP=0x00000001000c7970
- (id)initWithDependencies:(id)arg1 intendedState:(id)arg2 errorState:(id)arg3 recoveryKey:(id)arg4 saveVoucher:(_Bool)arg5;	// IMP=0x00000001000c7844
