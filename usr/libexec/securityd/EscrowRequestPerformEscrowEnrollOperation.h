...
+ (void)cdpUploadPrerecord:(id)arg1 secretType:(unsigned long long)arg2 reply:(CDUnknownBlockType)arg3;	// IMP=0x000000010009fb44
- (void).cxx_destruct;	// IMP=0x000000010009f61c
...
- (void)groupStart;	// IMP=0x000000010009ee08
- (_Bool)checkFatalError:(id)arg1;	// IMP=0x000000010009ec7c
- (id)initWithIntendedState:(id)arg1 errorState:(id)arg2 enforceRateLimiting:(_Bool)arg3 lockStateTracker:(id)arg4;	// IMP=0x000000010009eb84
