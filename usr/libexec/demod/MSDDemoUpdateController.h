...
+ (id)sharedInstance;	// IMP=0x0000000100036074
- (void).cxx_destruct;	// IMP=0x00000001000395e4
...
- (void)setAutomatedDeviceGroupStoreID;	// IMP=0x00000001000394d8
- (void)setTVSpecificSettings;	// IMP=0x00000001000393a8
- (_Bool)migrateDataWithBlockingUI:(int)arg1;	// IMP=0x0000000100038f3c
- (_Bool)PLHasCompletedMomentAnalysis;	// IMP=0x0000000100038e90
- (_Bool)PLHasCompletedRestorePostProcessing;	// IMP=0x0000000100038de4
- (_Bool)removeLowerPriorityAppsTillFreeSpace:(long long)arg1;	// IMP=0x00000001000388f4
- (void)loadInstallationOrder:(id)arg1;	// IMP=0x0000000100038524
- (void)checkWithTimeKeeper:(id)arg1;	// IMP=0x0000000100038328
- (_Bool)continueToUpdateDemoContentWithServer:(id)arg1;	// IMP=0x00000001000380f8
- (_Bool)updateDemoContentWithServer:(id)arg1;	// IMP=0x0000000100036af0
- (_Bool)enrollWithServer:(id)arg1 name:(id)arg2 pairingCredential:(id)arg3 error:(id *)arg4;	// IMP=0x0000000100036400
- (_Bool)enrolledWith:(id)arg1;	// IMP=0x00000001000362f4
- (void)getDemoUpdateInProgress:(_Bool *)arg1 operationAllowed:(_Bool *)arg2;	// IMP=0x0000000100036250
- (id)init;	// IMP=0x00000001000360e0
