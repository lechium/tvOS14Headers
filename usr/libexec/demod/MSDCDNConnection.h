...
+ (id)sharedInstance;	// IMP=0x0000000100053dd8
- (void).cxx_destruct;	// IMP=0x0000000100056288
...
- (void)URLSession:(id)arg1 task:(id)arg2 didReceiveChallenge:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x0000000100055e80
- (void)URLSession:(id)arg1 task:(id)arg2 didCompleteWithError:(id)arg3;	// IMP=0x0000000100055a4c
- (void)URLSession:(id)arg1 dataTask:(id)arg2 didReceiveData:(id)arg3;	// IMP=0x0000000100055610
- (void)URLSession:(id)arg1 dataTask:(id)arg2 didReceiveResponse:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x00000001000553d0
- (void)invalidate;	// IMP=0x0000000100055390
- (_Bool)directDownload:(id)arg1 withCredential:(id)arg2 to:(id)arg3 localSource:(_Bool)arg4 error:(id *)arg5 retry:(long long)arg6;	// IMP=0x00000001000543e8
- (id)init;	// IMP=0x0000000100053e44
