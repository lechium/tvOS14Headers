...
+ (id)sharedInstance;	// IMP=0x000000010000da18
- (void).cxx_destruct;	// IMP=0x000000010000e8b8
...
- (void)processCoreDuetCallBack;	// IMP=0x000000010000e1d0
- (void)startPowerForegroundAppMonitoring;	// IMP=0x000000010000dea0
- (void)monitorDiskSpace;	// IMP=0x000000010000dd78
- (void)startSystemIdleDetection;	// IMP=0x000000010000dba4
- (void)stopSystemIdleDetection;	// IMP=0x000000010000da84
