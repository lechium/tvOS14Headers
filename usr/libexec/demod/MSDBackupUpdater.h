...
+ (id)sharedInstance;	// IMP=0x000000010004240c
...
- (_Bool)installProvisioningProfiles;	// IMP=0x0000000100042fb8
- (id)namesForBackupsOfRange:(struct _NSRange)arg1;	// IMP=0x0000000100042e1c
- (_Bool)updateBackup:(struct _NSRange)arg1 error:(id *)arg2;	// IMP=0x0000000100042540
- (id)init;	// IMP=0x0000000100042478
