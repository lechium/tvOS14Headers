...
+ (id)contentServerConnection:(id)arg1 port:(id)arg2;	// IMP=0x00000001000503a4
- (void).cxx_destruct;	// IMP=0x0000000100053cd4
...
- (void)URLSession:(id)arg1 task:(id)arg2 willPerformHTTPRedirection:(id)arg3 newRequest:(id)arg4 completionHandler:(CDUnknownBlockType)arg5;	// IMP=0x0000000100053910
- (void)URLSession:(id)arg1 dataTask:(id)arg2 didReceiveData:(id)arg3;	// IMP=0x00000001000534e8
- (void)URLSession:(id)arg1 dataTask:(id)arg2 didReceiveResponse:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x00000001000531fc
- (void)URLSession:(id)arg1 task:(id)arg2 didCompleteWithError:(id)arg3;	// IMP=0x0000000100052a48
- (void)URLSession:(id)arg1 task:(id)arg2 didReceiveChallenge:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x00000001000526e4
- (_Bool)addAuthenticationHeadersToRequest:(id)arg1 withBody:(id)arg2 error:(id *)arg3;	// IMP=0x000000010005243c
- (void)cancelDownloading;	// IMP=0x00000001000520e8
- (void)runRunLoopUntilDone;	// IMP=0x00000001000520ac
- (_Bool)startDownloadingFile;	// IMP=0x000000010005135c
- (void)invalidate;	// IMP=0x000000010005131c
- (void)enableAuthenticationWithHMACKey:(id)arg1;	// IMP=0x0000000100051310
- (_Bool)downloadTo:(id)arg1 byPosting:(id)arg2 toPath:(id)arg3 retry:(int)arg4 error:(id *)arg5;	// IMP=0x0000000100051020
- (id)postDataForEnrolment:(id)arg1 to:(id)arg2 retry:(int)arg3 error:(id *)arg4;	// IMP=0x0000000100050f30
- (id)postData:(id)arg1 to:(id)arg2 retry:(int)arg3 error:(id *)arg4;	// IMP=0x0000000100050dcc
- (_Bool)downloadFile:(id)arg1 to:(id)arg2 retry:(long long)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x0000000100050964
- (id)downloadFileToNSData:(id)arg1 retry:(long long)arg2 error:(id *)arg3;	// IMP=0x0000000100050820
- (void)dealloc;	// IMP=0x00000001000506e0
- (void)setupServer:(id)arg1 port:(id)arg2;	// IMP=0x0000000100050668
- (id)initWithCellularAccess:(_Bool)arg1;	// IMP=0x0000000100050438
