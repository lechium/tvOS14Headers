...
- (id)submitMessage:(id)arg1;	// IMP=0x00000001000258d0
@property(retain, nonatomic) NSArray *configuredMetricIDs;
@property(retain, nonatomic) NSArray *interestedMetricIDs;
- (void)iterateConfigChange;	// IMP=0x0000000100025248
- (id)initWithMessageGroupType:(long long)arg1 andConfigChangeDelegate:(id)arg2 onQueue:(id)arg3;	// IMP=0x0000000100024d74
- (id)init;	// IMP=0x0000000100024cc4
