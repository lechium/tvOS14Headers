...
- (void).cxx_destruct;	// IMP=0x00000001000577d4
...
- (id)submitDPSRMessage:(id)arg1;	// IMP=0x0000000100051d84
- (id)submitSlowWiFiMessage:(id)arg1;	// IMP=0x00000001000517f8
- (id)submitMessage:(id)arg1;	// IMP=0x000000010005156c
- (id)initWithMessageGroupType:(long long)arg1;	// IMP=0x000000010005145c
