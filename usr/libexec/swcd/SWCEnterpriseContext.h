...
- (void).cxx_destruct;	// IMP=0x0000000100010774
@property(readonly, getter=isManaging) _Bool managing; // @synthesize managing=_managing;
@property(readonly) NSData *state;
- (id)isApplicationIdentifierEligibleForManagedMode:(id)arg1 error:(id *)arg2;	// IMP=0x0000000100010384
- (id)serviceSpecifiersForApplicationIdentifier:(id)arg1 error:(id *)arg2;	// IMP=0x00000001000101a4
- (id)init;	// IMP=0x00000001000100d4
- (void)_loadEnterpriseData;	// IMP=0x00000001000107b0
