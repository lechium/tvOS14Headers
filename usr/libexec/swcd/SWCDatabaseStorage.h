...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000001000148bc
- (void).cxx_destruct;	// IMP=0x0000000100015270
...
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000100014984
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000001000148c4
