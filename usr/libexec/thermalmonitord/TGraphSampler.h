...
+ (id)sharedInstance;	// IMP=0x000000010000f1c8
- (void)logToPowerlog;	// IMP=0x0000000100010d68
- (void)updateAppleCareState:(int)arg1 value:(int)arg2;	// IMP=0x0000000100010bf8
- (void)updatePowerLogLiteHiP:(BOOL)arg1 client:(BOOL)arg2;	// IMP=0x0000000100010ac8
- (void)updatePowerlogLiteMode:(long long)arg1 pressureLevel:(long long)arg2;	// IMP=0x0000000100010904
- (void)updatePowerlogMiscState:(int)arg1 value:(int)arg2;	// IMP=0x0000000100010784
- (void)genTGraphData;	// IMP=0x00000001000101a0
- (void)genTGraphHeader;	// IMP=0x000000010000fabc
- (struct __CFString *)getTGraphData:(int)arg1;	// IMP=0x000000010000fa2c
- (void)setTGraphDataString:(struct __CFString *)arg1;	// IMP=0x000000010000f9e8
- (void)updateLiteModePowerLogDictionaryForSensors;	// IMP=0x000000010000f850
- (void)updatePowerLogDictionaryForSensors;	// IMP=0x000000010000f724
- (_Bool)shouldLogSensorForLiteMode:(struct __CFString *)arg1;	// IMP=0x000000010000f6c8
- (_Bool)shouldLogSensor:(struct __CFString *)arg1;	// IMP=0x000000010000f64c
- (void)updateSubkeyController:(id)arg1 forControlList:(id)arg2;	// IMP=0x000000010000f500
- (void)addtGraphDataSource:(id)arg1;	// IMP=0x000000010000f4ec
- (void)dealloc;	// IMP=0x000000010000f49c
- (void)setProduct:(id)arg1 withComponents:(id)arg2 andHotspotSupervisors:(id)arg3;	// IMP=0x000000010000f438
