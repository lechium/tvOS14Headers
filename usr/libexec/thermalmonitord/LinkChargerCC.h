...
- (struct __CFString *)copyFieldCurrentValueForIndex:(int)arg1;	// IMP=0x000000010000e69c
- (struct __CFString *)copyHeaderForIndex:(int)arg1;	// IMP=0x000000010000e5bc
- (int)numberOfFields;	// IMP=0x000000010000e584
- (void)setChargerType:(int)arg1;	// IMP=0x000000010000e574
- (_Bool)canSystemSleep;	// IMP=0x000000010000e460
- (_Bool)isOnCharger;	// IMP=0x000000010000e450
- (_Bool)isCurrentlyCloaked;	// IMP=0x000000010000e440
- (void)refreshTGraphTelemetry;	// IMP=0x000000010000e41c
- (_Bool)updateCloakingState:(_Bool)arg1;	// IMP=0x000000010000e288
- (void)defaultAction;	// IMP=0x000000010000ddf0
- (id)initWithParams:(struct __CFDictionary *)arg1 aggdController:(id)arg2;	// IMP=0x000000010000db68
