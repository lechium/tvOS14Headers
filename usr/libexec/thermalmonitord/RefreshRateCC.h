...
- (struct __CFString *)copyHeaderForIndex:(int)arg1;	// IMP=0x000000010000da04
- (int)numberOfFields;	// IMP=0x000000010000d9d0
- (void)refreshTGraphTelemetry;	// IMP=0x000000010000d9cc
- (void)initRefreshRateTable:(struct __CFArray *)arg1;	// IMP=0x000000010000d788
- (void)defaultAction;	// IMP=0x000000010000d6dc
- (id)initWithParams:(struct __CFDictionary *)arg1;	// IMP=0x000000010000d5cc
