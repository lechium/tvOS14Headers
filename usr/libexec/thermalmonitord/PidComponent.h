...
- (void)applySeedToIntegratorFromControlEffort:(int)arg1 currentTemperature:(float)arg2;	// IMP=0x00000001000080e4
- (_Bool)isIntegratorAtMin;	// IMP=0x00000001000080d4
- (_Bool)isEqualMType:(int)arg1;	// IMP=0x00000001000080c4
- (void)calculateControlEffort:(float)arg1;	// IMP=0x0000000100008044
- (void)dealloc;	// IMP=0x0000000100007ff8
- (id)initPIDWith:(struct __CFDictionary *)arg1;	// IMP=0x0000000100007ee4
