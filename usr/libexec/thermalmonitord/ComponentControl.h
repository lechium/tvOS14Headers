...
- (int)getPowerlogFieldCurrentValue;	// IMP=0x0000000100017784
- (struct __CFString *)getPowerlogKey;	// IMP=0x0000000100017774
- (struct __CFString *)copyFieldCurrentValueForIndex:(int)arg1;	// IMP=0x0000000100017684
- (struct __CFString *)copyHeaderForIndex:(int)arg1;	// IMP=0x00000001000175d0
- (int)numberOfFields;	// IMP=0x00000001000175c8
- (int)getReleaseMaxLI;	// IMP=0x00000001000175b8
- (int)getReleaseRate;	// IMP=0x00000001000175a8
- (void)resetCPMSMitigationState;	// IMP=0x0000000100017570
- (void)updatePowerParameters:(struct __CFDictionary *)arg1;	// IMP=0x00000001000173e0
- (void)setCPMSMitigationState:(_Bool)arg1;	// IMP=0x0000000100017100
- (_Bool)shouldDoCPMSActions;	// IMP=0x00000001000170bc
- (void)testLoadingIndexLevel;	// IMP=0x000000010001701c
- (void)setMaxLoadingIndex:(unsigned int)arg1 releaseIndex:(unsigned int)arg2;	// IMP=0x0000000100016fec
- (void)refreshFunctionalTelemetry;	// IMP=0x0000000100016fe8
- (void)refreshCPMSTGraphTelemetry;	// IMP=0x0000000100016f78
- (void)refreshTGraphTelemetry;	// IMP=0x0000000100016f74
- (_Bool)isEqualMType:(int)arg1;	// IMP=0x0000000100016f44
- (unsigned int)computePowerTarget;	// IMP=0x0000000100016ee0
- (void)defaultCPMSAction;	// IMP=0x0000000100016d00
- (void)defaultAction;	// IMP=0x0000000100016cc0
- (id)initWithCC:(int)arg1:(struct __CFDictionary *)arg2;	// IMP=0x0000000100016b5c
