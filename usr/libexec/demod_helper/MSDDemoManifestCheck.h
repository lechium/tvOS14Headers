...
+ (id)sharedInstance;	// IMP=0x000000010000dfb8
- (void).cxx_destruct;	// IMP=0x0000000100010e08
...
- (_Bool)checkFileForEntitlements:(id)arg1 forCorrespondingManifestEntry:(id)arg2;	// IMP=0x00000001000107e0
- (void)registerEntitlementNotificationHandler;	// IMP=0x00000001000105bc
- (_Bool)runAppLayoutSecurityCheck:(id)arg1;	// IMP=0x000000010000fbec
- (_Bool)runSecurityChecksForSection:(id)arg1 dataType:(id)arg2;	// IMP=0x000000010000f114
- (_Bool)runSecurityCheck;	// IMP=0x000000010000e5d8
- (_Bool)secureManifestCheckForSegmentedManifest:(id)arg1;	// IMP=0x000000010000e480
- (id)init;	// IMP=0x000000010000e024
