...
+ (id)sharedInstance;	// IMP=0x0000000100012d8c
- (void).cxx_destruct;	// IMP=0x0000000100013894
...
- (id)copyDeviceTreeInt:(id)arg1 key:(id)arg2 defaultValue:(int)arg3;	// IMP=0x00000001000136c8
- (id)copyBootArgs;	// IMP=0x0000000100013624
- (id)copyBootSessionUUID;	// IMP=0x0000000100013574
- (id)copyDeviceTreeProperty:(id)arg1 key:(id)arg2;	// IMP=0x00000001000134c0
- (id)init;	// IMP=0x0000000100012df8
