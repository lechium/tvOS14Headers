...
+ (id)defaultManager;	// IMP=0x00000001000253ec
- (void).cxx_destruct;	// IMP=0x0000000100025a08
...
- (void)waitForSystemAppMigrationToComplete:(CDUnknownBlockType)arg1;	// IMP=0x00000001000257b4
@property(nonatomic) _Bool systemAppMigrationComplete; // @synthesize systemAppMigrationComplete=_systemAppMigrationComplete;
- (id)init;	// IMP=0x00000001000252b0
