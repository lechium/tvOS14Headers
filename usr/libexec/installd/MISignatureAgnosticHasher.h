...
+ (void)unpackPackedCpuTypeAndSubType:(id)arg1 cputype:(int *)arg2 subtype:(int *)arg3;	// IMP=0x000000010005e45c
+ (id)packedNumberForCPUType:(int)arg1 subtype:(int)arg2;	// IMP=0x000000010005e43c
...
- (_Bool)performHashWithError:(id *)arg1;	// IMP=0x000000010005dbb4
- (id)_hashSliceAtOffset:(long long)arg1 withSize:(long long)arg2 machHeaderAndCommands:(const struct mach_header *)arg3 dictionaryKey:(id *)arg4 error:(id *)arg5;	// IMP=0x000000010005ca08
- (void)dealloc;	// IMP=0x000000010005c9a4
- (id)initWithExecutable:(id)arg1 searchForSectionNamed:(id)arg2;	// IMP=0x000000010005c8f8
