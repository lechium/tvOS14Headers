...
- (void).cxx_destruct;	// IMP=0x000000010001a248
...
- (id)gatherUsageInfoWithError:(id *)arg1;	// IMP=0x0000000100019fcc
- (id)_gatherForIdentifier:(id)arg1;	// IMP=0x0000000100019a1c
- (id)initWithIdentifiers:(id)arg1 options:(id)arg2;	// IMP=0x00000001000198e0
