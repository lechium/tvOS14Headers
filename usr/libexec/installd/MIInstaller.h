...
+ (id)installerForURL:(id)arg1 withOptions:(id)arg2 forClient:(id)arg3;	// IMP=0x000000010000f894
...
- (_Bool)performInstallationWithError:(id *)arg1;	// IMP=0x0000000100013440
- (_Bool)_installProvisioningProfilesAtStagingRootWithError:(id *)arg1;	// IMP=0x0000000100012fec
- (_Bool)_installProvisioningProfilesFromUserOptionsWithError:(id *)arg1;	// IMP=0x0000000100012c78
- (_Bool)_discoverInstallablesWithError:(id *)arg1;	// IMP=0x0000000100011c5c
- (void)_writeLockBundles:(id)arg1;	// IMP=0x0000000100011a3c
- (void)_acquireTerminationAssertionsForBundles:(id)arg1;	// IMP=0x0000000100011838
- (id)_bundlesAtURL:(id)arg1 error:(id *)arg2;	// IMP=0x0000000100011484
- (id)_manifestPathForBase:(id)arg1 withIdentifier:(id)arg2 patchType:(unsigned char *)arg3 error:(id *)arg4;	// IMP=0x0000000100011008
- (_Bool)_extractPackageContainedSymlink:(_Bool *)arg1 withError:(id *)arg2;	// IMP=0x0000000100010848
- (_Bool)_setupPackageStateWithError:(id *)arg1;	// IMP=0x000000010000fc70
- (_Bool)_takeOwnershipOfInstallableContainingSymlink:(_Bool *)arg1 error:(id *)arg2;	// IMP=0x000000010000fa08
- (void)_fireCallbackWithStatus:(id)arg1;	// IMP=0x000000010000f99c
- (void)_fireCallbackWithStatus:(id)arg1 percentComplete:(unsigned int)arg2;	// IMP=0x000000010000f928
- (void)dealloc;	// IMP=0x000000010000f6b8
- (id)initWithURL:(id)arg1 options:(id)arg2 forClient:(id)arg3;	// IMP=0x000000010000f5e8
- (id)init;	// IMP=0x000000010000f5dc
