...
- (void).cxx_destruct;	// IMP=0x0000000100039a50
...
- (_Bool)applyPatchWithError:(id *)arg1;	// IMP=0x000000010003961c
- (_Bool)_applyParallelPatchWithError:(id *)arg1;	// IMP=0x00000001000391a0
- (_Bool)_applyDeltaPatchWithError:(id *)arg1;	// IMP=0x0000000100038b94
@property(readonly, nonatomic) NSString *patchTypeName; // @dynamic patchTypeName;
- (id)initWithBundle:(id)arg1 inStagingRoot:(id)arg2 packageFormat:(unsigned char)arg3 userOptions:(id)arg4 manifestURL:(id)arg5 existingBundleContainer:(id)arg6 patchType:(unsigned char)arg7 error:(id *)arg8;	// IMP=0x00000001000386dc
