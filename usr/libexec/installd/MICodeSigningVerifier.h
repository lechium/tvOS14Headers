...
+ (_Bool)_validateStubSignature:(id)arg1 withSigningID:(id)arg2 error:(id *)arg3;	// IMP=0x000000010005856c
+ (_Bool)_validateBundleExecutable:(id)arg1 againstStubAt:(id)arg2 trustedHashes:(id)arg3 sectionName:(id)arg4 signingIdentifier:(id)arg5 error:(id *)arg6;	// IMP=0x0000000100057c40
+ (_Bool)validateWatchKitV2StubExecutableBundle:(id)arg1 error:(id *)arg2;	// IMP=0x00000001000579d4
+ (_Bool)validateWatchKitV1StubExecutableBundle:(id)arg1 error:(id *)arg2;	// IMP=0x0000000100057768
+ (id)_validateSignatureAndCopyInfoForURL:(id)arg1 withOptions:(id)arg2 error:(id *)arg3;	// IMP=0x0000000100056310
+ (id)codeSigningVerifierForBundle:(id)arg1;	// IMP=0x00000001000562bc
- (void).cxx_destruct;	// IMP=0x0000000100058918
...
- (_Bool)performValidationWithError:(id *)arg1;	// IMP=0x00000001000567b8
- (id)_loadSystemDetachedSignatureForBundleID:(id)arg1 error:(id *)arg2;	// IMP=0x0000000100056620
- (id)initWithBundle:(id)arg1;	// IMP=0x000000010005623c
