...
- (void).cxx_destruct;	// IMP=0x000000010005c8ec
@property(retain, nonatomic) FBSApplicationTerminationAssertion *termAssertion; // @synthesize termAssertion=_termAssertion;
- (void)dealloc;	// IMP=0x000000010005c878
- (void)invalidate;	// IMP=0x000000010005c820
- (id)initWithBundleIdentifier:(id)arg1 reason:(unsigned char)arg2;	// IMP=0x000000010005c45c
