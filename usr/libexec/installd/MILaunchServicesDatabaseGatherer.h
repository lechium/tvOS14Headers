...
+ (id)fetchInfoForBundle:(id)arg1 inContainer:(id)arg2 withError:(id *)arg3;	// IMP=0x0000000100005328
+ (id)entryForBundle:(id)arg1 inContainer:(id)arg2 withError:(id *)arg3;	// IMP=0x0000000100005074
+ (_Bool)enumeratePluginKitPluginsInBundle:(id)arg1 updatingPluginParentID:(_Bool)arg2 ensurePluginsAreExecutable:(_Bool)arg3 installProfiles:(_Bool)arg4 error:(id *)arg5 enumerator:(CDUnknownBlockType)arg6;	// IMP=0x00000001000049b0
- (void).cxx_destruct;	// IMP=0x00000001000061d4
...
- (_Bool)performGatherWithError:(id *)arg1;	// IMP=0x0000000100005fd8
- (void)errorOccurred:(id)arg1;	// IMP=0x0000000100005f4c
- (_Bool)scanExecutableBundle:(id)arg1 inContainer:(id)arg2 withError:(id *)arg3;	// IMP=0x0000000100005bf0
- (id)_setForEntry:(id)arg1;	// IMP=0x00000001000059c8
- (_Bool)_scanBundle:(id)arg1 inBundleContainer:(id)arg2 withError:(id *)arg3;	// IMP=0x0000000100005734
- (id)initWithEnumerator:(CDUnknownBlockType)arg1;	// IMP=0x00000001000047f4
