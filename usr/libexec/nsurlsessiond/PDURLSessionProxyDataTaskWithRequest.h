...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000010000b880
- (unsigned long long)hash;	// IMP=0x000000010000b7d8
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010000b6a4
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010000b5a0
- (void)copyTo:(id)arg1;	// IMP=0x000000010000b4e8
- (void)writeTo:(id)arg1;	// IMP=0x000000010000b440
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000010000b12c
- (id)dictionaryRepresentation;	// IMP=0x000000010000afac
- (id)description;	// IMP=0x000000010000aef8
