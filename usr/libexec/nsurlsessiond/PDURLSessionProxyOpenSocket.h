...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000100005d14
- (unsigned long long)hash;	// IMP=0x0000000100005c6c
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100005b38
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000100005a34
- (void)copyTo:(id)arg1;	// IMP=0x000000010000597c
- (void)writeTo:(id)arg1;	// IMP=0x00000001000058d4
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000001000055dc
- (id)dictionaryRepresentation;	// IMP=0x00000001000054a4
