...
- (void).cxx_destruct;	// IMP=0x0000000100041900
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000001000417c8
- (unsigned long long)hash;	// IMP=0x0000000100041720
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001000415f4
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001000414f8
- (void)copyTo:(id)arg1;	// IMP=0x000000010004142c
- (void)writeTo:(id)arg1;	// IMP=0x0000000100041368
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000100040f64
- (id)dictionaryRepresentation;	// IMP=0x0000000100040dc0
- (id)description;	// IMP=0x0000000100040d0c
