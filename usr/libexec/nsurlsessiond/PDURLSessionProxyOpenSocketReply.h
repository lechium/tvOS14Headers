...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000100036384
- (unsigned long long)hash;	// IMP=0x0000000100036330
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010003625c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001000361cc
- (void)copyTo:(id)arg1;	// IMP=0x0000000100036158
- (void)writeTo:(id)arg1;	// IMP=0x00000001000360dc
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000100035df4
- (id)dictionaryRepresentation;	// IMP=0x0000000100035cf0
- (id)description;	// IMP=0x0000000100035c3c
