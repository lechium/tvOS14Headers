...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000010005137c
- (void).cxx_destruct;	// IMP=0x0000000100051370
...
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000100051214
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000100051120
- (id)initWithCallbackType:(int)arg1 taskIdentifier:(unsigned long long)arg2 args:(id)arg3;	// IMP=0x000000010005103c
