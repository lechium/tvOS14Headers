...
+ (_Bool)lock:(CDUnknownBlockType)arg1;	// IMP=0x000000010002aecc
- (void).cxx_destruct;	// IMP=0x000000010002b804
...
- (_Bool)unregisterSession:(id)arg1;	// IMP=0x000000010002b738
- (_Bool)registerSession:(id)arg1;	// IMP=0x000000010002b6b8
- (_Bool)apply;	// IMP=0x000000010002b5b4
- (_Bool)removeAllPoliciesLow:(id)arg1;	// IMP=0x000000010002b420
- (_Bool)removeAllPolicies:(id)arg1;	// IMP=0x000000010002b28c
- (_Bool)addPolicyLow:(id)arg1 policyIDList:(id)arg2;	// IMP=0x000000010002b118
- (_Bool)addPolicy:(id)arg1 policyIDList:(id)arg2;	// IMP=0x000000010002afa4
- (id)initPrivate;	// IMP=0x000000010002ad90
