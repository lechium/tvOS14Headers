...
+ (id)sharedServer;	// IMP=0x00000001000459d0
- (void).cxx_destruct;	// IMP=0x0000000100053390
...
- (void)handleFallbackEnabled:(_Bool)arg1;	// IMP=0x0000000100052be4
- (void)handleSessionStopped:(id)arg1;	// IMP=0x0000000100052b74
- (void)copySessionsWithProviderIdentifier:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000001000527bc
- (_Bool)removeFallbackInterface:(unsigned long long)arg1 predictedInterfaceIndex:(unsigned long long)arg2;	// IMP=0x0000000100052268
- (_Bool)addFallbackInterface:(unsigned long long)arg1 predictedInterfaceIndex:(unsigned long long)arg2;	// IMP=0x0000000100051d4c
- (_Bool)shouldSetDropAll;	// IMP=0x0000000100051cac
- (void)registerForAppsChangedNotifications;	// IMP=0x0000000100051938
- (void)deregisterForCaptiveNetworkPluginChanges;	// IMP=0x0000000100051934
- (void)registerForCaptiveNetworkPluginChanges;	// IMP=0x00000001000514e8
- (void)handleNetworkDetectionEvent:(id)arg1;	// IMP=0x0000000100050a9c
- (void)notifySessionForConfiguration:(id)arg1 sessionType:(int)arg2 notifyType:(int)arg3;	// IMP=0x0000000100050880
- (void)applyLayer2DefaultDrop:(unsigned char)arg1;	// IMP=0x0000000100050754
- (void)applyIPDefaultDropByFeature:(struct __CFString *)arg1 featureEnabled:(unsigned char)arg2;	// IMP=0x0000000100050574
- (long long)applyIPDefaultDrop:(_Bool)arg1 minDropType:(long long)arg2;	// IMP=0x000000010004fff4
- (void)registerForNetworkDetectionEvents;	// IMP=0x000000010004ff58
- (void)postCurrentInfo;	// IMP=0x000000010004fe2c
- (void)adjustActiveSessionCount:(long long)arg1;	// IMP=0x000000010004fbe0
- (void)deregisterForNetworkConfigurationChangeEvents;	// IMP=0x000000010004fb5c
- (void)registerForNetworkConfigurationChangeEvents;	// IMP=0x000000010004f540
- (void)requestUninstallForSession:(id)arg1;	// IMP=0x000000010004f184
- (void)requestInstallForSession:(id)arg1 withParentSession:(id)arg2 exclusive:(_Bool)arg3;	// IMP=0x000000010004e99c
- (void)deregisterSession:(id)arg1;	// IMP=0x000000010004e448
- (void)registerSession:(id)arg1 withCompletionHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000010004c494
- (void)dealloc;	// IMP=0x000000010004c428
- (void)deregisterForUserEvents;	// IMP=0x000000010004c32c
- (void)registerForUserEvents;	// IMP=0x000000010004bf20
- (void)deregisterForPowerEvents;	// IMP=0x000000010004be54
- (void)registerForPowerEvents;	// IMP=0x000000010004bd40
- (void)deregisterForInterfaceEvents;	// IMP=0x000000010004bb4c
- (void)registerForInterfaceEvents;	// IMP=0x000000010004b780
- (void)prohibitVPNOnParameters:(id)arg1;	// IMP=0x000000010004b6fc
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x000000010004a874
- (void)snapshotNetworksChanged:(_Bool)arg1;	// IMP=0x000000010004a5e0
- (void)satisfyCellularPathForSession:(id)arg1;	// IMP=0x000000010004a3ac
- (void)satisfyPathForSession:(id)arg1;	// IMP=0x000000010004a178
- (id)copyInterfaceInfoFromNWIState:(struct _nwi_state *)arg1;	// IMP=0x0000000100049f48
- (void)processInterfaceChanges:(id)arg1;	// IMP=0x00000001000492b0
- (void)ackSleep;	// IMP=0x00000001000490f0
- (void)handleWakeup;	// IMP=0x0000000100048e90
- (void)handleSleepTime:(double)arg1;	// IMP=0x0000000100048c20
- (_Bool)handleSleep;	// IMP=0x0000000100048950
- (_Bool)canSleep;	// IMP=0x00000001000486d8
- (void)handleAgentClientConnection:(id)arg1 initialMessage:(id)arg2;	// IMP=0x00000001000483ac
- (void)addSessionClientWithConnection:(id)arg1 initialMessage:(id)arg2;	// IMP=0x00000001000480fc
- (void)addPendingSessionRequestForConfigurationIdentifier:(id)arg1 sessionType:(int)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000100047cb8
- (void)addPendingSessionRequestOnQueueForConfigurationIdentifier:(id)arg1 sessionType:(int)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000100047ba8
- (void)removeSessionWithType:(int)arg1 andConfigurationIdentifier:(id)arg2;	// IMP=0x0000000100047894
- (void)loadSessionWithType:(int)arg1 andConfigurationIdentifier:(id)arg2;	// IMP=0x0000000100047318
- (void)setupFileHandles;	// IMP=0x0000000100046b9c
- (void)loadPendingSessions;	// IMP=0x00000001000468dc
- (void)acceptNewContentFilterConnection:(id)arg1;	// IMP=0x00000001000466a8
- (void)acceptNewConnection:(id)arg1;	// IMP=0x0000000100046224
- (void)stopWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000100045dd8
- (void)start;	// IMP=0x0000000100045a48
- (id)initPrivate;	// IMP=0x0000000100044f78
- (id)init;	// IMP=0x0000000100044f50
