...
- (_Bool)validateAfterStartWithAuditTokens:(id)arg1;	// IMP=0x000000010007b87c
@property(readonly) _Bool isPerUser;
- (void)addUUIDs:(id)arg1;	// IMP=0x000000010007b5e8
- (void)setPluginPID:(int)arg1 uuids:(id)arg2;	// IMP=0x000000010007b560
- (_Bool)supportsMultipleInstancesOfExtension;	// IMP=0x000000010007b4f0
- (void)terminate;	// IMP=0x000000010007b45c
- (void)disposeWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000010007ae7c
- (void)startWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000010007a908
- (void)sendSetupCommandWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000010007a258
- (id)description;	// IMP=0x000000010007a250
- (_Bool)matchesAuditToken:(id)arg1 expectedCDHashes:(id)arg2;	// IMP=0x000000010007a248
- (id)initWithPluginType:(id)arg1 pluginVersion:(long long)arg2 pluginClass:(long long)arg3 pluginInfo:(id)arg4 userID:(id)arg5;	// IMP=0x000000010007a0e8
