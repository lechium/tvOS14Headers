...
- (void).cxx_destruct;	// IMP=0x00000001000865a4
...
- (void)setPowerState:(long long)arg1;	// IMP=0x0000000100086230
- (void)stop;	// IMP=0x00000001000861a8
- (_Bool)start;	// IMP=0x0000000100085f48
- (void)setReadyToSleep;	// IMP=0x0000000100085d54
- (_Bool)sleepPending;	// IMP=0x0000000100085d18
- (id)initWithDelegate:(id)arg1 queue:(id)arg2;	// IMP=0x0000000100085c70
