...
- (void)handleSessionStopped:(id)arg1;	// IMP=0x000000010000ed74
- (void)startWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000010000ea4c
- (id)initWithExtensionIdentifier:(id)arg1;	// IMP=0x000000010000e9b4
