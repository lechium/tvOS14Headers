...
- (void).cxx_destruct;	// IMP=0x00000001000089d8
...
- (id)description;	// IMP=0x00000001000088bc
- (int)getSocketWithConnectTimeout:(unsigned int)arg1;	// IMP=0x0000000100008754
- (void)dealloc;	// IMP=0x00000001000086fc
- (void)cancel;	// IMP=0x0000000100008670
- (void)updateWithDescription:(id)arg1;	// IMP=0x00000001000085bc
- (id)initWithName:(const char *)arg1 description:(id)arg2;	// IMP=0x000000010000833c
- (id)copyClientDescription;	// IMP=0x0000000100011a44
