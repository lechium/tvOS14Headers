...
- (void).cxx_destruct;	// IMP=0x0000000100004d08
...
- (void)dealloc;	// IMP=0x0000000100004b98
- (void)cancel;	// IMP=0x0000000100004b48
- (id)copyServiceDescription;	// IMP=0x0000000100004a1c
- (id)initWithService:(id)arg1 forDevice:(id)arg2 withPort:(char *)arg3 onSocket:(int)arg4;	// IMP=0x0000000100004598
