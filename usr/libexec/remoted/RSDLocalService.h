...
- (void).cxx_destruct;	// IMP=0x0000000100004468
...
- (void)dealloc;	// IMP=0x0000000100004394
- (void)set_expose_policy:(id)arg1;	// IMP=0x0000000100004180
- (id)copyServiceDescription;	// IMP=0x0000000100003fe4
- (_Bool)shouldBeExposedToDevice:(id)arg1;	// IMP=0x0000000100003ee0
- (void)fireDevice:(id)arg1 fd:(int)arg2;	// IMP=0x0000000100003d6c
- (id)initWithServiceEntryNamed:(const char *)arg1;	// IMP=0x0000000100003c2c
- (id)initWithToken:(unsigned long long)arg1 name:(char *)arg2 event:(id)arg3;	// IMP=0x0000000100003ac8
