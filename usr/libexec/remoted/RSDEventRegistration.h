...
- (void).cxx_destruct;	// IMP=0x0000000100017d58
...
- (void)dealloc;	// IMP=0x0000000100017ccc
- (void)fire:(id)arg1;	// IMP=0x0000000100017b44
- (void)cancelBrowsing;	// IMP=0x0000000100017a1c
- (void)startBrowsing:(id)arg1;	// IMP=0x0000000100017814
- (id)initWithToken:(unsigned long long)arg1 name:(char *)arg2;	// IMP=0x0000000100017794
