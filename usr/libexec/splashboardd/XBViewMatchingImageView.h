...
- (void).cxx_destruct;	// IMP=0x0000000100006820
...
- (void)layoutSubviews;	// IMP=0x0000000100006644
- (id)initWithMatchingView:(id)arg1 image:(id)arg2 bottom:(_Bool)arg3;	// IMP=0x00000001000064e4
