...
+ (id)contextWrapperForApplicationWithCompatibilityInfo:(id)arg1 launchRequest:(id)arg2 captureOptions:(long long)arg3;	// IMP=0x0000000100003d48
+ (void)initialize;	// IMP=0x0000000100003d04
...
- (void)invalidate;	// IMP=0x0000000100006288
- (void)updateLaunchRequest:(id)arg1;	// IMP=0x000000010000621c
- (unsigned long long)_estimatedMemorySizeOfViewHierarchy:(id)arg1;	// IMP=0x0000000100005cbc
- (id)_ioSurfaceForLayerContents:(void *)arg1;	// IMP=0x0000000100005c58
- (void)_update;	// IMP=0x0000000100005854
- (void)_configureNewWindow;	// IMP=0x0000000100004010
@property(readonly, nonatomic) unsigned int contextID;
- (id)initWithApplicationCompatibilityInfo:(id)arg1 launchRequest:(id)arg2 captureOptions:(long long)arg3;	// IMP=0x0000000100003de0
