...
- (_Bool)isMachTimeValid:(unsigned long long)arg1;	// IMP=0x0000000100012888
...
- (void)montonicTimeForMachTime:(unsigned long long)arg1 toQueue:(id)arg2 withCompletionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000100012104
- (void)dealloc;	// IMP=0x00000001000120bc
- (id)initWithSyncInterval:(double)arg1;	// IMP=0x0000000100012008
- (id)init;	// IMP=0x0000000100011fa8
