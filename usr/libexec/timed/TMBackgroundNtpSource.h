...
- (void)setWantedTime:(double)arg1;	// IMP=0x0000000100014b9c
- (void)dealloc;	// IMP=0x0000000100014b0c
- (id)init;	// IMP=0x0000000100014ab0
- (void)fetchTime;	// IMP=0x0000000100014a4c
