...
- (void).cxx_destruct;	// IMP=0x000000010005f6c4
...
- (void)_initPathPropertiesWithDaemonUser:(id)arg1;	// IMP=0x000000010005f36c
- (void)_addPaths:(id)arg1;	// IMP=0x000000010005f32c
- (id)managedPathForURL:(id)arg1;	// IMP=0x000000010005f18c
- (id)orderedPathsFromPaths:(id)arg1;	// IMP=0x000000010005ee7c
- (id)initWithDaemonUser:(id)arg1;	// IMP=0x000000010005ed54
