...
+ (id)_posixOwnerForContainerSubdirectories:(unsigned long long)arg1 user:(id)arg2;	// IMP=0x0000000100083d7c
+ (Class)_containerClassPathClass;	// IMP=0x0000000100083d70
+ (id)containerPathIdentifierForCodeSignIdentifier:(id)arg1;	// IMP=0x0000000100083c48
+ (id)containerPathForUserIdentity:(id)arg1 containerClass:(unsigned long long)arg2 containerPathIdentifier:(id)arg3;	// IMP=0x0000000100083b34
+ (id)containerPathForContainerIdentity:(id)arg1 containerPathIdentifier:(id)arg2;	// IMP=0x0000000100083a74
- (void).cxx_destruct;	// IMP=0x0000000100083954
...
- (_Bool)_createURLIfNecessary:(id)arg1 mode:(unsigned short)arg2 owner:(id)arg3 dataProtectionClass:(int)arg4 error:(id *)arg5;	// IMP=0x0000000100083768
- (_Bool)_obj1:(id)arg1 isEqualToObj2:(id)arg2;	// IMP=0x0000000100083704
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000100083648
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001000835d0
- (_Bool)isEqualToContainerPath:(id)arg1;	// IMP=0x000000010008353c
@property(readonly) unsigned long long hash;
@property(readonly, copy) NSString *description;
- (id)initWithContainerClassPath:(id)arg1 containerPathIdentifier:(id)arg2 containerRootComponent:(id)arg3 containerDataComponent:(id)arg4;	// IMP=0x00000001000830fc
@property(readonly, nonatomic) NSURL *classURL;
@property(readonly, nonatomic) NSURL *categoryURL;
@property(readonly, nonatomic) NSURL *baseURL;
- (_Bool)createIfNecessaryWithDataProtectionClass:(int)arg1 error:(id *)arg2;	// IMP=0x0000000100082d64
