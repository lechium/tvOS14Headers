...
- (void).cxx_destruct;	// IMP=0x000000010005fa70
...
- (void)_initPathPropertiesWithUserHomeDirectoryURL:(id)arg1 clientUser:(id)arg2;	// IMP=0x000000010005f8f4
- (id)initWithUserIdentity:(id)arg1 daemonUser:(id)arg2;	// IMP=0x000000010005f76c
