...
- (void).cxx_destruct;	// IMP=0x0000000100062964
...
- (id)description;	// IMP=0x0000000100062748
- (unsigned long long)hash;	// IMP=0x00000001000625f8
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010006229c
- (id)serialize;	// IMP=0x0000000100061fd0
- (id)initWithSerializedDictionary:(id)arg1;	// IMP=0x0000000100061dbc
- (id)initWithCodeSigningInfo:(id)arg1;	// IMP=0x0000000100061dac
- (id)initWithCodeSigningInfo:(id)arg1 andDataContainerClass:(unsigned long long)arg2;	// IMP=0x0000000100061d18
