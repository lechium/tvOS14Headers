...
- (void).cxx_destruct;	// IMP=0x000000010002a6f4
...
- (void)dealloc;	// IMP=0x000000010002a664
- (id)initWithMetadata:(id)arg1 sandboxToken:(const char *)arg2;	// IMP=0x000000010002a48c
- (_Bool)encodeReplyOntoXPCObject:(id)arg1;	// IMP=0x000000010002a20c
