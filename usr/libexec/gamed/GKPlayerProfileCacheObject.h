...
+ (id)entityName;	// IMP=0x0000000100043864
+ (id)playerProfilesWithPlayerIDs:(id)arg1 inManagedObjectContext:(id)arg2;	// IMP=0x0000000100042428
+ (id)playerProfilesWithPlayers:(id)arg1 inManagedObjectContext:(id)arg2;	// IMP=0x00000001000423c8
+ (id)profileForPlayer:(id)arg1 context:(id)arg2;	// IMP=0x0000000100042340
+ (id)playerProfileWithPlayerID:(id)arg1 inManagedObjectContext:(id)arg2;	// IMP=0x000000010004213c
+ (id)localPlayerInManagedObjectContext:(id)arg1;	// IMP=0x0000000100041f7c
+ (const void *)uniqueObjectIDLookupKey;	// IMP=0x00000001000417fc
+ (id)uniqueAttributeName;	// IMP=0x00000001000417f0
+ (id)filterPlayerIDs:(id)arg1 familiarity:(int)arg2 includeSelf:(_Bool)arg3;	// IMP=0x000000010004480c
+ (unsigned char)piecesToLoadForFamiliarity:(int)arg1;	// IMP=0x00000001000447dc
+ (id)playersByFamiliarity:(id)arg1;	// IMP=0x000000010004437c
+ (void)setFamiliarPlayerIDs:(id)arg1 familiarity:(int)arg2;	// IMP=0x00000001000441e0
+ (void)removeFamiliarPlayerIDs:(id)arg1 familiarity:(int)arg2;	// IMP=0x0000000100043f5c
+ (void)addFamiliarPlayerIDs:(id)arg1 familiarity:(int)arg2;	// IMP=0x0000000100043de8
+ (int)familiarityForPlayerID:(id)arg1;	// IMP=0x0000000100043cb0
+ (id)selfPlayerID;	// IMP=0x0000000100043c84
+ (void)buildFamiliarilyLookupForProfile:(id)arg1;	// IMP=0x0000000100043ae0
+ (id)_familiarityLookup;	// IMP=0x0000000100043984
- (void)expireRecentMatchesWithGame:(id)arg1;	// IMP=0x0000000100043870
- (id)internalRepresentation;	// IMP=0x000000010004372c
- (id)internalRepresentationWithPieces:(unsigned char)arg1;	// IMP=0x0000000100043528
- (void)updateWithServerRepresentation:(id)arg1 expirationDate:(id)arg2 pieces:(unsigned char)arg3;	// IMP=0x0000000100042938
- (id)updateImagesWithImageURLs:(id)arg1;	// IMP=0x0000000100042644
- (void)updateWithServerRepresentation:(id)arg1 expirationDate:(id)arg2;	// IMP=0x0000000100042634
- (void)deleteCachedImage:(id)arg1;	// IMP=0x0000000100041d40
- (void)deleteCachedAvatars;	// IMP=0x0000000100041bc8
- (void)clearImages;	// IMP=0x0000000100041960
...
- (void)invalidate;	// IMP=0x0000000100041880
