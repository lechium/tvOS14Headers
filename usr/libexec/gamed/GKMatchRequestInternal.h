...
+ (id)secureCodedPropertyKeys;	// IMP=0x000000010011f708
...
- (_Bool)hasGuestPlayers;	// IMP=0x000000010011fa28
- (unsigned long long)hash;	// IMP=0x000000010011f694
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010011f274
- (void)dealloc;	// IMP=0x000000010011f1c4
- (id)init;	// IMP=0x000000010011f144
