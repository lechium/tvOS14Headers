...
+ (id)entityName;	// IMP=0x000000010004ff60
- (id)internalRepresentation;	// IMP=0x000000010004fbf4
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x000000010004f620
