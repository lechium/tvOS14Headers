...
+ (id)entityName;	// IMP=0x0000000100044d3c
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x0000000100044b14
- (id)internalRepresentation;	// IMP=0x0000000100044954
