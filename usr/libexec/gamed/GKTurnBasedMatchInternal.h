...
+ (id)secureCodedPropertyKeys;	// IMP=0x000000010011d418
...
- (id)descriptionSubstitutionMap;	// IMP=0x000000010011e09c
@property(nonatomic) unsigned int state; // @synthesize state=_state;
- (long long)activeExchangeCount;	// IMP=0x000000010011db24
- (long long)previousParticipantIndex;	// IMP=0x000000010011d99c
- (long long)localPlayerParticipantIndex;	// IMP=0x000000010011d948
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010011d834
- (unsigned long long)hash;	// IMP=0x000000010011d810
- (void)dealloc;	// IMP=0x000000010011d2b8
- (void)updateWithCacheObject:(id)arg1;	// IMP=0x00000001001247dc
