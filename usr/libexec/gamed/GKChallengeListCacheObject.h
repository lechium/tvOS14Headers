...
+ (Class)entryClass;	// IMP=0x0000000100055e2c
+ (id)entityName;	// IMP=0x0000000100055e20
- (void)updateWithServerRepresentation:(id)arg1 expirationDate:(id)arg2;	// IMP=0x0000000100055e38
