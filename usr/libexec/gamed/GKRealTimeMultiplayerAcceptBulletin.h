...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000010003a8a8
...
- (void)handleAction:(id)arg1;	// IMP=0x000000010003b474
- (void)assembleBulletin;	// IMP=0x000000010003b1a4
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000010003af38
- (id)initWithCoder:(id)arg1;	// IMP=0x000000010003ac68
- (id)initWithPushNotification:(id)arg1;	// IMP=0x000000010003a9b4
- (_Bool)isAccept;	// IMP=0x000000010003a9ac
- (id)notificationName;	// IMP=0x000000010003a99c
- (id)debugLine;	// IMP=0x000000010003a990
- (id)aggregateDictionaryKey;	// IMP=0x000000010003a980
- (void)dealloc;	// IMP=0x000000010003a8b0
