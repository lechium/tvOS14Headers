...
+ (id)secureCodedPropertyKeys;	// IMP=0x000000010011e3f0
...
- (id)descriptionSubstitutionMap;	// IMP=0x000000010011e80c
- (id)serverRepresentation;	// IMP=0x000000010011e67c
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010011e5ac
- (unsigned long long)hash;	// IMP=0x000000010011e590
- (void)dealloc;	// IMP=0x000000010011e340
@property(readonly, nonatomic) NSString *playerID;
- (void)updateWithCacheObject:(id)arg1;	// IMP=0x0000000100124fc0
