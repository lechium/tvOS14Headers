...
+ (id)secureCodedPropertyKeys;	// IMP=0x00000001000839b4
...
- (_Bool)transitionToState:(long long)arg1;	// IMP=0x0000000100083bf4
- (_Bool)isNetworkError;	// IMP=0x0000000100083bb4
- (_Bool)isTimeout;	// IMP=0x0000000100083b74
- (_Bool)isCancelled;	// IMP=0x0000000100083b34
- (_Bool)isFinished;	// IMP=0x0000000100083af4
- (int)_incrementSequence;	// IMP=0x0000000100083ae4
- (void)dealloc;	// IMP=0x0000000100083904
