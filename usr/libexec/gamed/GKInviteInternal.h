...
+ (id)secureCodedPropertyKeys;	// IMP=0x00000001001203cc
+ (id)nearbyInviteIDForPlayerID:(id)arg1 deviceID:(id)arg2 bundleID:(id)arg3;	// IMP=0x000000010012021c
+ (id)inviteFromNearbyPlayer:(id)arg1 participantID:(id)arg2 deviceID:(id)arg3 bundleID:(id)arg4 connectionData:(id)arg5;	// IMP=0x00000001001200e4
+ (id)inviteWithBulletin:(id)arg1;	// IMP=0x000000010011fd10
...
- (id)descriptionSubstitutionMap;	// IMP=0x0000000100120774
@property(readonly, nonatomic) _Bool isNearby; // @dynamic isNearby;
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001001206d8
- (unsigned long long)hash;	// IMP=0x00000001001206b4
- (void)dealloc;	// IMP=0x00000001001202bc
- (id)init;	// IMP=0x0000000100120258
