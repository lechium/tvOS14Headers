...
+ (id)writerWithCacheWriter:(id)arg1 cacheReader:(id)arg2 networkWriter:(id)arg3 batchSubmissionInterval:(double)arg4;	// IMP=0x00000001000b0220
...
- (void)writeResourcesToCacheOnly:(id)arg1 handler:(CDUnknownBlockType)arg2;	// IMP=0x00000001000b190c
- (void)writeResources:(id)arg1 handler:(CDUnknownBlockType)arg2;	// IMP=0x00000001000b11b4
- (void)readAndSubmitDelayedRequestsOfResources:(id)arg1 handler:(CDUnknownBlockType)arg2;	// IMP=0x00000001000b0974
- (void)deleteSubmittedRequestsWithIDs:(id)arg1 onConnection:(id)arg2;	// IMP=0x00000001000b06ac
- (void)submitDelayedRequestsForPlayer:(id)arg1 handler:(CDUnknownBlockType)arg2;	// IMP=0x00000001000b05fc
- (void)batchAndPerformInGroup:(id)arg1 block:(CDUnknownBlockType)arg2;	// IMP=0x00000001000b0478
- (void)dealloc;	// IMP=0x00000001000b0410
- (id)initWithCacheWriter:(id)arg1 cacheReader:(id)arg2 networkWriter:(id)arg3 batchSubmissionInterval:(double)arg4;	// IMP=0x00000001000b033c
