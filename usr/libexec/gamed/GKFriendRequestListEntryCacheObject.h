...
+ (id)entityName;	// IMP=0x000000010004eb30
- (id)internalRepresentation;	// IMP=0x000000010004e948
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x000000010004e6ec
