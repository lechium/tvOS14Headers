...
+ (id)entityName;	// IMP=0x0000000100049a10
- (id)internalRepresentation;	// IMP=0x0000000100049804
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x00000001000493c0
