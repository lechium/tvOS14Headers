...
+ (id)writerWithTransport:(id)arg1 forBagKey:(id)arg2;	// IMP=0x0000000100151768
...
- (void)writeResources:(id)arg1 handler:(CDUnknownBlockType)arg2;	// IMP=0x0000000100151888
- (void)dealloc;	// IMP=0x0000000100151828
- (id)initWithTransport:(id)arg1 forBagKey:(id)arg2;	// IMP=0x00000001001517a8
