...
+ (id)entityName;	// IMP=0x0000000100049280
+ (id)ratingForGameDescriptor:(id)arg1 context:(id)arg2;	// IMP=0x0000000100048ef8
- (void)updateWithServerRepresentation:(id)arg1 expirationDate:(id)arg2;	// IMP=0x00000001000490e0
