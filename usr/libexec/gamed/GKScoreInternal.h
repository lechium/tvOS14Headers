...
+ (id)secureCodedPropertyKeys;	// IMP=0x0000000100116890
+ (_Bool)supportsSecureCoding;	// IMP=0x000000010011636c
...
- (unsigned long long)hash;	// IMP=0x0000000100116d44
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100116b5c
- (id)serverRepresentation;	// IMP=0x0000000100116a34
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000100116764
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000100116394
- (void)dealloc;	// IMP=0x00000001001162dc
