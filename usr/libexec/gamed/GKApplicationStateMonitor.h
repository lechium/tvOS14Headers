...
- (void)startObservingStateChangesForBundleID:(id)arg1;	// IMP=0x0000000100075074
- (_Bool)observingStateChangesForBundleID:(id)arg1;	// IMP=0x000000010007503c
@property(copy, nonatomic) CDUnknownBlockType handler;
- (void)dealloc;	// IMP=0x0000000100074fc4
- (id)init;	// IMP=0x0000000100074f58
