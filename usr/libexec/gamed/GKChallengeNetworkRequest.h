...
+ (id)bagKey;	// IMP=0x00000001001a9c68
- (void).cxx_destruct;	// IMP=0x00000001001aab6c
...
- (id)taskInfo;	// IMP=0x00000001001aa874
- (void)removeFromStore:(id)arg1;	// IMP=0x00000001001aa5c0
- (id)postBody;	// IMP=0x00000001001aa528
- (id)initWithTask:(id)arg1;	// IMP=0x00000001001aa334
- (id)initWithChallenges:(id)arg1 bundleID:(id)arg2;	// IMP=0x00000001001aa1fc
- (void)handleNetworkRequest:(id)arg1 session:(id)arg2 clientProxy:(id)arg3;	// IMP=0x00000001001a9c74
