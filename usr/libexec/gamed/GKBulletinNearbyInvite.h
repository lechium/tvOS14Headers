...
- (void)handleAction:(id)arg1;	// IMP=0x00000001000e2ee8
- (void)dealloc;	// IMP=0x00000001000e2e98
- (id)initWithPlayer:(id)arg1 localizedGameName:(id)arg2 inviteDictionary:(id)arg3;	// IMP=0x00000001000e2a3c
