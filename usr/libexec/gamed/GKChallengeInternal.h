...
+ (id)internalRepresentation;	// IMP=0x0000000100118bd0
+ (id)secureCodedPropertyKeys;	// IMP=0x0000000100118778
...
- (id)descriptionSubstitutionMap;	// IMP=0x0000000100118f5c
@property(readonly, nonatomic) NSString *subtitleText;
@property(readonly, nonatomic) NSString *titleText;
@property(readonly, nonatomic) unsigned long long type;
- (id)findLocalGameBundleID;	// IMP=0x0000000100118cf0
- (id)serverRepresentationForReceivingPlayer:(id)arg1;	// IMP=0x0000000100118be4
- (id)serverRepresentation;	// IMP=0x0000000100118bd8
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100118b4c
- (unsigned long long)hash;	// IMP=0x0000000100118b28
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000100118a50
- (void)dealloc;	// IMP=0x0000000100118980
