...
+ (id)secureCodedPropertyKeys;	// IMP=0x000000010010b610
+ (id)propertiesToFetch;	// IMP=0x0000000100121ae8
...
- (id)description;	// IMP=0x000000010010b900
- (id)serverRepresentation;	// IMP=0x000000010010b8f4
- (void)dealloc;	// IMP=0x000000010010b580
- (unsigned long long)hash;	// IMP=0x000000010010b55c
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010010b4d8
- (id)defaultCategory;	// IMP=0x000000010010bf68
- (unsigned short)numberOfCategories;	// IMP=0x000000010010bf5c
- (void)updateWithProperties:(id)arg1;	// IMP=0x0000000100121b3c
- (void)updateWithCacheObject:(id)arg1;	// IMP=0x00000001001214e0
