...
+ (id)entityName;	// IMP=0x000000010004dd3c
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x000000010004dd48
- (id)internalRepresentation;	// IMP=0x000000010004db14
