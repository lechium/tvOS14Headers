...
+ (id)secureCodedPropertyKeys;	// IMP=0x0000000100113b68
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000100113b00
...
- (unsigned long long)hash;	// IMP=0x0000000100113d0c
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100113c6c
- (void)dealloc;	// IMP=0x0000000100113b08
