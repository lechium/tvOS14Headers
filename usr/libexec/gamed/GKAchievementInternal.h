...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000100114b44
+ (id)secureCodedPropertyKeys;	// IMP=0x000000010011493c
...
- (id)descriptionSubstitutionMap;	// IMP=0x0000000100114fec
...
- (unsigned long long)hash;	// IMP=0x0000000100114edc
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100114e0c
- (id)serverRepresentation;	// IMP=0x0000000100114cac
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000100114be8
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000100114b4c
- (void)dealloc;	// IMP=0x000000010011487c
- (void)mergePropertiesFromDescription:(id)arg1;	// IMP=0x00000001001150f8
