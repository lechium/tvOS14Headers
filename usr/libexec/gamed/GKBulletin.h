...
+ (void)performAsync:(CDUnknownBlockType)arg1;	// IMP=0x00000001000cfaf8
+ (_Bool)shouldProcessNotification;	// IMP=0x00000001000cf918
+ (_Bool)supportsSecureCoding;	// IMP=0x00000001000cf610
+ (void)loadBulletinsForPushNotification:(id)arg1 withHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000001000cee28
+ (void)bulletinsForPushNotification:(id)arg1 withHandler:(CDUnknownBlockType)arg2;	// IMP=0x00000001000ce89c
+ (id)syncQueue;	// IMP=0x00000001000ce828
...
- (id)description;	// IMP=0x00000001000cfc60
- (void)handleAction:(id)arg1;	// IMP=0x00000001000cfbec
- (void)executeBulletinWithBulletinController:(id)arg1;	// IMP=0x00000001000cfa08
- (void)dealloc;	// IMP=0x00000001000cf870
- (id)initWithPushNotification:(id)arg1;	// IMP=0x00000001000cf718
- (id)dataFrom64String:(id)arg1;	// IMP=0x00000001000cf618
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000001000cf258
- (id)initWithCoder:(id)arg1;	// IMP=0x00000001000cee94
