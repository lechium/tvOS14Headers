...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000001000353fc
...
- (id)description;	// IMP=0x00000001000367a4
- (id)customInviteSoundPathForBundleID:(id)arg1;	// IMP=0x0000000100036698
- (void)declineInviteWithReason:(int)arg1;	// IMP=0x0000000100036534
- (void)updateDeclineInviteTrackingForReason:(long long)arg1;	// IMP=0x0000000100036410
- (id)clientNotification;	// IMP=0x00000001000360f8
- (id)clientNotificationWithiCloudID:(id)arg1;	// IMP=0x000000010003608c
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000100035db4
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000100035a40
- (id)initWithPushNotification:(id)arg1;	// IMP=0x0000000100035744
- (void)parseClientData:(id)arg1;	// IMP=0x000000010003562c
- (long long)inviteVersionFromMessage:(id)arg1;	// IMP=0x0000000100035518
- (void)dealloc;	// IMP=0x0000000100035438
- (id)init;	// IMP=0x0000000100035404
