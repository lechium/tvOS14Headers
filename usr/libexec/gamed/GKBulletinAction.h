...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000100077acc
...
- (void)dealloc;	// IMP=0x0000000100077b40
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000100077ad4
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000100077890
- (id)initWithCoder:(id)arg1;	// IMP=0x000000010007766c
- (id)initWithDictionary:(id)arg1;	// IMP=0x00000001000775e4
- (id)init;	// IMP=0x00000001000775a4
