...
+ (id)entityName;	// IMP=0x000000010005730c
- (id)internalRepresentation;	// IMP=0x0000000100057318
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x0000000100057308
