...
+ (id)secureCodedPropertyKeys;	// IMP=0x0000000100115b64
- (void).cxx_destruct;	// IMP=0x0000000100115f48
...
- (unsigned long long)hash;	// IMP=0x0000000100115e48
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100115d60
