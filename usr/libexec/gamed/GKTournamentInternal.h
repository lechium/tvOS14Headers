...
+ (id)defaultCustomTournamentForTournamentDefinition:(id)arg1;	// IMP=0x00000001000e1c4c
+ (id)secureCodedPropertyKeys;	// IMP=0x00000001000e18e0
- (void).cxx_destruct;	// IMP=0x00000001000e2148
