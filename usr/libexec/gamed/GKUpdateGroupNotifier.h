...
- (void).cxx_destruct;	// IMP=0x0000000100117430
...
- (void)addUpdatesFromGroup:(id)arg1;	// IMP=0x00000001001172e0
- (void)addUpdate:(CDUnknownBlockType)arg1 error:(id)arg2;	// IMP=0x0000000100117154
- (void)updateError:(id)arg1;	// IMP=0x00000001001170d0
- (oneway void)release;	// IMP=0x0000000100117020
- (id)retain;	// IMP=0x0000000100116f84
- (void)dealloc;	// IMP=0x0000000100116f20
- (id)init;	// IMP=0x0000000100116eb8
