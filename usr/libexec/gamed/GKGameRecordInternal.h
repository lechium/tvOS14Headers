...
+ (id)secureCodedPropertyKeys;	// IMP=0x000000010010c854
+ (id)gameRecordForGame:(id)arg1;	// IMP=0x000000010010c6c0
+ (id)_gameProperties;	// IMP=0x0000000100122500
+ (id)propertiesToFetch;	// IMP=0x0000000100122220
...
- (void)updateWithGame:(id)arg1;	// IMP=0x000000010010c708
- (void)dealloc;	// IMP=0x000000010010c650
- (void)updateWithProperties:(id)arg1;	// IMP=0x00000001001225e4
- (void)updateWithCacheObject:(id)arg1;	// IMP=0x0000000100121fcc
