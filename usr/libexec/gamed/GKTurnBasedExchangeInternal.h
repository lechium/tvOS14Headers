...
+ (id)secureCodedPropertyKeys;	// IMP=0x000000010011ea80
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010011ed48
- (unsigned long long)hash;	// IMP=0x000000010011ed30
- (void)dealloc;	// IMP=0x000000010011e9b0
- (void)updateWithCacheObject:(id)arg1;	// IMP=0x00000001001251c0
