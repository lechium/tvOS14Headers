...
+ (id)bagKey;	// IMP=0x00000001001aabd8
- (void).cxx_destruct;	// IMP=0x00000001001ab3b0
...
- (void)updateWithTaskInfo:(id)arg1;	// IMP=0x00000001001ab1f0
- (void)removeFromStore:(id)arg1;	// IMP=0x00000001001ab1ec
- (void)handleNetworkRequest:(id)arg1 session:(id)arg2 clientProxy:(id)arg3;	// IMP=0x00000001001ab190
- (id)taskInfo;	// IMP=0x00000001001ab020
- (id)postBody;	// IMP=0x00000001001ab014
- (id)initWithInstanceScore:(id)arg1 bundleID:(id)arg2 challenges:(id)arg3;	// IMP=0x00000001001aad88
- (id)initWithTask:(id)arg1;	// IMP=0x00000001001aabe4
