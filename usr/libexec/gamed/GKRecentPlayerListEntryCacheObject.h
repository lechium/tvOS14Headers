...
+ (id)entityName;	// IMP=0x0000000100050428
- (id)internalRepresentation;	// IMP=0x00000001000505f0
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x0000000100050434
