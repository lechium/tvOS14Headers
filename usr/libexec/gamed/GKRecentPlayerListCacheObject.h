...
+ (Class)entryClass;	// IMP=0x000000010004ff78
+ (id)entityName;	// IMP=0x000000010004ff6c
- (id)internalRepresentation;	// IMP=0x000000010005013c
- (void)updateWithServerRepresentation:(id)arg1 expirationDate:(id)arg2;	// IMP=0x000000010004ff84
