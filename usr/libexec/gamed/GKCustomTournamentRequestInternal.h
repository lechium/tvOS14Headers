...
+ (id)customTournamentRequestWithTournamentDefinition:(id)arg1 player:(id)arg2;	// IMP=0x00000001000e09b8
+ (id)secureCodedPropertyKeys;	// IMP=0x00000001000e07bc
- (void).cxx_destruct;	// IMP=0x00000001000e0d74
