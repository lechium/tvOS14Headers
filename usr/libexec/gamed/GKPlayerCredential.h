...
+ (id)secureCodedPropertyKeys;	// IMP=0x000000010010d5ec
...
- (id)description;	// IMP=0x000000010010d4e8
@property(readonly) NSString *scopeAsString;
- (void)dealloc;	// IMP=0x000000010010d35c
- (unsigned long long)hash;	// IMP=0x000000010010d338
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010010d1e0
