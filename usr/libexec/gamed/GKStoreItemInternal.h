...
+ (id)secureCodedPropertyKeys;	// IMP=0x000000010010c024
...
- (void)storeItemURLForGamePlatform:(long long)arg1 withContext:(id)arg2 withHandler:(CDUnknownBlockType)arg3;	// IMP=0x000000010010c2fc
- (id)storeItemURLForURL:(id)arg1 gamePlatform:(long long)arg2 extraQueryParams:(id)arg3;	// IMP=0x000000010010c29c
- (_Bool)isValid;	// IMP=0x000000010010c278
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010010c1f4
- (unsigned long long)hash;	// IMP=0x000000010010c1dc
- (void)dealloc;	// IMP=0x000000010010bf74
- (void)updateWithProperties:(id)arg1;	// IMP=0x0000000100123008
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x0000000100122c28
- (void)updateWithCacheObject:(id)arg1;	// IMP=0x0000000100122910
