...
+ (id)secureCodedPropertyKeys;	// IMP=0x00000001001190f8
+ (id)internalRepresentation;	// IMP=0x00000001001190e4
...
- (id)titleText;	// IMP=0x0000000100119420
- (unsigned long long)type;	// IMP=0x0000000100119418
- (id)serverRepresentationForReceivingPlayer:(id)arg1;	// IMP=0x0000000100119214
- (void)dealloc;	// IMP=0x0000000100119084
