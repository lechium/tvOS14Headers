...
+ (id)writerWithTransport:(id)arg1 forBagKey:(id)arg2;	// IMP=0x0000000100107584
...
- (void)writeResources:(id)arg1 handler:(CDUnknownBlockType)arg2;	// IMP=0x0000000100107694
- (void)dealloc;	// IMP=0x0000000100107644
- (id)initWithTransport:(id)arg1 forBagKey:(id)arg2;	// IMP=0x00000001001075c4
