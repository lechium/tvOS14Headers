...
+ (Class)entryClass;	// IMP=0x0000000100050710
+ (id)entityName;	// IMP=0x0000000100050704
- (id)internalRepresentation;	// IMP=0x00000001000508d4
- (void)updateWithServerRepresentation:(id)arg1 expirationDate:(id)arg2;	// IMP=0x000000010005071c
