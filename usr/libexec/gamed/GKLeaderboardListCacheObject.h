...
+ (id)entityName;	// IMP=0x0000000100049e80
- (_Bool)isValid;	// IMP=0x0000000100049f40
- (void)updateWithServerRepresentation:(id)arg1 expirationDate:(id)arg2;	// IMP=0x0000000100049e8c
