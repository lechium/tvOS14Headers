...
+ (id)sharedManager;	// IMP=0x00000001000ec190
- (void).cxx_destruct;	// IMP=0x00000001000ec650
...
- (_Bool)isRecordEqualToMostRecentInviteShare:(id)arg1;	// IMP=0x00000001000ec3a8
- (id)init;	// IMP=0x00000001000ec2f0
