...
+ (id)entityName;	// IMP=0x000000010004c444
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x000000010004c450
- (id)internalRepresentation;	// IMP=0x000000010004c2cc
