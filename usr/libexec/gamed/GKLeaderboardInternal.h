...
+ (id)secureCodedPropertyKeys;	// IMP=0x000000010011523c
- (void).cxx_destruct;	// IMP=0x00000001001159e4
...
- (unsigned long long)hash;	// IMP=0x00000001001156c0
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001001155d8
