...
+ (id)entityName;	// IMP=0x0000000100053fe0
- (id)internalRepresentation;	// IMP=0x00000001000542d8
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x0000000100053fec
