...
+ (id)displayNameForEnvironment:(long long)arg1;	// IMP=0x0000000100073108
+ (id)hostNameForEnvironment:(long long)arg1;	// IMP=0x00000001000730dc
+ (id)shared;	// IMP=0x000000010007200c
...
- (void)removeOverrideForKey:(id)arg1;	// IMP=0x00000001000724cc
- (void)setStringValue:(id)arg1 forKey:(struct __CFString *)arg2;	// IMP=0x00000001000724b4
- (id)stringValueForKey:(struct __CFString *)arg1 defaultValue:(id)arg2;	// IMP=0x0000000100072484
- (void)setTimeInterval:(double)arg1 forKey:(struct __CFString *)arg2;	// IMP=0x0000000100072428
- (double)timeIntervalForKey:(struct __CFString *)arg1 defaultValue:(double)arg2;	// IMP=0x00000001000723e4
- (void)setUnsignedIntegerValue:(long long)arg1 forKey:(struct __CFString *)arg2;	// IMP=0x0000000100072388
- (long long)unsignedIntegerValueForKey:(struct __CFString *)arg1 defaultValue:(long long)arg2;	// IMP=0x0000000100072344
- (void)setIntegerValue:(long long)arg1 forKey:(struct __CFString *)arg2;	// IMP=0x00000001000722e8
- (long long)integerValueForKey:(struct __CFString *)arg1 defaultValue:(long long)arg2;	// IMP=0x00000001000722a4
- (void)setBooleanValue:(_Bool)arg1 forKey:(struct __CFString *)arg2;	// IMP=0x0000000100072244
- (_Bool)booleanValueForKey:(struct __CFString *)arg1;	// IMP=0x0000000100072234
- (_Bool)booleanValueForKey:(struct __CFString *)arg1 defaultValue:(_Bool)arg2;	// IMP=0x00000001000721f0
- (id)preferencesValueForKey:(id)arg1;	// IMP=0x00000001000721a0
- (void)_didWriteKey:(struct __CFString *)arg1;	// IMP=0x0000000100072178
- (void)synchronize;	// IMP=0x000000010007213c
- (void)invalidate;	// IMP=0x000000010007212c
- (_Bool)isInternalBuild;	// IMP=0x00000001000720b0
- (void)dealloc;	// IMP=0x0000000100071fc4
- (id)init;	// IMP=0x0000000100071fb8
- (id)initWithoutUIKitNotifications;	// IMP=0x0000000100071f38
- (id)initWithUIKitNotifications;	// IMP=0x0000000100071f2c
- (void)profileConnectionDidReceiveEffectiveSettingsChangedNotification:(id)arg1 userInfo:(id)arg2;	// IMP=0x00000001000d0300
- (id)valueRestrictionForKey:(id)arg1;	// IMP=0x00000001000d02c4
- (_Bool)restrictionEnabledForKey:(id)arg1;	// IMP=0x00000001000d027c
