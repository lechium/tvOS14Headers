...
+ (id)entityName;	// IMP=0x00000001000542e0
- (id)internalRepresentation;	// IMP=0x000000010005493c
- (void)updateWithServerRepresentation:(id)arg1 participants:(id)arg2;	// IMP=0x00000001000542ec
