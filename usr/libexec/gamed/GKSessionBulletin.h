...
+ (_Bool)displayNotification;	// IMP=0x00000001000c9840
+ (_Bool)supportsSecureCoding;	// IMP=0x00000001000c9838
- (void).cxx_destruct;	// IMP=0x00000001000cb8fc
...
- (id)description;	// IMP=0x00000001000cb688
- (void)assembleBulletin;	// IMP=0x00000001000cb0ec
- (void)localizeMessage;	// IMP=0x00000001000cb018
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000001000cad74
- (id)initWithCoder:(id)arg1;	// IMP=0x00000001000caab0
- (id)initWithPushNotification:(id)arg1;	// IMP=0x00000001000ca7f8
- (void)distributeData;	// IMP=0x00000001000ca7f4
- (void)loadDataWithHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000001000ca3f8
- (void)determineGameLocationOnDeviceOrInStoreWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000001000c9848
