...
+ (id)processWithPID:(int)arg1 name:(const char *)arg2;	// IMP=0x0000000100010798
+ (unsigned long long)generateUniqueIDForPID:(int)arg1 processName:(id)arg2;	// IMP=0x0000000100010764
- (void).cxx_destruct;	// IMP=0x00000001000108ec
...
- (id)initWithPID:(int)arg1 name:(id)arg2;	// IMP=0x0000000100010820
