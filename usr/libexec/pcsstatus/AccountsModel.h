...
+ (id)defaultAccountsModel;	// IMP=0x00000001000077d0
...
- (void)update;	// IMP=0x0000000100007f40
...
- (void)_accountStoreDidChange:(id)arg1;	// IMP=0x0000000100007984
- (id)init;	// IMP=0x0000000100007854
