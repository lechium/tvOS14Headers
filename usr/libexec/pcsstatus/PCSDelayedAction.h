...
- (void).cxx_destruct;	// IMP=0x0000000100009510
...
- (void)trigger;	// IMP=0x0000000100009378
- (void)setHoldTransaction:(_Bool)arg1;	// IMP=0x00000001000092e0
- (void)run;	// IMP=0x00000001000092d0
- (void)setAction:(CDUnknownBlockType)arg1;	// IMP=0x000000010000928c
- (id)initWithDelay:(unsigned long long)arg1 operationQueue:(id)arg2;	// IMP=0x0000000100008eac
