...
+ (int)dumpConnectedHosts:(id *)arg1;	// IMP=0x0000000100006064
+ (void)invalidateServiceWithPID:(int)arg1 heartBeatRef:(unsigned long long)arg2;	// IMP=0x0000000100005ed0
+ (void)invalidateWatcherForHost:(struct __CFString *)arg1;	// IMP=0x0000000100005b60
+ (void)removeService:(id)arg1 forHostID:(struct __CFString *)arg2;	// IMP=0x0000000100005a88
+ (void)addService:(id)arg1 forHostID:(struct __CFString *)arg2;	// IMP=0x0000000100005984
- (void).cxx_destruct;	// IMP=0x0000000100008e18
...
- (void)enumerateServices:(CDUnknownBlockType)arg1;	// IMP=0x0000000100008c54
- (void)removeService:(id)arg1;	// IMP=0x0000000100008be4
- (void)addService:(id)arg1;	// IMP=0x0000000100008b74
- (void)dealloc;	// IMP=0x00000001000089f8
- (id)initWithCheckinGoop:(void *)arg1;	// IMP=0x0000000100008258
- (id)description;	// IMP=0x00000001000081d4
- (void)handleSleepNotification:(unsigned int)arg1 service:(unsigned int)arg2 messageArgument:(void *)arg3;	// IMP=0x0000000100007924
- (void)runWatcher;	// IMP=0x0000000100006f84
- (void)invalidate;	// IMP=0x0000000100006b1c
- (id)receiveMessage:(char **)arg1 size:(unsigned long long *)arg2;	// IMP=0x000000010000673c
- (int)receivePacket:(char *)arg1 size:(unsigned long long)arg2;	// IMP=0x00000001000066c0
- (int)sendPacket:(const char *)arg1 size:(unsigned long long)arg2;	// IMP=0x000000010000664c
- (long long)_receivePartialPacket:(char *)arg1 size:(unsigned long long)arg2;	// IMP=0x00000001000064c4
- (long long)_sendPartialPacket:(const char *)arg1 size:(unsigned long long)arg2;	// IMP=0x000000010000633c
