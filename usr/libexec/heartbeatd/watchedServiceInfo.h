...
+ (int)processWatchCommand:(id)arg1;	// IMP=0x0000000100008e6c
...
- (_Bool)hasHeartbeatRef:(unsigned long long)arg1 pid:(int)arg2;	// IMP=0x00000001000098bc
- (void)logService:(const char *)arg1;	// IMP=0x0000000100009810
- (id)description;	// IMP=0x000000010000978c
- (void)invalidate;	// IMP=0x00000001000095f8
- (void)dealloc;	// IMP=0x0000000100009580
- (id)initWithWatchCommand:(id)arg1;	// IMP=0x0000000100008fdc
