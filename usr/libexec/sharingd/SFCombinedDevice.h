...
- (void).cxx_destruct;	// IMP=0x000000010009e36c
...
- (_Bool)stateIsNearby;	// IMP=0x000000010009dff0
- (_Bool)stateIsMedium;	// IMP=0x000000010009dfac
- (_Bool)stateIsClose;	// IMP=0x000000010009df98
- (void)resetTicks;	// IMP=0x000000010009ddec
@property(readonly, copy, nonatomic) NSString *name;
@property(readonly, copy, nonatomic) NSString *effectiveID;
@property(readonly, nonatomic) _Bool isReady;
- (_Bool)_canTransition:(int)arg1;	// IMP=0x000000010009daa8
- (_Bool)canTransition:(int)arg1;	// IMP=0x000000010009d9ac
- (id)description;	// IMP=0x000000010009d610
