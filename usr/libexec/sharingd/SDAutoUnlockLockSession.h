...
- (void).cxx_destruct;	// IMP=0x00000001001cdf18
...
- (void)sendUnlockConfirmation:(_Bool)arg1 withError:(id)arg2;	// IMP=0x00000001001cd008
- (void)sendKeyExchangeResponseWithData:(id)arg1;	// IMP=0x00000001001ccd08
- (void)sendAuthPromptImageDataIfReady:(id)arg1;	// IMP=0x00000001001cc570
- (void)sendAuthPromptRequestWithImageHash:(id)arg1 appName:(id)arg2;	// IMP=0x00000001001cc150
- (void)sendAWDLInfoData:(id)arg1 type:(unsigned short)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000001001cbe48
- (void)consumeAuthTokenIfReady;	// IMP=0x00000001001cb8cc
- (void)startAWDL;	// IMP=0x00000001001cad38
- (void)handleConfirmationACK;	// IMP=0x00000001001caad8
- (void)handleSessionAuthToken:(id)arg1;	// IMP=0x00000001001ca6a4
- (void)handleSessionKeyExchangeRequest:(id)arg1;	// IMP=0x00000001001c9ea0
- (void)handleAuthPromptResponse:(id)arg1;	// IMP=0x00000001001c9b34
- (void)handleAWDLInfo:(id)arg1;	// IMP=0x00000001001c94ac
- (void)handleMessageWithWrapper:(id)arg1;	// IMP=0x00000001001c9008
- (void)notifyDelegateWithError:(id)arg1;	// IMP=0x00000001001c8db8
- (void)handleWiFiRequestInvalidated;	// IMP=0x00000001001c8d4c
- (void)handleRangingStarted;	// IMP=0x00000001001c8cac
- (void)handlePeerFound:(_Bool)arg1;	// IMP=0x00000001001c8be4
- (void)handleAWDLUp;	// IMP=0x00000001001c8a10
- (void)handlePeerOutOfRange;	// IMP=0x00000001001c8738
- (void)handlePeerInRange;	// IMP=0x00000001001c85e0
- (_Bool)peerInRange:(id)arg1;	// IMP=0x00000001001c832c
- (void)handleRangingResults:(id)arg1 errorCode:(long long)arg2;	// IMP=0x00000001001c7ecc
- (void)invalidateConfirmationTimer;	// IMP=0x00000001001c7df4
- (void)restartConfirmationTimer:(unsigned long long)arg1 error:(id)arg2;	// IMP=0x00000001001c7b70
- (void)handleTimerFired;	// IMP=0x00000001001c7608
- (void)invalidateTimerIfReady;	// IMP=0x00000001001c75b0
- (id)aksPeerAvailable;	// IMP=0x00000001001c73a8
- (void)deviceConnected:(id)arg1;	// IMP=0x00000001001c6fc0
- (_Bool)handleFoundBLEDevice:(id)arg1 available:(_Bool)arg2 lockedOnWrist:(_Bool)arg3;	// IMP=0x00000001001c6cc8
- (_Bool)handleFoundBLEDevice:(id)arg1;	// IMP=0x00000001001c6c5c
- (void)connectionActivated;	// IMP=0x00000001001c6940
- (void)updateImageData:(id)arg1 imageHash:(id)arg2;	// IMP=0x00000001001c6324
- (id)getAppName;	// IMP=0x00000001001c631c
@property(readonly, nonatomic) _Bool usingProxy;
- (id)hintToken;	// IMP=0x00000001001c61e8
- (_Bool)isAcceptor;	// IMP=0x00000001001c61e0
- (id)attemptResults;	// IMP=0x00000001001c5618
- (void)logResults;	// IMP=0x00000001001c4800
- (void)displayConfigChanged:(id)arg1;	// IMP=0x00000001001c475c
- (void)clamshellStateChanged:(id)arg1;	// IMP=0x00000001001c46b8
- (void)removeObservers;	// IMP=0x00000001001c4668
- (void)addObservers;	// IMP=0x00000001001c4560
- (void)handleDecryptionFailure:(long long)arg1;	// IMP=0x00000001001c43f8
- (void)_handleCanceledAfterSuccess;	// IMP=0x00000001001c42f0
- (void)handleCanceledAfterSuccess;	// IMP=0x00000001001c4264
- (void)lockKeyBagIfNeeded;	// IMP=0x00000001001c4180
- (void)_cancel;	// IMP=0x00000001001c3e0c
- (void)cancel;	// IMP=0x00000001001c3d80
- (void)invalidateNoDisconnect;	// IMP=0x00000001001c3d4c
- (void)invalidate;	// IMP=0x00000001001c3b48
- (id)initWithAutoUnlockDevice:(id)arg1 sessionID:(id)arg2 bleDevice:(id)arg3;	// IMP=0x00000001001c3754
