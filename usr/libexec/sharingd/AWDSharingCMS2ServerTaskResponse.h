...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000100172994
- (unsigned long long)hash;	// IMP=0x00000001001728e0
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100172794
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000100172684
- (void)copyTo:(id)arg1;	// IMP=0x0000000100172590
- (void)writeTo:(id)arg1;	// IMP=0x00000001001724a0
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000100172498
- (id)dictionaryRepresentation;	// IMP=0x0000000100171db4
- (id)description;	// IMP=0x0000000100171d00
