...
- (void).cxx_destruct;	// IMP=0x000000010017aa04
...
- (void)logClientReceived;	// IMP=0x000000010017a80c
- (void)logClientSent;	// IMP=0x000000010017a798
- (void)writeNetworkStream;	// IMP=0x000000010017a68c
- (void)readClientStream;	// IMP=0x000000010017a464
- (void)writeClientStream;	// IMP=0x000000010017a124
- (void)handleOpenedStream;	// IMP=0x000000010017a084
- (void)stream:(id)arg1 handleEvent:(unsigned long long)arg2;	// IMP=0x0000000100179ebc
- (void)streamHandlerDidClose:(id)arg1 withError:(id)arg2;	// IMP=0x0000000100179c40
- (void)streamHandler:(id)arg1 didReceiveStreamData:(id)arg2;	// IMP=0x0000000100179bcc
- (void)streamHandler:(id)arg1 bufferSpaceChanged:(_Bool)arg2;	// IMP=0x0000000100179b48
- (void)handleStreamResponse:(id)arg1;	// IMP=0x0000000100179948
- (void)handleStreamRequest:(id)arg1;	// IMP=0x00000001001796d0
- (void)streamHandler:(id)arg1 didReceiveMessage:(id)arg2;	// IMP=0x000000010017952c
- (void)netServiceBrowser:(id)arg1 didFindService:(id)arg2 moreComing:(_Bool)arg3;	// IMP=0x0000000100179474
- (int)setBufferSize:(int)arg1 socket:(int)arg2;	// IMP=0x0000000100179410
@property(readonly) NSFileHandle *fileHandle; // @synthesize fileHandle=_fileHandle;
- (void)notifyStreamRequestWithError:(id)arg1;	// IMP=0x0000000100178edc
- (void)switchToStreaming;	// IMP=0x0000000100178e48
- (void)sendInitialResponse:(_Bool)arg1;	// IMP=0x0000000100178b60
- (void)sendInitialRequest;	// IMP=0x0000000100178820
- (void)startBrowser;	// IMP=0x0000000100178744
- (void)getStreamsWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000001001786e0
- (void)setBundleID:(id)arg1;	// IMP=0x000000010017862c
- (void)stopIfReady;	// IMP=0x00000001001785dc
- (void)stop;	// IMP=0x0000000100178418
- (void)start;	// IMP=0x00000001001783dc
- (void)dealloc;	// IMP=0x0000000100178390
- (id)initWithAuthorData:(id)arg1 streamHandler:(id)arg2;	// IMP=0x0000000100178268
- (id)initWithStreamHandler:(id)arg1;	// IMP=0x0000000100178254
