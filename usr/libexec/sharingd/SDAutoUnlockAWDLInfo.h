...
- (void).cxx_destruct;	// IMP=0x00000001000c4da4
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000001000c4b8c
- (unsigned long long)hash;	// IMP=0x00000001000c4a58
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001000c4858
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001000c46b8
- (void)copyTo:(id)arg1;	// IMP=0x00000001000c455c
- (void)writeTo:(id)arg1;	// IMP=0x00000001000c4420
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000001000c4418
- (id)dictionaryRepresentation;	// IMP=0x00000001000c3c48
- (id)description;	// IMP=0x00000001000c3b94
