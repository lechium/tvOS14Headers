...
- (void).cxx_destruct;	// IMP=0x00000001000f53d4
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000001000f4ad8
- (unsigned long long)hash;	// IMP=0x00000001000f45d4
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001000f3edc
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001000f3850
- (void)copyTo:(id)arg1;	// IMP=0x00000001000f3228
- (void)writeTo:(id)arg1;	// IMP=0x00000001000f2c98
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000001000f2c90
- (id)dictionaryRepresentation;	// IMP=0x00000001000f05e8
- (id)description;	// IMP=0x00000001000f0534
