...
+ (id)shared;	// IMP=0x00000001001dadd0
- (void).cxx_destruct;	// IMP=0x00000001001e328c
- (id)init;	// IMP=0x00000001001dc7d8
- (_Bool)acquireTokenForIdentifier:(unsigned long long)arg1;	// IMP=0x00000001001dae10
