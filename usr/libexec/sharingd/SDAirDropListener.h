...
- (void).cxx_destruct;	// IMP=0x00000001000b41dc
...
- (void)dealloc;	// IMP=0x00000001000b40e0
- (void)stop;	// IMP=0x00000001000b4088
- (void)start;	// IMP=0x00000001000b4004
- (void)networkOperation:(id)arg1 event:(long long)arg2 withResults:(id)arg3;	// IMP=0x00000001000b3d0c
- (id)init;	// IMP=0x00000001000b3cb8
