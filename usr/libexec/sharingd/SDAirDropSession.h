...
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x0000000100038ad4
- (void)handleConversionProgress:(id)arg1;	// IMP=0x00000001000389e4
- (void)startProgress;	// IMP=0x0000000100038738
- (void)postNotificationForTransferStatus:(long long)arg1 progress:(double)arg2;	// IMP=0x0000000100038734
- (void)airDropClient:(id)arg1 event:(long long)arg2 withResults:(id)arg3;	// IMP=0x0000000100037fc4
- (void)removeClientAlerts;	// IMP=0x0000000100037e9c
- (void)dealloc;	// IMP=0x0000000100037e10
- (void)stop;	// IMP=0x0000000100037c7c
- (void)addClientForNode:(struct __SFNode *)arg1 shouldPublishProgress:(_Bool)arg2;	// IMP=0x0000000100037970
- (void)serversChanged:(id)arg1;	// IMP=0x0000000100037698
- (_Bool)send;	// IMP=0x000000010003756c
- (void)start;	// IMP=0x000000010003737c
- (void)releaseSandboxExtensions;	// IMP=0x0000000100037268
- (void)consumeSandboxExtensions;	// IMP=0x0000000100036ffc
- (void)setProperty:(id)arg1 forKey:(id)arg2;	// IMP=0x0000000100036f94
- (id)initWithPerson:(struct __SFNode *)arg1 items:(id)arg2 sandboxExtensions:(id)arg3;	// IMP=0x0000000100036da0
