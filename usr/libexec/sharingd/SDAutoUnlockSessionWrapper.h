...
- (void).cxx_destruct;	// IMP=0x00000001000dffe0
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000001000dfcfc
- (unsigned long long)hash;	// IMP=0x00000001000dfb80
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001000df90c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001000df6f4
- (void)copyTo:(id)arg1;	// IMP=0x00000001000df538
- (void)writeTo:(id)arg1;	// IMP=0x00000001000df3a8
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000001000df3a0
- (id)dictionaryRepresentation;	// IMP=0x00000001000deb28
- (id)description;	// IMP=0x00000001000dea74
