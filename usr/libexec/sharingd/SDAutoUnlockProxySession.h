...
- (void).cxx_destruct;	// IMP=0x00000001000c3924
...
- (void)sendProxyTrigger;	// IMP=0x00000001000c3438
- (void)notifyDelegateWithError:(id)arg1;	// IMP=0x00000001000c3364
- (void)handleFoundBLEDevice:(id)arg1;	// IMP=0x00000001000c30f4
- (void)deviceConnected:(id)arg1;	// IMP=0x00000001000c2f7c
- (id)results;	// IMP=0x00000001000c2dfc
- (void)removeObservers;	// IMP=0x00000001000c2dac
- (void)addObservers;	// IMP=0x00000001000c2d44
- (void)invalidate;	// IMP=0x00000001000c2c5c
- (void)_start;	// IMP=0x00000001000c2ba4
- (void)start;	// IMP=0x00000001000c2b18
- (id)initWithDevice:(id)arg1 sessionID:(id)arg2 bleDevice:(id)arg3;	// IMP=0x00000001000c2a4c
