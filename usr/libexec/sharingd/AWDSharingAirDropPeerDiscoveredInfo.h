...
- (void).cxx_destruct;	// IMP=0x000000010016fcfc
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000010016f860
- (unsigned long long)hash;	// IMP=0x000000010016f5dc
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010016f22c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010016eed0
- (void)copyTo:(id)arg1;	// IMP=0x000000010016ebc8
- (void)writeTo:(id)arg1;	// IMP=0x000000010016e90c
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000010016e904
- (id)dictionaryRepresentation;	// IMP=0x000000010016d808
- (id)description;	// IMP=0x000000010016d754
