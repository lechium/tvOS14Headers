...
- (void).cxx_destruct;	// IMP=0x00000001001219e4
...
- (unsigned long long)hash;	// IMP=0x00000001001217e8
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100121710
- (id)description;	// IMP=0x000000010012160c
- (void)dealloc;	// IMP=0x0000000100121554
- (id)initWithDictRepresentation:(id)arg1;	// IMP=0x0000000100121360
