...
- (void).cxx_destruct;	// IMP=0x0000000100045c00
...
- (void)logAutoUnlockEnd;	// IMP=0x0000000100045760
- (void)logAutoUnlockStart;	// IMP=0x0000000100045610
- (void)invalidateAssertionTimer;	// IMP=0x0000000100045538
- (void)restartAssertionTimer;	// IMP=0x0000000100045320
- (void)releaseIdleSleepAssertion;	// IMP=0x0000000100045278
- (void)declareSystemActivityAssertion;	// IMP=0x0000000100045014
- (void)sendConfirmationACK;	// IMP=0x0000000100044ddc
- (void)sendSessionAuthToken:(id)arg1 error:(id)arg2;	// IMP=0x000000010004493c
- (void)sendKeyExchangeRequestWithData:(id)arg1 error:(id)arg2;	// IMP=0x00000001000445f0
- (void)sendAuthPromptResponseWithData:(id)arg1 error:(id)arg2;	// IMP=0x00000001000442cc
- (void)sendAWDLInfoWithKeyData:(id)arg1 error:(id)arg2;	// IMP=0x0000000100043c80
- (void)handleUnlockConfirmation:(id)arg1;	// IMP=0x000000010004385c
- (void)createAuthTokenIfReady;	// IMP=0x0000000100043114
- (void)handleSessionKeyExchangeResponse:(id)arg1;	// IMP=0x0000000100042eb4
- (void)handleAuthPromptImageData:(id)arg1;	// IMP=0x0000000100042bf0
- (void)handleAuthPromptRequest:(id)arg1;	// IMP=0x000000010004276c
- (_Bool)handleAWDLInfo:(id)arg1;	// IMP=0x00000001000423a8
- (void)handleMessageWithWrapper:(id)arg1;	// IMP=0x0000000100041d18
- (void)handleWiFiRequestInvalidated;	// IMP=0x0000000100041cd0
- (void)handleWiFiRequestStartedWithStartAWDLHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000100041c9c
- (void)awdlNetworkStarted;	// IMP=0x0000000100041ad0
- (void)createWiFiRequest;	// IMP=0x00000001000414c4
- (void)alertOfUnlock;	// IMP=0x00000001000413b0
- (void)promptForApproval;	// IMP=0x00000001000413ac
- (void)deviceDisconnected:(id)arg1;	// IMP=0x0000000100041134
- (void)removeObservers;	// IMP=0x00000001000410e4
- (void)addObservers;	// IMP=0x000000010004107c
- (void)beginAKSSession;	// IMP=0x0000000100041078
- (void)notifyDelegateWithError:(id)arg1;	// IMP=0x0000000100040ea4
- (_Bool)keyCanUnlock;	// IMP=0x0000000100040e9c
- (void)_invalidate;	// IMP=0x0000000100040c68
- (void)invalidate;	// IMP=0x0000000100040be4
- (id)initWithBLEDevice:(id)arg1 sessionID:(id)arg2;	// IMP=0x000000010004091c
