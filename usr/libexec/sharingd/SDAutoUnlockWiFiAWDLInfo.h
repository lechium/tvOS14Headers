...
- (void).cxx_destruct;	// IMP=0x0000000100057154
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000100056fb8
- (unsigned long long)hash;	// IMP=0x0000000100056ecc
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100056d4c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000100056bf4
- (void)copyTo:(id)arg1;	// IMP=0x0000000100056ae0
- (void)writeTo:(id)arg1;	// IMP=0x00000001000569dc
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000001000569d4
- (id)dictionaryRepresentation;	// IMP=0x0000000100056360
- (id)description;	// IMP=0x00000001000562ac
