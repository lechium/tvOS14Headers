...
- (void).cxx_destruct;	// IMP=0x000000010015b1a4
...
- (void)companionStreamClosedStreams:(id)arg1;	// IMP=0x000000010015b124
- (void)manager:(id)arg1 connectedToService:(id)arg2 withFileHandle:(id)arg3 acceptHandler:(CDUnknownBlockType)arg4;	// IMP=0x000000010015af04
- (void)disableService:(id)arg1;	// IMP=0x000000010015ae7c
- (void)enableService:(id)arg1;	// IMP=0x000000010015adf8
- (id)streamHandlerForService:(id)arg1;	// IMP=0x000000010015ad94
- (void)stop;	// IMP=0x000000010015aba8
- (void)start;	// IMP=0x000000010015ab58
- (id)initWithClientProxy:(id)arg1 withIdentifier:(id)arg2;	// IMP=0x000000010015aa50
