...
- (void).cxx_destruct;	// IMP=0x000000010004c14c
...
- (void)updateWithRawAdvertisementData:(id)arg1 receivedViaScanning:(_Bool)arg2 isReplay:(_Bool)arg3 newAdvertisementHandler:(CDUnknownBlockType)arg4;	// IMP=0x000000010004b234
- (void)updateWithRawAdvertisementData:(id)arg1 receivedViaScanning:(_Bool)arg2 newAdvertisementHandler:(CDUnknownBlockType)arg3;	// IMP=0x000000010004b1d8
- (id)description;	// IMP=0x000000010004b0e8
- (id)initWithDevice:(id)arg1;	// IMP=0x000000010004b04c
