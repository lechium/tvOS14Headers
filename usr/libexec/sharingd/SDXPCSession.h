...
+ (id)sharedSession;	// IMP=0x00000001000cd978
...
- (void)connectionManagerDidInvalidate:(id)arg1;	// IMP=0x00000001000cdc0c
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x00000001000cdb6c
- (void)stop;	// IMP=0x00000001000cdb14
- (void)start;	// IMP=0x00000001000cda54
- (id)init;	// IMP=0x00000001000cd9e4
