...
- (void).cxx_destruct;	// IMP=0x00000001001d16b8
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000001001d1468
- (unsigned long long)hash;	// IMP=0x00000001001d1314
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001001d10f0
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001001d0f28
- (void)copyTo:(id)arg1;	// IMP=0x00000001001d0da4
- (void)writeTo:(id)arg1;	// IMP=0x00000001001d0c44
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000001001d0c3c
- (id)dictionaryRepresentation;	// IMP=0x00000001001d0370
- (id)description;	// IMP=0x00000001001d02bc
