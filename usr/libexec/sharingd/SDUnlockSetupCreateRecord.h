...
- (void).cxx_destruct;	// IMP=0x00000001000c89d8
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000001000c8874
- (unsigned long long)hash;	// IMP=0x00000001000c87a8
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001000c864c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001000c851c
- (void)copyTo:(id)arg1;	// IMP=0x00000001000c8430
- (void)writeTo:(id)arg1;	// IMP=0x00000001000c8350
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000001000c8348
- (id)dictionaryRepresentation;	// IMP=0x00000001000c7dc8
- (id)description;	// IMP=0x00000001000c7d14
