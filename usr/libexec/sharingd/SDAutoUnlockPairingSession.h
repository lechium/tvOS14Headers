...
- (void).cxx_destruct;	// IMP=0x000000010003aea0
...
- (void)handleTimerFired;	// IMP=0x000000010003acc0
- (void)invalidateResponseTimer;	// IMP=0x000000010003abe8
- (void)restartResponseTimer:(unsigned long long)arg1;	// IMP=0x000000010003a9ec
- (id)dataFromUUID:(id)arg1;	// IMP=0x000000010003a96c
- (id)wrapPayload:(id)arg1 withType:(unsigned short)arg2 useProxy:(_Bool)arg3 senderID:(id)arg4;	// IMP=0x000000010003a79c
- (id)wrapPayload:(id)arg1 withType:(unsigned short)arg2;	// IMP=0x000000010003a788
- (void)notifyDelegateWithError:(id)arg1;	// IMP=0x000000010003a784
- (void)start;	// IMP=0x000000010003a780
- (void)invalidate;	// IMP=0x000000010003a5fc
- (id)initWithDevice:(id)arg1 sessionID:(id)arg2;	// IMP=0x000000010003a500
- (id)init;	// IMP=0x000000010003a498
