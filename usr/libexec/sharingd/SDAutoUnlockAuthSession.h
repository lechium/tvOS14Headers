...
- (void).cxx_destruct;	// IMP=0x000000010015f25c
...
- (id)peerListFromAWDLInfo:(id)arg1;	// IMP=0x000000010015e8f0
- (void)sendData:(id)arg1 bleDevice:(id)arg2 direct:(_Bool)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x000000010015e400
- (void)sendData:(id)arg1 bleDevice:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x000000010015e390
- (void)sendAWDLInfo:(_Bool)arg1;	// IMP=0x000000010015dc60
- (void)sendAWDLInfo;	// IMP=0x000000010015dc50
- (void)sendData:(id)arg1 type:(unsigned short)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x000000010015db88
- (void)sendData:(id)arg1 type:(unsigned short)arg2 errorHandler:(CDUnknownBlockType)arg3;	// IMP=0x000000010015da6c
- (void)sendAWDLInfoData:(id)arg1 type:(unsigned short)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x000000010015da14
- (void)_start;	// IMP=0x000000010015da08
- (void)start;	// IMP=0x000000010015d97c
- (id)getAppName;	// IMP=0x000000010015d974
- (void)handleMessageWithWrapper:(id)arg1;	// IMP=0x000000010015d970
- (void)connectionActivated;	// IMP=0x000000010015d96c
- (void)invalidate;	// IMP=0x000000010015d85c
- (id)initWithDevice:(id)arg1 sessionID:(id)arg2 bleDevice:(id)arg3;	// IMP=0x000000010015d794
