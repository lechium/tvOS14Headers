...
- (void).cxx_destruct;	// IMP=0x0000000100087124
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000100086e28
- (unsigned long long)hash;	// IMP=0x0000000100086c78
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001000869f0
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001000867ac
- (void)copyTo:(id)arg1;	// IMP=0x00000001000865ac
- (void)writeTo:(id)arg1;	// IMP=0x00000001000863dc
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000001000863d4
- (id)dictionaryRepresentation;	// IMP=0x0000000100085838
- (id)description;	// IMP=0x0000000100085784
