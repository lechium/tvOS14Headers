...
- (void).cxx_destruct;	// IMP=0x0000000100160e00
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000100160b78
- (unsigned long long)hash;	// IMP=0x0000000100160a08
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001001607d0
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001001605e0
- (void)copyTo:(id)arg1;	// IMP=0x0000000100160434
- (void)writeTo:(id)arg1;	// IMP=0x00000001001602b0
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000001001602a8
- (id)dictionaryRepresentation;	// IMP=0x000000010015f904
- (id)description;	// IMP=0x000000010015f850
