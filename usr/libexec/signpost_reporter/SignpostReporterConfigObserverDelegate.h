...
- (void).cxx_destruct;	// IMP=0x000000010000684c
@property(copy, nonatomic) CDUnknownBlockType callbackBlock; // @synthesize callbackBlock=_callbackBlock;
- (void)observer:(id)arg1 didChangeConfiguration:(id)arg2 type:(id)arg3;	// IMP=0x00000001000067b4
- (id)initWithCallbackBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000100006740
