...
- (void).cxx_destruct;	// IMP=0x0000000100004610
...
- (void)setCap:(unsigned long long)arg1 downsampleRatio:(unsigned long long)arg2 forQuery:(id)arg3;	// IMP=0x0000000100004480
- (id)newChildInstance;	// IMP=0x0000000100004458
- (id)keyForChildren:(id)arg1;	// IMP=0x0000000100004428
- (id)entryForQuery:(id)arg1;	// IMP=0x000000010000432c
