...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000010002a544
- (void).cxx_destruct;	// IMP=0x000000010002a570
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000010002a46c
- (id)initWithCoder:(id)arg1;	// IMP=0x000000010002a378
