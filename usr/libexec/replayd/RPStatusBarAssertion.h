...
- (void).cxx_destruct;	// IMP=0x0000000100016184
...
- (void)statusBarCoordinator:(id)arg1 invalidatedRegistrationWithError:(id)arg2;	// IMP=0x000000010001600c
- (void)updateStatusStringWithTimer:(id)arg1;	// IMP=0x0000000100016008
- (void)updateDoubleHeightStatusBarWithDuration:(double)arg1 paused:(_Bool)arg2;	// IMP=0x0000000100016004
- (id)rpLocalizedRecordingDuration:(double)arg1 paused:(_Bool)arg2;	// IMP=0x0000000100015f00
- (id)stringWithTimeInterval:(double)arg1;	// IMP=0x0000000100015e14
- (void)invalidateDoubleHeightStatusBar;	// IMP=0x0000000100015e10
- (void)startRepeatingTimer;	// IMP=0x0000000100015d14
- (void)showDoubleHeightStatusBarWithPid:(int)arg1;	// IMP=0x0000000100015d10
- (void)acquireAssertionWithPid:(int)arg1;	// IMP=0x0000000100015cb4
- (void)acquireAssertionWithPidWaitForCompletion:(int)arg1;	// IMP=0x0000000100015cb0
