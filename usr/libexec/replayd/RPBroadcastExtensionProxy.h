...
- (void).cxx_destruct;	// IMP=0x000000010000cf4c
...
- (void)processPayload:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000010000cc6c
- (void)finishBroadcastWithError:(id)arg1;	// IMP=0x000000010000cb70
- (void)ping;	// IMP=0x000000010000ca94
- (void)updateBroadcastURL:(id)arg1;	// IMP=0x000000010000c9a4
- (void)updateServiceInfo:(id)arg1;	// IMP=0x000000010000c8b4
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x000000010000c890
- (void)setupNewConnection:(id)arg1;	// IMP=0x000000010000c58c
- (void)invalidateConnection;	// IMP=0x000000010000c3f8
- (void)establishConnectionWithHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000010000befc
- (id)initWithBroadcastUploadListenerEndpoint:(id)arg1;	// IMP=0x000000010000bda0
- (id)initWithBroadcastUploadExtension:(id)arg1;	// IMP=0x000000010000bbdc
