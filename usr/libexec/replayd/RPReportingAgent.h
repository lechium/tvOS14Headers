...
+ (void)reportSessionEnded:(unsigned short)arg1 endReason:(id)arg2 withServiceName:(id)arg3 clientBundleId:(id)arg4;	// IMP=0x00000001000196ac
- (void).cxx_destruct;	// IMP=0x0000000100019b34
...
- (void)reportEventWithType:(unsigned short)arg1 dictionary:(id)arg2 clientBundleId:(id)arg3;	// IMP=0x00000001000193a8
- (id)collectSummaryEventMetrics;	// IMP=0x0000000100018f90
- (id)initWithServiceName:(id)arg1;	// IMP=0x0000000100018e6c
