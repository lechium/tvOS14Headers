...
- (void).cxx_destruct;	// IMP=0x00000001000057d0
...
- (void)handleReplyName:(id)arg1 type:(id)arg2 domain:(id)arg3 ifIndex:(unsigned int)arg4 add:(_Bool)arg5;	// IMP=0x0000000100005504
- (void)dealloc;	// IMP=0x0000000100005480
- (void)stop;	// IMP=0x0000000100005320
- (_Bool)start;	// IMP=0x0000000100005188
- (id)initWithSrcIfIndex:(unsigned int)arg1 dstIfIndex:(unsigned int)arg2 bonjourType:(id)arg3;	// IMP=0x000000010000508c
