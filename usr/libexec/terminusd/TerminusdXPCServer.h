...
+ (id)copySharedServer;	// IMP=0x000000010002f130
- (void).cxx_destruct;	// IMP=0x00000001000290dc
...
- (void)handleRequest:(id)arg1 onConnection:(id)arg2;	// IMP=0x0000000100028d74
- (void)startXPCListener;	// IMP=0x0000000100028a3c
- (void)registerHandlerFunctions;	// IMP=0x0000000100027560
- (void)registerHandlerFunction:(CDUnknownFunctionPointerType)arg1 type:(unsigned long long)arg2 allowedEntitlementGroup:(id)arg3;	// IMP=0x0000000100027128
- (id)initInternal;	// IMP=0x0000000100026d60
