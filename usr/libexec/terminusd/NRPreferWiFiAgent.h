...
+ (id)agentFromData:(id)arg1;	// IMP=0x00000001000324d0
+ (id)agentType;	// IMP=0x000000010003248c
+ (id)agentDomain;	// IMP=0x0000000100032448
- (void).cxx_destruct;	// IMP=0x0000000100031d80
...
- (void)unassertAgentWithOptions:(id)arg1;	// IMP=0x0000000100031bf0
- (_Bool)assertAgentWithOptions:(id)arg1;	// IMP=0x0000000100031b4c
- (_Bool)startAgentWithOptions:(id)arg1;	// IMP=0x0000000100031aac
- (_Bool)unregisterAgent;	// IMP=0x00000001000318f0
- (void)activateAgent;	// IMP=0x0000000100031820
- (_Bool)registerAgentOnQueue:(id)arg1;	// IMP=0x00000001000316fc
- (id)copyAgentData;	// IMP=0x00000001000316f4
- (id)description;	// IMP=0x000000010003160c
- (void)dealloc;	// IMP=0x0000000100031558
- (id)init;	// IMP=0x00000001000312b0
