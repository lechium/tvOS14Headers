...
- (void).cxx_destruct;	// IMP=0x00000001000064b8
...
- (void)dealloc;	// IMP=0x0000000100006390
- (void)stop;	// IMP=0x000000010000630c
- (_Bool)start;	// IMP=0x00000001000060b8
- (id)initWithSrcIfIndex:(unsigned int)arg1 dstIfIndex:(unsigned int)arg2 name:(id)arg3 type:(id)arg4 domain:(id)arg5 hostTarget:(id)arg6 port:(unsigned short)arg7 txtRecord:(id)arg8;	// IMP=0x0000000100005f10
