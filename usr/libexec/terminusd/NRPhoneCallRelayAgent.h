...
+ (id)agentFromData:(id)arg1;	// IMP=0x00000001000bf0e8
+ (id)agentDomain;	// IMP=0x00000001000bf0a4
+ (id)agentType;	// IMP=0x00000001000bf060
- (void).cxx_destruct;	// IMP=0x00000001000bed50
...
- (void)unassertAgentWithOptions:(id)arg1;	// IMP=0x00000001000bebcc
- (_Bool)assertAgentWithOptions:(id)arg1;	// IMP=0x00000001000beb4c
- (_Bool)registerAgent;	// IMP=0x00000001000be770
- (_Bool)unregisterAgent;	// IMP=0x00000001000be5d8
@property(nonatomic) _Bool requiresAssert;
- (id)copyAgentData;	// IMP=0x00000001000be5c8
- (void)dealloc;	// IMP=0x00000001000be57c
- (id)initWithQueue:(id)arg1 delegate:(id)arg2;	// IMP=0x00000001000be2ac
