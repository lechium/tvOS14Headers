...
- (void).cxx_destruct;	// IMP=0x000000010004e250
...
- (void)attemptPairingUsingOutOfBandKey:(id)arg1 completionBlock:(CDUnknownBlockType)arg2;	// IMP=0x000000010004c558
- (void)setPacketReceiver:(id)arg1;	// IMP=0x000000010004c2f0
- (_Bool)sendPacketData:(id)arg1;	// IMP=0x000000010004c1a8
- (void)requestConfigurationForListener:(id)arg1 session:(id)arg2 sessionConfig:(id)arg3 childConfig:(id)arg4 validateAuthBlock:(CDUnknownBlockType)arg5 responseBlock:(CDUnknownBlockType)arg6;	// IMP=0x000000010004b2ac
- (id)respondToIKESession:(id)arg1 dataProtectionClass:(unsigned char)arg2 validateAuthBlock:(CDUnknownBlockType)arg3;	// IMP=0x000000010004ae84
- (void)listener:(id)arg1 receivedNewSession:(id)arg2;	// IMP=0x000000010004ad88
- (_Bool)setupIPsec;	// IMP=0x000000010004ab5c
- (void)restartIKESessionForDataProtectionClass:(unsigned char)arg1;	// IMP=0x000000010004a994
- (void)scheduleIKESessionClassADueToConnectFailure;	// IMP=0x000000010004a770
- (void)restartIKESessionClassA;	// IMP=0x000000010004a760
- (void)restartIKESessionClassC;	// IMP=0x000000010004a750
- (void)restartIKESessionClassD;	// IMP=0x000000010004a740
- (void)setupIPsecInitiatorIfNecessary:(unsigned char)arg1;	// IMP=0x000000010004a094
- (void)setupIPsecForPairingInitiatorIfNecessary;	// IMP=0x0000000100049dcc
- (void)setupIKECallbacksPairing;	// IMP=0x0000000100049968
- (void)sendlocalPublicClassAKeysEncryptedWithIDS;	// IMP=0x000000010004971c
- (void)sendlocalPublicClassCKeysEncryptedWithIDS;	// IMP=0x00000001000494d0
- (void)setupIKECallbacksClassA;	// IMP=0x00000001000494c0
- (void)setupIKECallbacksClassC;	// IMP=0x00000001000494b0
- (void)setupIKECallbacksClassD;	// IMP=0x00000001000494a0
- (void)setupIKECallbacks:(unsigned char)arg1;	// IMP=0x0000000100048eec
- (void)reportRegistrationFailureIfNeededWithFailureCode:(long long)arg1 errorDescription:(id)arg2;	// IMP=0x0000000100048ed0
- (void)handleNotifyCode:(unsigned short)arg1 payload:(id)arg2;	// IMP=0x00000001000474e8
- (void)sendNotifyPayload;	// IMP=0x00000001000474e4
- (_Bool)sendAlwaysOnWiFiUpdate;	// IMP=0x00000001000472d4
- (id)copyNotifyPayloadsToSendWithProxy:(_Bool)arg1;	// IMP=0x0000000100046b44
- (_Bool)sendControlData:(id)arg1;	// IMP=0x00000001000468f4
- (_Bool)handleIncomingIKEData:(id)arg1;	// IMP=0x00000001000466a4
- (_Bool)sendIKEData:(id)arg1;	// IMP=0x0000000100046398
- (void)handleRequestToActivateNexus:(id)arg1 fromFlow:(id)arg2;	// IMP=0x0000000100046394
- (void)acceptNewFlow:(id)arg1 fromNexus:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000100046304
- (_Bool)appendEncapsulatedData:(id)arg1 type:(unsigned char)arg2;	// IMP=0x0000000100045f90
- (void)appendlinkOutgoingData:(id)arg1;	// IMP=0x0000000100045f20
- (_Bool)sendData;	// IMP=0x0000000100045f10
- (_Bool)sendDataWithCount:(unsigned int)arg1;	// IMP=0x0000000100045cc8
- (void)stopReadingPackets;	// IMP=0x0000000100045cb8
- (void)stopReadingPacketsWithCount:(unsigned int)arg1;	// IMP=0x0000000100045b2c
- (void)resumeReadingPackets;	// IMP=0x0000000100045b1c
- (void)resumeReadingPacketsWithCount:(unsigned int)arg1;	// IMP=0x0000000100045984
- (unsigned long long)writeBytesToChannel:(const char *)arg1 length:(unsigned long long)arg2;	// IMP=0x000000010004573c
- (void)readDataFromChannelWithIsUrgent:(_Bool)arg1;	// IMP=0x00000001000454d0
- (void)readIncomingData:(char *)arg1 length:(unsigned long long)arg2 isUrgentLink:(_Bool)arg3;	// IMP=0x0000000100045234
- (void)handleIncoming6LoWPANData:(const char *)arg1 tlvBufferLength:(unsigned short)arg2 length:(unsigned short)arg3 tlvType:(unsigned char)arg4;	// IMP=0x0000000100044ee8
- (void)handPacketToNexus:(id)arg1;	// IMP=0x0000000100044edc
- (void)writePacketToNexusChannel:(id)arg1;	// IMP=0x0000000100044de0
- (void)handleReadData:(_Bool)arg1;	// IMP=0x00000001000429a4
- (void)flushPipeWithReason:(id)arg1;	// IMP=0x0000000100042910
- (void)cleanupLinkReadBufferWithExtra:(unsigned int)arg1;	// IMP=0x000000010004278c
- (void)armLinkStatsTimer;	// IMP=0x000000010004266c
- (_Bool)setupNexus;	// IMP=0x00000001000420b8
- (void)checkProxyAgentWithForceUpdate:(_Bool)arg1;	// IMP=0x0000000100041fec
- (void)addVirtualInterfaceRoutes;	// IMP=0x0000000100041e38
- (void)handlePongSequenceNumber:(unsigned long long)arg1 receiveTime:(unsigned long long)arg2;	// IMP=0x0000000100041aa0
- (void)measureLatencyWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0000000100041678
- (void)updateDatagramPipe:(id)arg1;	// IMP=0x0000000100040c00
- (void)updateUrgentPipe:(id)arg1;	// IMP=0x0000000100040230
- (void)cleanupUrgentPipeState;	// IMP=0x000000010003ff0c
- (_Bool)setQosMarkingEnabled;	// IMP=0x000000010003fc3c
- (_Bool)setMPKLLoggingWithEnabled:(_Bool)arg1;	// IMP=0x000000010003f9f4
- (_Bool)setupNexusChannelVoice:(id)arg1;	// IMP=0x000000010003f3a4
- (_Bool)setupNexusChannelBestEffort:(id)arg1;	// IMP=0x000000010003ed54
- (_Bool)setupNexusChannelBackground:(id)arg1;	// IMP=0x000000010003e704
- (_Bool)setupNexusChannelVideo:(id)arg1;	// IMP=0x000000010003e0b4
- (_Bool)validateChannelAttributes:(struct channel_attr *)arg1;	// IMP=0x000000010003d4d8
- (_Bool)setupNexusChannel;	// IMP=0x000000010003d260
- (void)pipeDidDisconnect;	// IMP=0x000000010003d24c
- (_Bool)resume;	// IMP=0x000000010003d150
- (_Bool)suspend;	// IMP=0x000000010003cfe4
- (_Bool)cancelBecausePipeDisconnected;	// IMP=0x000000010003ce74
- (_Bool)cancelWithReason:(id)arg1;	// IMP=0x000000010003c924
- (unsigned short)metric;	// IMP=0x000000010003c91c
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x000000010003c744
- (void)refreshCompanionProxyAgent;	// IMP=0x000000010003c6bc
- (void)dealloc;	// IMP=0x000000010003c620
- (void)invalidateLink;	// IMP=0x000000010003c20c
- (void)invalidateNexusChannels;	// IMP=0x000000010003bbc8
- (void)invalidateIKESessionClassA;	// IMP=0x000000010003bbb8
- (void)invalidateIKESessionClassC;	// IMP=0x000000010003bba8
- (void)invalidateIKESessionClassD;	// IMP=0x000000010003bb98
- (id *)ikeSessionPointerForDataProtectionClass:(unsigned char)arg1;	// IMP=0x000000010003ba44
- (void)invalidateIKESessionForClass:(unsigned char)arg1;	// IMP=0x000000010003b9d8
- (_Bool)start;	// IMP=0x0000000100039e78
- (id)copyShortDescriptionInner;	// IMP=0x0000000100039d88
- (id)copyDescriptionInner;	// IMP=0x0000000100039c04
- (id)initLinkWithQueue:(id)arg1 linkDelegate:(id)arg2 nrUUID:(id)arg3 pipe:(id)arg4 remoteDeviceName:(id)arg5;	// IMP=0x0000000100039690
@property(readonly, nonatomic) _Bool hasValidPipe;
- (id)copyStatusString;	// IMP=0x00000001000382a8
