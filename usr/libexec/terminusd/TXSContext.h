...
- (void).cxx_destruct;	// IMP=0x0000000100026ba0
...
- (id)copyClientDescription;	// IMP=0x0000000100026a48
- (id)initWithRequest:(id)arg1 onConnection:(id)arg2;	// IMP=0x000000010002679c
