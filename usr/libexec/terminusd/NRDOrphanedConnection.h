...
- (void).cxx_destruct;	// IMP=0x00000001000680a0
@property(retain, nonatomic) NSObject<OS_xpc_object> *connection; // @synthesize connection=_connection;
@property(retain, nonatomic) NSUUID *nrUUID; // @synthesize nrUUID=_nrUUID;
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100067f48
- (unsigned long long)hash;	// IMP=0x0000000100067ed0
- (id)description;	// IMP=0x0000000100067e28
