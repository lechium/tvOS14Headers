...
- (void).cxx_destruct;	// IMP=0x0000000100071e9c
...
- (void)addToProhibited:(id)arg1;	// IMP=0x0000000100071c18
- (_Bool)handlePathUpdate:(id)arg1;	// IMP=0x0000000100071934
- (id)initWithInstance:(id)arg1 interface:(unsigned int)arg2;	// IMP=0x0000000100070f78
- (_Bool)setupLocalAddress;	// IMP=0x0000000100070f68
- (_Bool)setupLocalAddressCheckAgainst:(const struct in6_addr *)arg1;	// IMP=0x00000001000708cc
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100070850
- (id)description;	// IMP=0x00000001000707c4
- (void)readPackets;	// IMP=0x000000010006fc54
- (void)dealloc;	// IMP=0x000000010006fbd8
- (void)sendPacket:(struct iovec *)arg1 iovLen:(unsigned int)arg2 toAddr:(const struct in6_addr *)arg3;	// IMP=0x000000010006f9b0
