...
+ (id)agentFromData:(id)arg1;	// IMP=0x0000000100038260
+ (id)agentDomain;	// IMP=0x000000010003821c
+ (id)agentType;	// IMP=0x00000001000381d8
- (void).cxx_destruct;	// IMP=0x000000010003810c
...
- (void)unassertAgentWithOptions:(id)arg1;	// IMP=0x0000000100037fd0
- (_Bool)assertAgentWithOptions:(id)arg1;	// IMP=0x0000000100037f88
- (_Bool)registerAgentWithActivate:(_Bool)arg1;	// IMP=0x00000001000379e4
- (void)activateAgent;	// IMP=0x00000001000378bc
- (void)suspendAgent;	// IMP=0x0000000100037794
- (_Bool)unregisterAgent;	// IMP=0x00000001000375a0
- (id)copyAgentData;	// IMP=0x0000000100037598
- (id)description;	// IMP=0x0000000100037420
- (void)dealloc;	// IMP=0x000000010003737c
- (id)initWithNRUUID:(id)arg1 queue:(id)arg2;	// IMP=0x0000000100036ea0
