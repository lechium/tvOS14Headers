...
- (void).cxx_destruct;	// IMP=0x000000010002fef4
...
- (void)sendTokenOnConnection:(id)arg1 connection:(id)arg2;	// IMP=0x000000010002fc10
- (void)pushDownloadOnConnection:(id)arg1;	// IMP=0x000000010002fbfc
- (void)setReadHandlerOnConnection:(id)arg1 forService:(id)arg2;	// IMP=0x000000010002fb34
- (void)handleNewConnection:(id)arg1 forPeerEndpoint:(id)arg2 forService:(id)arg3 forServiceConnector:(id)arg4;	// IMP=0x000000010002f8e4
- (void)setupTestServer;	// IMP=0x000000010002f800
- (id)createServiceConnector:(_Bool)arg1;	// IMP=0x000000010002f700
- (void)cancel;	// IMP=0x000000010002f6ac
- (id)copyStatusString;	// IMP=0x000000010002f588
- (void)start;	// IMP=0x000000010002f4f8
- (void)dealloc;	// IMP=0x000000010002f3c0
- (id)initTestServerWithQueue:(id)arg1;	// IMP=0x000000010002f1a8
