...
+ (id)agentFromData:(id)arg1;	// IMP=0x0000000100011f10
+ (id)agentDomain;	// IMP=0x0000000100011ecc
+ (id)agentType;	// IMP=0x0000000100011e88
- (void).cxx_destruct;	// IMP=0x0000000100011b18
...
- (void)unassertAgentWithOptions:(id)arg1;	// IMP=0x000000010001195c
- (_Bool)assertAgentWithOptions:(id)arg1;	// IMP=0x00000001000118dc
- (_Bool)registerAgent;	// IMP=0x0000000100011464
- (void)activateAgent;	// IMP=0x00000001000112c8
- (void)suspendAgent;	// IMP=0x0000000100011140
- (_Bool)unregisterAgent;	// IMP=0x0000000100010f4c
- (void)updateQRConnectedState:(_Bool)arg1;	// IMP=0x0000000100010edc
- (id)copyAgentData;	// IMP=0x0000000100010e68
- (id)description;	// IMP=0x0000000100010cc8
- (void)dealloc;	// IMP=0x0000000100010c24
- (id)initWithNRUUID:(id)arg1 queue:(id)arg2 delegate:(id)arg3;	// IMP=0x00000001000106f0
