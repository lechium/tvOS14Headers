...
+ (id)agentFromData:(id)arg1;	// IMP=0x0000000100036c2c
+ (id)agentDomain;	// IMP=0x0000000100036bfc
+ (id)agentType;	// IMP=0x0000000100036bb8
...
- (void)unassertAgentWithOptions:(id)arg1;	// IMP=0x00000001000367bc
- (_Bool)assertAgentWithOptions:(id)arg1;	// IMP=0x000000010003673c
- (_Bool)registerAgent;	// IMP=0x000000010003631c
- (_Bool)unregisterAgent;	// IMP=0x0000000100036184
@property(nonatomic) _Bool requiresAssert;
- (id)copyAgentData;	// IMP=0x0000000100036174
- (void)dealloc;	// IMP=0x0000000100036128
- (id)initWithNRUUID:(id)arg1 queue:(id)arg2 delegate:(id)arg3;	// IMP=0x0000000100035e38
