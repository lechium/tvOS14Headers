...
- (void).cxx_destruct;	// IMP=0x00000001000772c8
...
- (_Bool)cancelIfMatchesPrefix:(id)arg1 routerID:(unsigned long long)arg2 seqno:(unsigned short)arg3;	// IMP=0x0000000100077138
- (_Bool)cancelIfRouteUnselected;	// IMP=0x000000010007705c
- (void)dealloc;	// IMP=0x0000000100076fdc
- (void)cancelWithDelay:(_Bool)arg1;	// IMP=0x0000000100076ea8
- (void)cancelTimer;	// IMP=0x0000000100076e6c
- (void)start;	// IMP=0x0000000100076de0
- (id)description;	// IMP=0x0000000100076cd8
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100076c08
- (_Bool)matchesPrefix:(id)arg1 routerID:(unsigned long long)arg2;	// IMP=0x0000000100076be4
- (id)initWithInstance:(id)arg1 prefix:(id)arg2 routerID:(unsigned long long)arg3;	// IMP=0x0000000100076998
- (void)sendSeqnoReq;	// IMP=0x00000001000768a0
- (id)createTLV;	// IMP=0x00000001000767f0
