...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001000393b4
- (unsigned long long)hash;	// IMP=0x00000001000393a4
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010003933c
- (_Bool)isEqualToLogItemRequestInternal:(id)arg1;	// IMP=0x0000000100039300
- (id)description;	// IMP=0x00000001000390c0
- (void)dealloc;	// IMP=0x0000000100039050
