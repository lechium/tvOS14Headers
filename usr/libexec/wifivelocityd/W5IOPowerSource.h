...
- (int)batteryWarningLevel;	// IMP=0x0000000100019940
- (long long)powerSourceType;	// IMP=0x0000000100019808
- (double)estimatedTimeRemaining;	// IMP=0x0000000100019744
- (double)internalBatteryLevel;	// IMP=0x00000001000195e4
- (void)stopEventMonitoring;	// IMP=0x0000000100019534
- (void)startEventMonitoring;	// IMP=0x0000000100018f48
- (void)dealloc;	// IMP=0x0000000100018eec
- (id)init;	// IMP=0x0000000100018cb4
