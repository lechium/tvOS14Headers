...
- (unsigned int)caps;	// IMP=0x0000000100061c18
- (void)stopEventMonitoring;	// IMP=0x0000000100061b74
- (void)startEventMonitoring;	// IMP=0x00000001000618dc
- (void)dealloc;	// IMP=0x0000000100061888
- (id)init;	// IMP=0x000000010006172c
