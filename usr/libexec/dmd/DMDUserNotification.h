...
- (void).cxx_destruct;	// IMP=0x000000010006c090
...
- (void)setNotificationRef:(struct __CFUserNotification *)arg1;	// IMP=0x000000010006bfb4
- (struct __CFUserNotification *)notificationRef;	// IMP=0x000000010006bfac
- (void)dealloc;	// IMP=0x000000010006bf60
- (id)init;	// IMP=0x000000010006bef0
