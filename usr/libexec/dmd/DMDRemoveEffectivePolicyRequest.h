...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000001000605ec
- (void).cxx_destruct;	// IMP=0x000000010006087c
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000100060760
- (id)initWithCoder:(id)arg1;	// IMP=0x00000001000605f4
