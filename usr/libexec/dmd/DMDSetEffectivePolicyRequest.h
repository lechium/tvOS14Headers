...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000100064304
- (void).cxx_destruct;	// IMP=0x00000001000648cc
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000010006460c
- (id)initWithCoder:(id)arg1;	// IMP=0x000000010006430c
