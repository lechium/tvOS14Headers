...
- (void).cxx_destruct;	// IMP=0x000000010003153c
...
- (void)resolveAssetWithContext:(id)arg1;	// IMP=0x00000001000313a0
- (void)configurationSourceController:(id)arg1 fetchEventsWithCompletionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000100031274
- (void)configurationSourceController:(id)arg1 fetchStatusUpdatesWithCompletionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000100031148
- (void)unregisterConfigurationSource:(id)arg1;	// IMP=0x00000001000310b4
- (id)registerConfigurationSource:(id)arg1;	// IMP=0x0000000100030ed0
- (id)configurationSourceWithIdentifier:(id)arg1;	// IMP=0x0000000100030df0
...
- (void)updateWithOrganization:(id)arg1;	// IMP=0x0000000100030404
- (id)initWithOrganization:(id)arg1 delegate:(id)arg2;	// IMP=0x0000000100030308
