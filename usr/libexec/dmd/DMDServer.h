...
+ (id)sharedServer;	// IMP=0x0000000100062d04
- (void).cxx_destruct;	// IMP=0x0000000100062fb4
...
- (void)invalidate;	// IMP=0x0000000100062e98
- (void)run;	// IMP=0x0000000100062d70
- (id)init;	// IMP=0x0000000100062a10
