...
- (void)networkDidChange;	// IMP=0x000000010003913c
- (void)keybagLockStateDidChange;	// IMP=0x00000001000390cc
- (void)stopObservingChanges;	// IMP=0x0000000100039080
- (void)startObservingChanges;	// IMP=0x0000000100038c94
@property(readonly, copy) NSString *description;
- (id)init;	// IMP=0x0000000100038b98
