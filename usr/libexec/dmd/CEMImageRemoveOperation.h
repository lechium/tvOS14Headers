...
- (void).cxx_destruct;	// IMP=0x000000010000899c
...
- (void)main;	// IMP=0x0000000100008814
- (id)initWithImageDeclaration:(id)arg1 installMetadata:(id)arg2;	// IMP=0x0000000100008760
