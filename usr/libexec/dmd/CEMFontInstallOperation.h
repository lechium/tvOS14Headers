...
- (void).cxx_destruct;	// IMP=0x0000000100007bb8
...
- (void)assetResolutionFailedWithError:(id)arg1;	// IMP=0x0000000100007b1c
- (void)assetResolutionDidSucceedWithAssetURL:(id)arg1;	// IMP=0x000000010000784c
...
- (void)main;	// IMP=0x0000000100007670
- (_Bool)isAsynchronous;	// IMP=0x0000000100007668
- (id)initWithFontDeclaration:(id)arg1 resolver:(id)arg2;	// IMP=0x00000001000075b4
