...
+ (id)sharedController;	// IMP=0x000000010006c0f0
...
- (void)_notificationRef:(struct __CFUserNotification *)arg1 wasDismissedWithFlags:(unsigned long long)arg2;	// IMP=0x000000010006cec8
- (void)_completeNotification:(id)arg1 response:(unsigned long long)arg2;	// IMP=0x000000010006cd00
- (void)_showNextNotification;	// IMP=0x000000010006c910
- (id)_dictFromNotification:(id)arg1;	// IMP=0x000000010006c6f8
- (void)showNotification:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000010006c25c
- (id)initPrivate;	// IMP=0x000000010006c198
