...
- (void).cxx_destruct;	// IMP=0x0000000100069e34
@property(readonly, nonatomic) CATTaskServer *taskServer; // @synthesize taskServer=_taskServer;
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x0000000100069d30
- (id)initWithTaskServer:(id)arg1;	// IMP=0x0000000100069cb8
