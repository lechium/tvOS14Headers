...
- (void).cxx_destruct;	// IMP=0x0000000100041890
...
- (id)processDeclarationPayloadsInContext:(id)arg1 forOrganization:(id)arg2 enqueuedOperations:(id)arg3 assetResolver:(id)arg4 error:(id *)arg5;	// IMP=0x000000010003ed50
- (id)processCommandPayloadsInContext:(id)arg1 forOrganization:(id)arg2 enqueuedOperations:(id)arg3 assetResolver:(id)arg4 error:(id *)arg5;	// IMP=0x000000010003da44
- (_Bool)updateActiveRestrictionsInContext:(id)arg1 error:(id *)arg2;	// IMP=0x000000010003d2cc
- (_Bool)preprocessDatabaseInContext:(id)arg1 forOrganization:(id)arg2 error:(id *)arg3;	// IMP=0x000000010003cbb8
- (void)performDatabaseModificationOperationWithManagedObjectContext:(id)arg1;	// IMP=0x000000010003c46c
