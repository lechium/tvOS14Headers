...
- (void).cxx_destruct;	// IMP=0x000000010004561c
...
- (void)startWithScheduleElapsedHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000100045418
- (unsigned long long)hash;	// IMP=0x00000001000452d0
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100045054
- (id)description;	// IMP=0x0000000100044f90
- (void)dealloc;	// IMP=0x0000000100044f40
- (id)initWithScheduleRegistration:(id)arg1;	// IMP=0x0000000100044c80
