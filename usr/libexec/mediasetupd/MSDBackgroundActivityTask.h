...
- (void).cxx_destruct;	// IMP=0x000000010002804c
...
- (void)schedule;	// IMP=0x0000000100027db8
- (void)invalidate;	// IMP=0x0000000100027d6c
- (void)checkIn;	// IMP=0x0000000100027c40
- (id)initWithIdentifier:(id)arg1;	// IMP=0x0000000100027b6c
