...
- (void).cxx_destruct;	// IMP=0x00000001000389a8
...
- (void)dealloc;	// IMP=0x00000001000388f8
- (void)_endSession;	// IMP=0x00000001000387ac
- (id)eventOccurance;	// IMP=0x00000001000385a4
- (id)eventDurations;	// IMP=0x00000001000382ac
- (void)recordEvent:(id)arg1;	// IMP=0x0000000100038230
- (void)recordEvent:(id)arg1 occuredAt:(id)arg2;	// IMP=0x0000000100037ff4
- (id)initForType:(id)arg1 withMetadata:(id)arg2;	// IMP=0x0000000100037f2c
