...
+ (id)sharedService;	// IMP=0x0000000100004c44
- (void).cxx_destruct;	// IMP=0x000000010000576c
...
- (void)connection:(id)arg1 didChangeConnectedStatus:(_Bool)arg2;	// IMP=0x0000000100005644
- (void)connection:(id)arg1 didReceiveIncomingMessage:(id)arg2;	// IMP=0x00000001000053e8
- (void)connection:(id)arg1 didReceivePublicToken:(id)arg2;	// IMP=0x0000000100005300
- (id)_determinePushEnvironment;	// IMP=0x0000000100005214
- (void)_statConnectionWithEnvironment:(id)arg1;	// IMP=0x0000000100004d44
- (void)dealloc;	// IMP=0x0000000100004ce8
- (id)init;	// IMP=0x0000000100004b58
