...
- (void).cxx_destruct;	// IMP=0x0000000100020db4
...
- (id)description;	// IMP=0x0000000100020bdc
- (_Bool)hasEntitlement:(id)arg1;	// IMP=0x0000000100020b78
- (id)entitlementValueForKey:(id)arg1;	// IMP=0x0000000100020ac4
@property(readonly) int pid;
- (void)dead;	// IMP=0x00000001000209e4
- (void)dying;	// IMP=0x0000000100020990
- (void)dealloc;	// IMP=0x0000000100020944
- (id)initWithConnection:(id)arg1 server:(id)arg2;	// IMP=0x00000001000201bc
