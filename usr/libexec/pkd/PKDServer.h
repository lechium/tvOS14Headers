...
+ (id)server;	// IMP=0x00000001000043d0
- (void).cxx_destruct;	// IMP=0x0000000100005bd0
...
- (void)stop;	// IMP=0x000000010000583c
- (void)submitWork:(CDUnknownBlockType)arg1 synchronously:(_Bool)arg2;	// IMP=0x0000000100005750
- (void)unholdClient:(id)arg1;	// IMP=0x00000001000053e8
- (void)unholdToken:(id)arg1;	// IMP=0x00000001000050f0
- (void)addHold:(id)arg1;	// IMP=0x0000000100004fe8
- (id)holdOnPlugIn:(id)arg1;	// IMP=0x0000000100004cb8
- (void)terminatePlugIns:(id)arg1 synchronously:(_Bool)arg2 reply:(CDUnknownBlockType)arg3;	// IMP=0x0000000100004508
- (void)removedPlugIns:(id)arg1;	// IMP=0x0000000100004418
- (void)run;	// IMP=0x00000001000043dc
- (id)initForService:(const char *)arg1 database:(const char *)arg2;	// IMP=0x0000000100003e80
