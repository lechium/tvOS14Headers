...
- (id)description;	// IMP=0x0000000100019c34
- (unsigned long long)hash;	// IMP=0x0000000100019be8
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100019b28
- (id)initWithPlugIns:(id)arg1 forClient:(id)arg2;	// IMP=0x00000001000199b0
