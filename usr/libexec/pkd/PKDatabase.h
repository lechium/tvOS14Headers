...
- (void)pluginsWillUninstall:(id)arg1;	// IMP=0x0000000100015c50
- (void)pluginsDidInstall:(id)arg1;	// IMP=0x000000010001595c
- (void)autoElect:(id)arg1;	// IMP=0x00000001000157e4
- (void)notifyAnnotationChange;	// IMP=0x0000000100015768
- (id)setAnnotation:(id)arg1 forPlugIn:(id)arg2;	// IMP=0x0000000100015634
- (id)annotationForPlugIn:(id)arg1;	// IMP=0x00000001000154a0
- (id)removePlugIn:(id)arg1;	// IMP=0x0000000100015318
- (id)addPlugIn:(id)arg1;	// IMP=0x0000000100015190
- (id)plugInsWithinApplication:(id)arg1;	// IMP=0x0000000100014ef4
- (id)findPlugInAtPath:(id)arg1;	// IMP=0x0000000100014e04
- (id)findPlugIn:(id)arg1;	// IMP=0x0000000100014a54
- (id)findPlugIns:(id)arg1 discoveryInstanceUUID:(id)arg2;	// IMP=0x0000000100013acc
- (void)purgeCachesToLimit:(long long)arg1;	// IMP=0x0000000100013940
- (id)createPlugInForProxy:(id)arg1 knowledgeUUID:(id)arg2 discoveryInstanceUUID:(id)arg3 extensionPointCache:(id)arg4;	// IMP=0x00000001000136f8
- (id)plugInForProxy:(id)arg1 knowledgeUUID:(id)arg2 discoveryInstanceUUID:(id)arg3 extensionPointCache:(id)arg4;	// IMP=0x00000001000132a8
- (id)initWithDatabase:(const char *)arg1;	// IMP=0x0000000100012f38
