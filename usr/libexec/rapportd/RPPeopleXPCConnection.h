...
- (void)xpcPeopleDiscoveryUpdate:(id)arg1;	// IMP=0x00000001000491e8
- (void)xpcPeopleDiscoveryActivate:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000100048e84
- (void)xpcPeopleRemoveAppleID:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000100048a64
- (void)xpcPeopleAddAppleID:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000100048984
- (void)clientPeopleStatusChanged:(unsigned int)arg1;	// IMP=0x0000000100048938
- (void)clientDeviceChanged:(id)arg1 changes:(unsigned int)arg2;	// IMP=0x0000000100048654
- (void)clientDeviceLost:(id)arg1;	// IMP=0x000000010004828c
- (void)clientDeviceFound:(id)arg1 report:(_Bool)arg2;	// IMP=0x0000000100047e78
- (_Bool)_entitledAndReturnError:(id *)arg1;	// IMP=0x0000000100047d38
- (void)connectionInvalidated;	// IMP=0x0000000100047c54
- (id)initWithDaemon:(id)arg1 xpcCnx:(id)arg2;	// IMP=0x0000000100047ba0
