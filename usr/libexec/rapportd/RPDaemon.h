...
+ (id)sharedDaemon;	// IMP=0x0000000100028c3c
- (void).cxx_destruct;	// IMP=0x000000010002bc58
...
- (void)_xpcPublisherStateChangedForToken:(unsigned long long)arg1 state:(_Bool)arg2;	// IMP=0x000000010002ba24
- (void)_xpcPublisherTriggeredReply:(id)arg1 token:(unsigned long long)arg2 responseHandler:(CDUnknownBlockType)arg3;	// IMP=0x000000010002b6c8
- (void)_xpcPublisherTriggeredToken:(unsigned long long)arg1 payload:(id)arg2 responseHandler:(CDUnknownBlockType)arg3;	// IMP=0x000000010002b3e8
- (void)_xpcPublisherRemoveToken:(unsigned long long)arg1;	// IMP=0x000000010002b268
- (void)_xpcPublisherAddToken:(unsigned long long)arg1 event:(id)arg2;	// IMP=0x000000010002adc4
- (void)_xpcPublisherAction:(unsigned int)arg1 token:(unsigned long long)arg2 event:(id)arg3;	// IMP=0x000000010002acdc
- (void)_updateErrorFlags;	// IMP=0x000000010002ab7c
- (void)_prefsChanged;	// IMP=0x000000010002aa60
- (void)postDaemonInfoChanges:(unsigned long long)arg1;	// IMP=0x000000010002a884
- (id)keychainStateString;	// IMP=0x000000010002a630
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x000000010002a3bc
- (_Bool)diagnosticCommand:(id)arg1 params:(id)arg2;	// IMP=0x000000010002a284
- (void)invalidate;	// IMP=0x0000000100029f2c
- (void)activate;	// IMP=0x0000000100029500
- (id)descriptionWithLevel:(int)arg1;	// IMP=0x0000000100028e70
- (id)init;	// IMP=0x0000000100028ca8
