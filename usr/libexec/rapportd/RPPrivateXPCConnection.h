...
- (void).cxx_destruct;	// IMP=0x000000010004b828
...
- (void)xpcPrivateDiscoveryUpdate:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000010004b6a4
- (void)xpcPrivateDiscoveryActivate:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000010004b57c
- (void)xpcPrivateAdvertiserUpdate:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000010004b464
- (void)xpcPrivateAdvertiserActivate:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000010004b33c
- (void)xpcConnectionInvalidated;	// IMP=0x000000010004b1b4
- (_Bool)_entitledAndReturnError:(id *)arg1;	// IMP=0x000000010004b074
