...
- (void)accountDidChange:(id)arg1;	// IMP=0x0000000100087e5c
- (void)onIdentityUpdateNotification;	// IMP=0x00000001000862b4
@property(nonatomic, retain) OS_dispatch_queue *pushDelegateQueue;
@property(nonatomic, readonly) NSString *debugDescription;
@property(nonatomic, readonly) NSString *description;
- (_Bool)respondsToSelector:(SEL)arg1;	// IMP=0x00000001000545f4
- (_Bool)conformsToProtocol:(id)arg1;	// IMP=0x00000001000545ec
- (_Bool)isMemberOfClass:(Class)arg1;	// IMP=0x00000001000545e4
- (_Bool)isKindOfClass:(Class)arg1;	// IMP=0x00000001000545dc
- (_Bool)isProxy;	// IMP=0x00000001000545d4
- (id *)performSelector:(SEL)arg1 withObject:(id)arg2 withObject:(id)arg3;	// IMP=0x00000001000544f8
- (id *)performSelector:(SEL)arg1 withObject:(id)arg2;	// IMP=0x0000000100054468
- (id *)performSelector:(SEL)arg1;	// IMP=0x0000000100054424
- (id)self;	// IMP=0x0000000100054410
@property(nonatomic, readonly) Class superclass;
@property(nonatomic, readonly) long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100054318
- (void)didReceiveWithMessage:(id)arg1;	// IMP=0x000000010008e9a0
- (void)didReceiveWithToken:(id)arg1 forTopic:(id)arg2 identifier:(id)arg3;	// IMP=0x000000010008d780
- (void)didReceiveWithPublicToken:(id)arg1;	// IMP=0x000000010008d64c
