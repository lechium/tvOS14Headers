...
+ (id)sharedBubbleXPCInterface;	// IMP=0x0000000100017e9c
+ (id)sharedXPCInterface;	// IMP=0x0000000100017e18
+ (id)clientWithXPCConnection:(id)arg1;	// IMP=0x0000000100017dc0
- (void).cxx_destruct;	// IMP=0x00000001000190d0
...
- (void)clearTaskLists;	// IMP=0x0000000100018f80
- (void)bubbleShouldPop;	// IMP=0x0000000100018f24
- (void)bubbleDidPop;	// IMP=0x0000000100018ee4
- (void)uploadContentWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000100018e78
- (void)deviceLoginSessionStateDidUpdate;	// IMP=0x0000000100018e38
- (void)userSwitchTaskListDidUpdate;	// IMP=0x0000000100018df8
- (void)readyToSwitchToLoginSession:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000100018d2c
- (void)readyToSwitchToUser:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000100018c60
- (void)personaUpdateCallbackForMachServiceCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000100018afc
- (void)personaListDidUpdateCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000001000189c0
- (void)willSwitchToUser:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000010001884c
@property(readonly, nonatomic) _Bool hasUserSyncTasks;
- (_Bool)removeUserSyncTask:(id)arg1;	// IMP=0x00000001000186e0
- (void)addUserSyncTask:(id)arg1;	// IMP=0x0000000100018674
@property(readonly, nonatomic) _Bool hasUserSwitchTasks;
- (_Bool)removeUserSwitchTask:(id)arg1;	// IMP=0x0000000100018508
- (id)taskDictionaryInArray:(id)arg1 withUUIDString:(id)arg2;	// IMP=0x000000010001835c
- (void)addUserSwitchTask:(id)arg1;	// IMP=0x00000001000182f0
- (id)syncProxy;	// IMP=0x0000000100018204
- (id)proxy;	// IMP=0x0000000100018118
- (CDStruct_6ad76789)currentAuditToken;	// IMP=0x00000001000180bc
- (_Bool)hasEntitlement:(id)arg1;	// IMP=0x0000000100017fe8
@property(readonly, nonatomic) int pid;
- (id)init;	// IMP=0x0000000100017f20
