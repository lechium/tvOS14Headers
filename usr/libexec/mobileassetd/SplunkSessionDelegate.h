...
- (void)URLSession:(id)arg1 task:(id)arg2 didCompleteWithError:(id)arg3;	// IMP=0x000000010001cdd4
- (void)dealloc;	// IMP=0x000000010001cda0
- (id)initWithDownloadManager:(id)arg1;	// IMP=0x000000010001cd58
