...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000001000076f0
...
- (id)description;	// IMP=0x0000000100007cbc
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000100007a78
- (void)dealloc;	// IMP=0x00000001000079e8
- (id)initWithCoder:(id)arg1;	// IMP=0x000000010000779c
- (id)init;	// IMP=0x00000001000076f8
