...
- (void).cxx_destruct;	// IMP=0x000000010004a134
...
- (void)URLSession:(id)arg1 task:(id)arg2 willPerformHTTPRedirection:(id)arg3 newRequest:(id)arg4 completionHandler:(CDUnknownBlockType)arg5;	// IMP=0x0000000100049fa8
- (void)URLSession:(id)arg1 task:(id)arg2 didCompleteWithError:(id)arg3;	// IMP=0x0000000100049a6c
- (void)URLSession:(id)arg1 dataTask:(id)arg2 didReceiveData:(id)arg3;	// IMP=0x00000001000499f8
- (_Bool)fetchNext:(id)arg1;	// IMP=0x0000000100049618
- (id)createNextRequest:(id)arg1;	// IMP=0x0000000100049604
- (id)init;	// IMP=0x0000000100049570
