...
- (void).cxx_destruct;	// IMP=0x00000001000208e8
...
- (void)URLSession:(id)arg1 task:(id)arg2 didCompleteWithError:(id)arg3;	// IMP=0x000000010002054c
- (void)URLSession:(id)arg1 dataTask:(id)arg2 didReceiveData:(id)arg3;	// IMP=0x000000010002030c
- (void)URLSession:(id)arg1 dataTask:(id)arg2 didReceiveResponse:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x000000010001fd64
- (long long)versionFromTask:(id)arg1;	// IMP=0x000000010001fd08
- (void)updateDb:(unsigned long long)arg1;	// IMP=0x000000010001fb3c
- (void)reschedule;	// IMP=0x000000010001f950
