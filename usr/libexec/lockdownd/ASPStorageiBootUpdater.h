...
- (void)dealloc;	// IMP=0x000000010002d7b8
- (_Bool)updateBootFirmwareWithCallback:(struct ramrod_update_callbacks *)arg1 context:(struct firmware_update_context *)arg2 error:(id *)arg3;	// IMP=0x000000010002d7a8
- (_Bool)updateBootFirmwareWithError:(id *)arg1;	// IMP=0x000000010002d02c
- (id)initWithApNonce:(id)arg1;	// IMP=0x000000010002cf88
