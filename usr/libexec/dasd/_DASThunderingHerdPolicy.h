...
+ (id)policyInstance;	// IMP=0x000000010002ed90
- (void).cxx_destruct;	// IMP=0x000000010002f27c
...
- (id)responseForActivity:(id)arg1 withState:(id)arg2;	// IMP=0x000000010002f000
- (double)weightForActivity:(id)arg1;	// IMP=0x000000010002eff8
- (_Bool)shouldIgnoreTrigger:(id)arg1 withState:(id)arg2;	// IMP=0x000000010002ef44
- (void)handleTriggerEvent;	// IMP=0x000000010002eeb0
- (_Bool)appliesToActivity:(id)arg1;	// IMP=0x000000010002edfc
- (id)init;	// IMP=0x000000010002e904
- (id)initializeTriggers;	// IMP=0x000000010002e5b8
