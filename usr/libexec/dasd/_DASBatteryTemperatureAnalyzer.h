...
- (void).cxx_destruct;	// IMP=0x0000000100010098
...
- (void)analyzeValues:(id)arg1 currentContext:(id)arg2;	// IMP=0x000000010000fcac
- (double)getReferenceTemperatureForContext:(id)arg1 reader:(id)arg2;	// IMP=0x000000010000fbb0
- (void)recordValue;	// IMP=0x000000010000fb00
- (void)stop;	// IMP=0x000000010000fa94
- (void)start;	// IMP=0x000000010000fa04
- (id)initWithQueueLimit:(unsigned long long)arg1 reader:(id)arg2 monitoringInterval:(unsigned long long)arg3 analyzeToMonitorRatio:(unsigned long long)arg4;	// IMP=0x000000010000f7bc
