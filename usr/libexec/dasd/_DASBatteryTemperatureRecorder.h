...
+ (id)sharedInstance;	// IMP=0x0000000100037e94
...
- (long long)roundedTemperature:(long long)arg1;	// IMP=0x000000010003874c
- (_Bool)storeBatteryTemperatureEvent:(long long)arg1 metaData:(id)arg2;	// IMP=0x0000000100038570
- (id)getBatteryStatus;	// IMP=0x00000001000383b8
- (void)handleBatteryNotification;	// IMP=0x00000001000380a8
- (void)startRecording;	// IMP=0x0000000100037f18
- (id)init;	// IMP=0x0000000100037dd4
