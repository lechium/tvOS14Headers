...
- (void).cxx_destruct;	// IMP=0x00000001000414e0
...
- (double)scoreForApplication:(id)arg1 atDate:(id)arg2;	// IMP=0x0000000100041218
- (id)scoresForAllApplicationsAtDate:(id)arg1;	// IMP=0x0000000100040a00
- (id)initWithAlgorithms:(id)arg1;	// IMP=0x0000000100040890
