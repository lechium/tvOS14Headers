...
+ (id)getDeviceBootTime;	// IMP=0x00000001000212fc
+ (id)policyInstance;	// IMP=0x0000000100021248
- (void).cxx_destruct;	// IMP=0x0000000100021668
...
- (id)responseForActivity:(id)arg1 withState:(id)arg2;	// IMP=0x00000001000213b0
- (double)weightForActivity:(id)arg1;	// IMP=0x00000001000212f0
- (_Bool)appliesToActivity:(id)arg1;	// IMP=0x00000001000212bc
- (_Bool)shouldIgnoreTrigger:(id)arg1 withState:(id)arg2;	// IMP=0x00000001000212b4
- (id)init;	// IMP=0x00000001000211b8
