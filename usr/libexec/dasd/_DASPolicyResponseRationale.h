...
- (void).cxx_destruct;	// IMP=0x0000000100030d68
...
- (void)addRationaleWithCondition:(id)arg1;	// IMP=0x0000000100030c30
- (void)addRationaleForCondition:(id)arg1 withRequiredValue:(double)arg2 withCurrentValue:(double)arg3;	// IMP=0x0000000100030ba4
- (id)initWithPolicyName:(id)arg1;	// IMP=0x0000000100030b00
- (id)description;	// IMP=0x00000001000308e8
