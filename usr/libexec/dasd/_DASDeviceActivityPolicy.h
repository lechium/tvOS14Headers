...
+ (_Bool)isDeviceInUse:(id)arg1;	// IMP=0x0000000100025388
+ (id)policyInstance;	// IMP=0x0000000100024d94
+ (void)printLowLikelihoodRegions;	// IMP=0x0000000100024850
...
- (double)predictedScoreForActivity:(id)arg1 atDate:(id)arg2;	// IMP=0x000000010002595c
- (id)responseForActivity:(id)arg1 withState:(id)arg2;	// IMP=0x0000000100025574
- (_Bool)backgroundTaskAllowedWithType:(id)arg1 withRationale:(id)arg2 withState:(id)arg3;	// IMP=0x0000000100025434
- (double)scoreForActivity:(id)arg1 atDate:(id)arg2;	// IMP=0x0000000100025000
- (double)weightForActivity:(id)arg1;	// IMP=0x0000000100024f90
- (_Bool)appliesToActivity:(id)arg1;	// IMP=0x0000000100024f08
- (_Bool)shouldIgnoreTrigger:(id)arg1 withState:(id)arg2;	// IMP=0x0000000100024e30
- (_Bool)shouldLogScoreToPowerLog;	// IMP=0x0000000100024d8c
- (id)predictionForDeviceActivity;	// IMP=0x0000000100024d20
- (id)init;	// IMP=0x0000000100024b2c
- (id)initializeTriggers;	// IMP=0x00000001000249fc
