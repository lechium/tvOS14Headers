...
+ (id)policyInstance;	// IMP=0x000000010002fd8c
- (void).cxx_destruct;	// IMP=0x0000000100030618
...
- (id)responseForActivity:(id)arg1 withState:(id)arg2;	// IMP=0x000000010003018c
- (_Bool)applicationForActivity:(id)arg1 isBlacklistedWithContext:(id)arg2;	// IMP=0x0000000100030008
- (double)weightForActivity:(id)arg1;	// IMP=0x0000000100030000
- (_Bool)sessionInProgress:(id)arg1;	// IMP=0x000000010002ffa8
- (_Bool)appliesToActivity:(id)arg1;	// IMP=0x000000010002ff04
- (_Bool)shouldIgnoreTrigger:(id)arg1 withState:(id)arg2;	// IMP=0x000000010002fe2c
- (id)init;	// IMP=0x000000010002fc44
- (id)initializeTriggers;	// IMP=0x000000010002f9a0
