...
+ (id)sharedInstance;	// IMP=0x0000000100041c20
- (void).cxx_destruct;	// IMP=0x0000000100041e38
...
- (void)stop;	// IMP=0x0000000100041de4
- (void)start;	// IMP=0x0000000100041d88
- (void)updateSwapScoresWithDictionary:(id)arg1;	// IMP=0x0000000100041788
- (void)updateScores;	// IMP=0x00000001000416d8
- (id)initWithAlgorithms:(id)arg1;	// IMP=0x00000001000414f4
