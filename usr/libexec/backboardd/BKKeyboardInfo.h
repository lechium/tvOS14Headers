...
+ (id)keyboardInfoWithIOHIDService:(id)arg1;	// IMP=0x000000010004a294
- (void).cxx_destruct;	// IMP=0x000000010004a0c8
...
- (void)loadModifierKeyRemapping;	// IMP=0x0000000100049b04
- (void)setCapsLockDelayOverride:(double)arg1;	// IMP=0x00000001000499c4
- (void)setCapsLockLEDOn:(_Bool)arg1;	// IMP=0x00000001000498ec
...
- (void)appendDescriptionToFormatter:(id)arg1;	// IMP=0x00000001000493e4
@property(readonly, copy) NSString *description;
- (void)dealloc;	// IMP=0x0000000100049380
- (id)initWithService:(id)arg1;	// IMP=0x00000001000491a8
