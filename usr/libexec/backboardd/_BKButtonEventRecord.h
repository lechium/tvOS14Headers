...
- (void).cxx_destruct;	// IMP=0x00000001000165a8
...
- (void)applyEventPhase:(unsigned short)arg1 down:(_Bool)arg2;	// IMP=0x00000001000164f4
- (id)conciseDescription;	// IMP=0x00000001000163c0
- (id)descriptionBuilderWithMultilinePrefix:(id)arg1;	// IMP=0x000000010001628c
- (id)descriptionWithMultilinePrefix:(id)arg1;	// IMP=0x0000000100016238
- (id)succinctDescriptionBuilder;	// IMP=0x0000000100016220
- (id)succinctDescription;	// IMP=0x00000001000161cc
