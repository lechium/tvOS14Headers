...
- (void).cxx_destruct;	// IMP=0x000000010004b414
- (void)listener:(id)arg1 didReceiveConnection:(id)arg2 withContext:(id)arg3;	// IMP=0x000000010004b1a0
- (void)activate;	// IMP=0x000000010004b190
- (id)initWithObservationManager:(id)arg1;	// IMP=0x000000010004b0a0
