...
- (void).cxx_destruct;	// IMP=0x0000000100044458
...
- (id)descriptionBuilderWithMultilinePrefix:(id)arg1;	// IMP=0x0000000100044294
- (id)descriptionWithMultilinePrefix:(id)arg1;	// IMP=0x0000000100044240
- (id)succinctDescriptionBuilder;	// IMP=0x0000000100044198
- (id)succinctDescription;	// IMP=0x0000000100044144
@property(readonly, copy) NSString *description;
- (void)dealloc;	// IMP=0x00000001000440e8
- (id)initWithConnection:(id)arg1;	// IMP=0x000000010004404c
