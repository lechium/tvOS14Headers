...
+ (id)relativeToBottomMiddleOfSuper:(struct CGPoint)arg1;	// IMP=0x00000001000566c4
+ (id)relativeToBottomLeftOfSuper:(struct CGPoint)arg1;	// IMP=0x0000000100056640
+ (id)relativeToTopLeftOfSuper:(struct CGPoint)arg1;	// IMP=0x00000001000565bc
+ (id)centerAtPoint:(struct CGPoint)arg1;	// IMP=0x000000010005654c
+ (id)controlledBySupernode;	// IMP=0x000000010005650c
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001000563e4
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010005639c
