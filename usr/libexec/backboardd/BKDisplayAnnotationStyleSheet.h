...
- (void).cxx_destruct;	// IMP=0x0000000100017e44
...
- (id)newLayerForContent:(id)arg1 scale:(double)arg2;	// IMP=0x0000000100017c5c
- (void)sizeLayer:(id)arg1 toFitAtScale:(double)arg2;	// IMP=0x0000000100017b98
- (void)applyToLayer:(id)arg1 forContent:(id)arg2;	// IMP=0x0000000100017b0c
