...
- (void).cxx_destruct;	// IMP=0x000000010001c988
...
- (id)descriptionBuilderWithMultilinePrefix:(id)arg1;	// IMP=0x000000010001c860
- (id)descriptionWithMultilinePrefix:(id)arg1;	// IMP=0x000000010001c80c
- (id)succinctDescriptionBuilder;	// IMP=0x000000010001c7a0
- (id)succinctDescription;	// IMP=0x000000010001c74c
@property(readonly, copy) NSString *description;
- (void)_wrapInCATransaction:(CDUnknownBlockType)arg1;	// IMP=0x000000010001c6cc
- (id)_persistenceData;	// IMP=0x000000010001c650
- (void)_cleanup;	// IMP=0x000000010001c64c
- (void)_freeze;	// IMP=0x000000010001c648
- (void)_dismissWithAnimationSettings:(id)arg1;	// IMP=0x000000010001c644
- (void)_stopAnimating;	// IMP=0x000000010001c640
- (void)_startAnimating;	// IMP=0x000000010001c63c
- (_Bool)_presentWithAnimationSettings:(id)arg1;	// IMP=0x000000010001c634
- (void)dismissWithAnimationSettings:(id)arg1;	// IMP=0x000000010001c4dc
- (void)freeze;	// IMP=0x000000010001c350
- (_Bool)presentWithAnimationSettings:(id)arg1;	// IMP=0x000000010001c168
...
- (void)dealloc;	// IMP=0x000000010001bff8
- (id)_initWithPersistenceData:(id)arg1;	// IMP=0x000000010001bf3c
- (id)initWithOverlayDescriptor:(id)arg1 level:(float)arg2;	// IMP=0x000000010001bd9c
