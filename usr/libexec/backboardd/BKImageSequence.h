...
- (void).cxx_destruct;	// IMP=0x0000000100020984
...
- (void)_loadAllImages;	// IMP=0x00000001000208c8
- (struct CGImage *)_imageAtIndex:(long long)arg1;	// IMP=0x00000001000206cc
- (id)_idiomSuffix;	// IMP=0x0000000100020620
- (struct CGImage *)_createImageForIndex:(unsigned long long)arg1 basename:(id)arg2 scale:(double)arg3 idiom:(id)arg4 bundle:(id)arg5;	// IMP=0x0000000100020324
- (id)allImages;	// IMP=0x00000001000202f0
- (struct CGImage *)imageAtIndex:(long long)arg1;	// IMP=0x00000001000202e4
- (id)initWithBasename:(id)arg1 bundle:(id)arg2 imageCount:(long long)arg3 scale:(double)arg4;	// IMP=0x00000001000201ac
