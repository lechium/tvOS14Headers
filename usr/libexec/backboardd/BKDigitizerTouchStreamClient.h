...
- (void)watchForPortDeathOnQueue:(id)arg1 block:(CDUnknownBlockType)arg2;	// IMP=0x0000000100055780
- (id)description;	// IMP=0x000000010005559c
- (void)invalidate;	// IMP=0x0000000100055528
- (void)dealloc;	// IMP=0x000000010005548c
- (id)init;	// IMP=0x0000000100055448
