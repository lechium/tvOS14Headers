...
- (void).cxx_destruct;	// IMP=0x000000010000b174
...
- (void)resetForCancel;	// IMP=0x000000010000b0bc
- (id)description;	// IMP=0x000000010000af40
- (id)initWithService:(id)arg1;	// IMP=0x000000010000ad34
