...
- (void).cxx_destruct;	// IMP=0x000000010002fee4
...
- (long long)processEvent:(inout struct __IOHIDEvent **)arg1 sender:(id)arg2 dispatcher:(id)arg3;	// IMP=0x000000010002fc34
- (void)getStatus:(unsigned long long *)arg1 presence:(_Bool *)arg2 proximityInCentimeters:(double *)arg3 forDisplayUUID:(id)arg4;	// IMP=0x000000010002fb90
- (void)_setPresence:(_Bool)arg1 forDisplayUUID:(id)arg2;	// IMP=0x000000010002fafc
- (void)_setProximityInCentimeters:(double)arg1 forDisplayUUID:(id)arg2;	// IMP=0x000000010002fa68
- (void)serviceDidDisappear:(id)arg1;	// IMP=0x000000010002f8b0
- (void)matcher:(id)arg1 servicesDidMatch:(id)arg2;	// IMP=0x000000010002f650
@property(readonly, copy) NSString *description;
- (void)dealloc;	// IMP=0x000000010002f568
- (id)init;	// IMP=0x000000010002f418
